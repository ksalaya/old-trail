...
const AUTO_TICK_BASE_MS = 4500;
const IMAGE_BASE = "assets/images/";
const IMAGE_URLS = {
start_screen:
IMAGE_BASE+"start-screen_orig.png",
st_joseph_start:
IMAGE_BASE+"stjoseph-start2_orig.png",
council_bluffs_start:
IMAGE_BASE+"councilbluff-start_orig.png",
independence_start_edge:
IMAGE_BASE+"independence-start2_orig.png",
leaving_independence:
IMAGE_BASE+"leaving-independnce_orig.png",
kansas_bottomlands:
IMAGE_BASE+"kansasriver-bottomlands_orig.png",
little_blue_spring:
IMAGE_BASE+"littlebluevalley-spring_orig.png",
little_blue_burned:
IMAGE_BASE+"littlebluevalley-burned-out_orig.png",
platte_clear:
IMAGE_BASE+"centralplatte-clear_orig.png",
platte_heat_storm:
IMAGE_BASE+"centralplatte-heat-storm_orig.png",
buffalo_plains_heat:
IMAGE_BASE+"buffaloplains-summerheat_orig.png",
buffalo_plains_storm:
IMAGE_BASE+"buffaloplains-storm_orig.png",
chimney_clear:
IMAGE_BASE+"chimney-clear_orig.png",
chimney_storm:
IMAGE_BASE+"chimney-storm_orig.png",
fort_kearny_camp:
IMAGE_BASE+"fort-kearny_orig.png",
fort_laramie_approach:
IMAGE_BASE+"fort-laramie_orig.png",
register_cliffs:
IMAGE_BASE+"register-cliffs_orig.png",
independence_rock:
IMAGE_BASE+"independence-rock_orig.png",
devils_gate:
IMAGE_BASE+"devilsgate_orig.png",
south_pass_clear:
IMAGE_BASE+"southpass-clear_orig.png",
south_pass_midsummer:
IMAGE_BASE+"southpass-midsummer_orig.png",
soda_springs_morning:
IMAGE_BASE+"sodasprings-earlymorning_orig.png",
soda_springs_warm:
IMAGE_BASE+"sodasprings-warmday_orig.png",
snake_bench_heat:
IMAGE_BASE+"snakeriver-bench-heat_orig.png",
snake_bench_storm:
IMAGE_BASE+"snakeriver-bench-storm_orig.png",
salmon_falls_dusk:
IMAGE_BASE+"salmonfalls-dusk_orig.png",
salmon_falls_summer:
IMAGE_BASE+"salmonfalls-summer_orig.png",
alkali_flats_evening:
IMAGE_BASE+"alkaliflats-evening_orig.png",
alkali_flats_day:
IMAGE_BASE+"alkaliflats-summer_orig.png",
three_island_calm:
IMAGE_BASE+"threeislandcrossing-calm_orig.png",
three_island_danger:
IMAGE_BASE+"threeislandcrossing-danger_orig.png",
grande_ronde_autumn:
IMAGE_BASE+"granderonde-valley-autumn_orig.png",
grande_ronde_summer:
IMAGE_BASE+"granderonde-valley-summer_orig.png",
blue_mountains_clear:
IMAGE_BASE+"bluemtnsroad-clear_orig.png",
blue_mountains_rain:
IMAGE_BASE+"bluemtnsroad-rain_orig.png",
mountain_creek_calm:
IMAGE_BASE+"mountaincreek-calm_orig.png",
mountain_creek_danger:
IMAGE_BASE+"mountaincreek-danger_orig.png",
columbia_gorge_primary:
IMAGE_BASE+"columbiagorge-primary_orig.png",
columbia_gorge_rain:
IMAGE_BASE+"columbiagorge-rain_orig.png",
dalles_primary:
IMAGE_BASE+"dalles-primary_orig.png",
dalles_evening:
IMAGE_BASE+"dalles-evening_orig.png",
barlow_clear:
IMAGE_BASE+"barlow-mthood-clear_orig.png",
barlow_snow:
IMAGE_BASE+"barlow-mthood-snow_orig.png",
oregon_city_primary:
IMAGE_BASE+"oregoncity-primary_orig.png",
oregon_city_rain:
IMAGE_BASE+"oregoncity-rain_orig.png",
oregon_city_spring:
IMAGE_BASE+"oregoncity-springmorning_orig.png",
willamette_valley:
IMAGE_BASE+"willamette-valley-arrival_orig.png",
generalstore_missouri:
IMAGE_BASE+"generalstore-missouri_orig.png",
generalstore_missouri_storm:
IMAGE_BASE+"generalstore-missouri-storm_orig.png",
fort_kearny_sutler:
IMAGE_BASE+"fort-kearny-sutler-primary_orig.png",
fort_laramie_yard:
IMAGE_BASE+"fort-laramie-parade_orig.png",
fort_laramie_evening:
IMAGE_BASE+"fort-laramie-evening_orig.png",
fort_bridger_evening:
IMAGE_BASE+"fort-bridger-evening_orig.png",
fort_bridger_cold:
IMAGE_BASE+"fort-bridger-cold2_orig.png",
fort_hall_summer:
IMAGE_BASE+"fort-hall-summer_orig.png",
fort_hall_rain:
IMAGE_BASE+"fort-hall-rain_orig.png",
fort_boise_primary:
IMAGE_BASE+"fort-boise-primary_orig.png",
fort_boise_flood:
IMAGE_BASE+"fort-boise-flooded_orig.png",
generalstore_independence_day:
IMAGE_BASE+"generalstore-independence-day_orig.png",
generalstore_independence_night:
IMAGE_BASE+"generalstore-interior-independence_orig.png",
trail_trading_tent:
IMAGE_BASE+"trail-trading-tent_orig.png",
fort_blacksmith:
IMAGE_BASE+"fort-blacksmith_orig.png",
fort_blacksmith_morning:
IMAGE_BASE+"fort-blacksmith-morning_orig.png",
fort_doctor_morning:
IMAGE_BASE+"fort-doctor-morning_orig.png",
fort_doctor_night:
IMAGE_BASE+"fort-doctor-night2_orig.png",
native_trade_lodge:
IMAGE_BASE+"native-trade-lodge_orig.png",
mission_dining:
IMAGE_BASE+"mission-whitman-dining_orig.png",
camp_storm:
IMAGE_BASE+"camp-storm_orig.png",
camp_sunrise_storm:
IMAGE_BASE+"camp-sunrise-storm_orig.png",
prairie_storm:
IMAGE_BASE+"prairire-storm_orig.png",
bluemtns_flurries:
IMAGE_BASE+"bluemtns-flurries_orig.png",
dust_storm:
IMAGE_BASE+"dust-storm_orig.png",
prairie_fire:
IMAGE_BASE+"prairie-fire_orig.png",
kansasriver_calm_day:
IMAGE_BASE+"kansasriver-calm_orig.png",
kansasriver_calm_sunset:
IMAGE_BASE+"kansasriver-calm-sunset_orig.png",
kansasriver_danger:
IMAGE_BASE+"kansasriver-danger_orig.png",
kansasriver_ferry:
IMAGE_BASE+"kansasriver-ferry_orig.png",
bigblueriver_crossing:
IMAGE_BASE+"bigblueriver-crossing_orig.png",
snakeriver_threeisle_ford:
IMAGE_BASE+"snakeriver-threeisle-ford_orig.png",
snakeriver_caulked:
IMAGE_BASE+"snakeriver-caulked_orig.png",
columbiariver_rafting:
IMAGE_BASE+"columbiariver-rafting_orig.png",
wagon_river_tipped:
IMAGE_BASE+"wagon-river-tipped_orig.png",
wagon_brokenwheel:
IMAGE_BASE+"wagon-brokenwheel_orig.png",
wagon_snappedaxle:
IMAGE_BASE+"wagon-snappedaxle_orig.png",
wagon_snappedaxle_rain:
IMAGE_BASE+"wagon-snappedaxle-rain_orig.png",
wagon_steep_descent:
IMAGE_BASE+"wagon-steep-descent_orig.png",
wagon_stuck_mud:
IMAGE_BASE+"wagon-stuck-mud_orig.png",
wagon_abandoned:
IMAGE_BASE+"wagon-abandoned_orig.png",
camp_evening:
IMAGE_BASE+"camp-evening_orig.png",
camp_hunting:
IMAGE_BASE+"camp-hunting_orig.png",
foraging:
IMAGE_BASE+"foraging_orig.png",
trade_salmon:
IMAGE_BASE+"trade-salmon_orig.png",
feast_cayuse_nez:
IMAGE_BASE+"feast-cayuse-nez_orig.png",
hunt_buffalo:
IMAGE_BASE+"hunt-buffalo_orig.png",
hunt_buffalo_dead:
IMAGE_BASE+"hunt-buffalo-dead_orig.png",
stalk_deer_primary:
IMAGE_BASE+"stalk-deer-primary_orig.png",
stalk_deer_timberline:
IMAGE_BASE+"stalk-deer-timberline_orig.png",
hunt_smallgame:
IMAGE_BASE+"hunt-smallgame_orig.png",
illness_cholera:
IMAGE_BASE+"illness-cholera_orig.png",
illness_dysentary:
IMAGE_BASE+"illness-dysentary_orig.png",
illness_fever:
IMAGE_BASE+"illness-fever_orig.png",
illness_snakebite:
IMAGE_BASE+"illness-snakebite_orig.png",
illness_brokenleg:
IMAGE_BASE+"illness-brokenleg_orig.png",
illness_frostbite:
IMAGE_BASE+"illness-frostbite_orig.png",
death_burial:
IMAGE_BASE+"death_orig.png",
travelers_in_need:
IMAGE_BASE+"travelers-in-need_orig.png",
trade_native:
IMAGE_BASE+"trade-native_orig.png",
hostile_tension:
IMAGE_BASE+"hostile-tension_orig.png",
help_stranger:
IMAGE_BASE+"help-stranger_orig.png",
wagon_lost:
IMAGE_BASE+"wagon-lost_orig.png",
buffalo_stampede:
IMAGE_BASE+"buffalo-stampede_orig.png",
alkali_water:
IMAGE_BASE+"alkali-water_orig.png",
};
...
const DREAMWEST_PACK = {"schemaVersion":1,"packId":"dreamwest_casefiles_v1","packName":"Dream-West Case Files","packVersion":"1.0.0","generatedAt":"2026-01-06","description":"X-files-on-the-frontier expansion: mythic anomalies, abductions, infections, conspiracies, and emergent story arcs for Old Trail's event director & encounter system.","integrationNotes":{"expects":{"systems":["eventDirectorTick (kind: breather/minor/major/lifeline/setpiece)","presentEncounter modal with options","storyState flags + hoursSinceFlag gating","traits + hiddenTraits + revealHiddenTrait","afflictions with stages (incubating/acute/recovering)","factionRep (caravans/forts/open_eye/men_in_gray) + optional new factions","mythic curios (2 slots) with upkeep"],"contextFields":["ctx.mode","ctx.block","ctx.regionKey","ctx.seasonTag","ctx.weather","ctx.risk","ctx.guardCoverage","ctx.avgMorale"]},"dslOverview":{"trigger":{"mode":["camp","travel","any"],"block":["morning","noon","evening","night","any"],"regionKey":"string or array","seasonTag":"string or array","weatherAny":["rain","storm","snow","fog","heat","cold"],"riskAny":"array of risk flags","riskAll":"array of risk flags","requiresFlagsAll":"array of storyState.eventFlags keys","forbidsFlagsAny":"array of storyState.eventFlags keys","hoursSinceFlagAtLeast":{"<flagKey>":0},"milesTraveledMin":0,"milesTraveledMax":9999,"guardCoverageMin":0,"guardCoverageMax":99,"partySizeMin":1,"partySizeMax":99,"mythicEnabled":true,"locationContains":"optional substring match","requiresSupplyAtLeast":{"<supplyOrItemId>":0},"requiresFactionRepMin":{"<factionId>":0},"requiresFactionRepMax":{"<factionId>":0},"requiresPartyTraitAny":["<traitId>"],"requiresPartyAfflictionAny":["<afflictionId>"],"requiresPartyAnyIllness":true},"effects":["log","moneyDelta","suppliesDelta","tensionDelta","mythicRumorDelta","factionRepDelta","personStatDelta","personSkillDelta","personAddThought","personAddTrait","personAddHiddenTrait","personRevealHiddenTrait","personAddAffliction","setFlag","incFlag","advanceChain","roll (chance, then, else)","choiceOutcomeMap (byChoice)","assignCaseFileRandom (custom)","addRumorFromTable (custom)","markPersonMissing/resolveMissingPerson (custom)","giveCurio (custom)","timeSkipHours (custom)","treatIllnessBestChance (custom)","reduceAfflictionSeverity (custom)"],"targetSelectors":["leader","randomAlive","randomNonLeader","lowestMorale","highestSkill:<skillId>","randomWithTrait:<traitId>","randomWithoutTrait:<traitId>","randomWithAffliction:<afflictionId>"]}},"caseFiles":[{"id":"cf_gray_trail","title":"Case File: The Gray Trail","synopsis":"Lights that don't burn, footsteps that leave no prints, and 'surveyors' who ask about your dreams. The trail feels watched.","signatureTags":["alien","abduction","men_in_gray","lights"],"startingFlags":["cf_gray_trail_active"],"signatureItems":["itm_alien_alloy","itm_etched_disc","itm_cinder_glass"],"signatureCurios":["cur_gray_token_plus","cur_star_map_scrap"],"signatureAfflictions":["aff_gray_fever","aff_implant_stitches"],"starterRumor":"Someone swears a star fell behind the bluffs, and the next morning their oxen wouldn't look west."},{"id":"cf_open_eye","title":"Case File: The Open Eye Covenant","synopsis":"A quiet cult travels faster than wagons: inked eyes on paper, charms at throats, whispered 'blessings' traded for flour.","signatureTags":["cult","omen","charms","open_eye"],"startingFlags":["cf_open_eye_active"],"signatureItems":["itm_inked_leaflet","itm_eye_charm","itm_salt_cord"],"signatureCurios":["cur_inked_charm","cur_blessing_bundle"],"signatureAfflictions":["aff_ink_sickness"],"starterRumor":"They say if you burn the leaflet, smoke curls into an eye and follows your wagon for three nights."},{"id":"cf_black_oil","title":"Case File: The Black Oil","synopsis":"Tar that moves like it listens. A sheen in the creek. Something in the blood that wants the fire put out.","signatureTags":["infection","possession","contamination"],"startingFlags":["cf_black_oil_active"],"signatureItems":["itm_black_oil_vial","itm_tar_grease","itm_ash_salve"],"signatureCurios":["cur_oil_vial"],"signatureAfflictions":["aff_black_oil"],"starterRumor":"A man at the last fort warned: 'If you see the oil shine, don't let it see you back.'"},{"id":"cf_mirror_road","title":"Case File: The Mirror Road","synopsis":"Same hill twice. The sun wrong. A wagon that reflects futures you didn't earn. Time creaks like wood.","signatureTags":["time","doubles","mirror","glitch"],"startingFlags":["cf_mirror_road_active"],"signatureItems":["itm_mirror_shard","itm_brass_gear","itm_time_chalk"],"signatureCurios":["cur_mirror_shard"],"signatureAfflictions":["aff_time_sickness","aff_mirror_split"],"starterRumor":"A journal page repeats itself, word for word, but the ink is fresher each time."},{"id":"cf_bone_valley","title":"Case File: Bone Valley","synopsis":"A valley where the ground is white with old bones. Wind whistles like a flute through ribs the size of barrels.","signatureTags":["bones","fossils","whispers","ancient"],"startingFlags":["cf_bone_valley_active"],"signatureItems":["itm_fossil_tooth","itm_bone_whistle","itm_white_dust"],"signatureCurios":["cur_bone_whistle"],"signatureAfflictions":["aff_bone_dust_cough"],"starterRumor":"They say if you pocket a tooth from that valley, your dreams will chew on you."},{"id":"cf_fungal_bloom","title":"Case File: The Fungal Bloom","synopsis":"Glowing caps under fallen logs. Spore clouds like faint lantern smoke. Memories that rot and regrow.","signatureTags":["fungus","spores","hallucination"],"startingFlags":["cf_fungal_bloom_active"],"signatureItems":["itm_glow_cap","itm_spore_sample","itm_bitter_tea"],"signatureCurios":["cur_mycelium_charm"],"signatureAfflictions":["aff_spore_lung","aff_dream_bleed"],"starterRumor":"An old hunter swore the mushrooms were 'listening' when the campfire told stories."},{"id":"cf_hollow_herd","title":"Case File: The Hollow Herd","synopsis":"Oxen found standing, eyes blank. Tracks that turn into bare feet. A howl that sounds almost like a name.","signatureTags":["cryptid","skinwalker","cattle"],"startingFlags":["cf_hollow_herd_active"],"signatureItems":["itm_antler_talisman","itm_hollow_horn","itm_sinew_thread"],"signatureCurios":["cur_antler_talisman"],"signatureAfflictions":["aff_cryptid_bite"],"starterRumor":"Someone carved a warning at Register Rock: 'DON'T FOLLOW THE TRACKS BACKWARD.'"},{"id":"cf_lost_regiment","title":"Case File: The Lost Regiment","synopsis":"Bootsteps at dawn with no men to wear them. Drumbeats over empty prairie. Dispatches signed by names that never lived here.","signatureTags":["ghost","war_echo","soldiers"],"startingFlags":["cf_lost_regiment_active"],"signatureItems":["itm_dull_medal","itm_powdered_ink","itm_dispatch_tape"],"signatureCurios":["cur_dull_medal"],"signatureAfflictions":["aff_battle_fugue"],"starterRumor":"A child said a blue-coated man saluted the wagon and asked what year it was."}],"definitions":{"traits":[{"id":"abductee","label":"Abductee","summary":"Lost time; gained scars. Notices patterns in the dark.","skillMods":{"doctoring":0.12,"travel":0.1,"guard":0.08},"moraleBias":-2,"mythicGuard":true,"rare":true,"tags":["mythic","alien"]},{"id":"implanted","label":"Implanted","summary":"Carries something under the skin that sometimes hums.","skillMods":{"foraging":0.08,"repair":0.08},"moraleBias":-3,"mythicGuard":true,"rare":true,"tags":["mythic","alien"]},{"id":"latent_psychic","label":"Latent Psychic","summary":"Dreams arrive before events. Hears trouble in quiet weather.","skillMods":{"foraging":0.1,"travel":0.1},"moraleBias":1,"mythicGuard":true,"rare":true,"tags":["mythic","psi"]},{"id":"hybrid_blood","label":"Hybrid Blood","summary":"Not entirely human\u2014or not entirely ordinary.","skillMods":{"guard":0.12,"hunting":0.08},"moraleBias":0,"mythicGuard":true,"rare":true,"tags":["mythic","alien"]},{"id":"conspiracy_mind","label":"Conspiracy Mind","summary":"Sees motives behind coincidences; spreads paranoia or preparation.","skillMods":{"guard":0.05},"moraleBias":-1,"opinionBias":-1,"socialBonus":-1,"rare":false,"tags":["social"]},{"id":"star_mapper","label":"Star Mapper","summary":"Reads the sky like a ledger; rarely gets truly lost.","skillMods":{"travel":0.18},"moraleBias":1,"rare":false,"tags":["wayfinding"]},{"id":"ink_touched","label":"Ink-Touched","summary":"Calmer around charms and scribbles; unsettled by clean paper.","skillMods":{"craft":0.06},"moraleBias":0,"socialBonus":1,"rare":false,"tags":["cult","mythic"]},{"id":"oathbound_eye","label":"Oathbound","summary":"Swore a quiet vow to the Open Eye. Keeps watch without being asked.","skillMods":{"guard":0.1},"moraleBias":0,"rare":true,"tags":["cult"]},{"id":"oil_carrier","label":"Oil Carrier","summary":"Seems healthier than they should\u2014until the fire goes out.","skillMods":{"guard":0.08,"repair":0.06},"moraleBias":-2,"rare":true,"tags":["mythic","infection"]},{"id":"mirrorstruck","label":"Mirrorstruck","summary":"Sometimes speaks in two tenses. Hates still water.","skillMods":{"craft":0.1,"repair":0.06},"moraleBias":-3,"mythicGuard":true,"rare":true,"tags":["mythic","time"]},{"id":"time_sense","label":"Time-Sense","summary":"Knows when hours are being stolen; wakes before loops.","skillMods":{"travel":0.12},"moraleBias":0,"mythicGuard":true,"rare":true,"tags":["mythic","time"]},{"id":"bone_listener","label":"Bone Listener","summary":"Hears wind in old ribs; can spot fossils and fractures.","skillMods":{"doctoring":0.1,"foraging":0.06},"moraleBias":-1,"rare":true,"tags":["mythic","bones"]},{"id":"cryptid_hunter","label":"Cryptid Hunter","summary":"Believes every tale has tracks. Good shot, bad bedtime stories.","skillMods":{"hunting":0.18,"guard":0.1},"moraleBias":0,"socialBonus":-1,"rare":false,"tags":["mythic"]},{"id":"mycelial_symbiote","label":"Mycelial Symbiote","summary":"Recovered from spores\u2014different. Learns plants quickly.","skillMods":{"foraging":0.18,"doctoring":0.06},"moraleBias":-1,"mythicGuard":true,"rare":true,"tags":["mythic","fungus"]},{"id":"bluecoat_echo","label":"Bluecoat Echo","summary":"Hears marching that others don't. Stands straighter at dawn.","skillMods":{"guard":0.08,"travel":0.06},"moraleBias":-1,"rare":true,"tags":["ghost"]},{"id":"telegraph_tinker","label":"Telegraph Tinker","summary":"Knows wire, batteries, and secret codes. Improvises repairs.","skillMods":{"repair":0.18,"craft":0.1},"moraleBias":0,"rare":false,"tags":["craft"]},{"id":"gentle_medium","label":"Gentle Medium","summary":"Comforts the shaken; claims to hear the dead without fear.","skillMods":{"cooking":0.04},"moraleBias":2,"socialBonus":2,"mythicGuard":true,"rare":true,"tags":["social","mythic"]},{"id":"hard_case","label":"Hard Case","summary":"Has seen too much to panic easily. Others borrow their calm.","skillMods":{"guard":0.06},"moraleBias":1,"socialBonus":1,"rare":false,"tags":["resilience"]}],"afflictions":[{"id":"aff_gray_fever","label":"Gray Fever","type":"illness","baseHoursIncubation":10,"baseHoursAcute":22,"baseHoursRecovery":28,"severityRange":[1,3],"crisisThreshold":3,"tags":["illness","mythic"],"cause":"Exposure to radiant debris or 'light' that left no burn.","cureHint":"Rest + doctoring; herbs help."},{"id":"aff_implant_stitches","label":"Implant Stitches","type":"injury","baseHoursIncubation":0,"baseHoursAcute":18,"baseHoursRecovery":26,"severityRange":[1,2],"crisisThreshold":2,"tags":["injury","mythic"],"cause":"Fresh cuts from a procedure nobody admits to.","cureHint":"Keep clean; doctoring reduces infection chance."},{"id":"aff_black_oil","label":"Black Oil Infection","type":"illness","baseHoursIncubation":14,"baseHoursAcute":30,"baseHoursRecovery":40,"severityRange":[1,4],"crisisThreshold":4,"tags":["illness","mythic","contagion"],"cause":"Contact with moving tar, tainted water, or contaminated food.","cureHint":"Ash salve + doctoring. Avoid sharing water skins."},{"id":"aff_ink_sickness","label":"Ink Sickness","type":"illness","baseHoursIncubation":6,"baseHoursAcute":14,"baseHoursRecovery":18,"severityRange":[1,2],"crisisThreshold":2,"tags":["illness","mythic"],"cause":"Fever after handling wet, strange ink.","cureHint":"Wash + rest; herbs."},{"id":"aff_spore_lung","label":"Spore Lung","type":"illness","baseHoursIncubation":8,"baseHoursAcute":20,"baseHoursRecovery":30,"severityRange":[1,3],"crisisThreshold":3,"tags":["illness","mythic"],"cause":"Breathing dense spore clouds.","cureHint":"Rest; tea + herbs."},{"id":"aff_dream_bleed","label":"Dream Bleed","type":"illness","baseHoursIncubation":0,"baseHoursAcute":16,"baseHoursRecovery":20,"severityRange":[1,2],"crisisThreshold":2,"tags":["illness","mythic","mental"],"cause":"Sleeplessness after visions; waking dreams.","cureHint":"Sleep in shifts; morale comforts."},{"id":"aff_time_sickness","label":"Time Sickness","type":"illness","baseHoursIncubation":0,"baseHoursAcute":18,"baseHoursRecovery":22,"severityRange":[1,2],"crisisThreshold":2,"tags":["illness","mythic"],"cause":"Too many repeated hours or wrong reflections.","cureHint":"Rest; keep them grounded."},{"id":"aff_mirror_split","label":"Mirror Split","type":"illness","baseHoursIncubation":4,"baseHoursAcute":18,"baseHoursRecovery":26,"severityRange":[1,3],"crisisThreshold":3,"tags":["illness","mythic","mental"],"cause":"Derealization after seeing oneself where one shouldn't be.","cureHint":"Rest; companionship; avoid mirrors."},{"id":"aff_bone_dust_cough","label":"Bone Dust Cough","type":"illness","baseHoursIncubation":0,"baseHoursAcute":16,"baseHoursRecovery":20,"severityRange":[1,2],"crisisThreshold":2,"tags":["illness"],"cause":"Breathing chalky dust in dry valleys.","cureHint":"Tea + rest."},{"id":"aff_cryptid_bite","label":"Cryptid Bite","type":"injury","baseHoursIncubation":6,"baseHoursAcute":20,"baseHoursRecovery":30,"severityRange":[1,3],"crisisThreshold":3,"tags":["injury","mythic","infection"],"cause":"Bite from something that didn't match any tracks.","cureHint":"Clean + doctoring; watch for fever."},{"id":"aff_radiant_burn","label":"Radiant Burn","type":"injury","baseHoursIncubation":0,"baseHoursAcute":22,"baseHoursRecovery":34,"severityRange":[1,3],"crisisThreshold":3,"tags":["injury","mythic"],"cause":"Sunburn-like injury from a crash site's glow.","cureHint":"Cover skin; water + rest."},{"id":"aff_battle_fugue","label":"Battle Fugue","type":"illness","baseHoursIncubation":0,"baseHoursAcute":14,"baseHoursRecovery":20,"severityRange":[1,2],"crisisThreshold":2,"tags":["illness","mental"],"cause":"Panic after hearing unseen drums or marching.","cureHint":"Keep close; calm; rest."}],"curios":[{"id":"cur_star_map_scrap","name":"Star Map Scrap","shortDesc":"Oilcloth charted with constellations that don't match any book you own.","boon":{"travel":1,"morale":1},"upkeep":{"kind":"time","cost":1,"periodHours":48},"tags":["mythic","wayfinding","alien"]},{"id":"cur_inked_charm","name":"Inked Eye Charm","shortDesc":"A small charm painted with an open eye. It feels heavier when lies are told nearby.","boon":{"mythicGuard":true,"morale":2},"upkeep":{"kind":"morale","cost":2,"periodHours":36},"tags":["mythic","omen","cult"]},{"id":"cur_blessing_bundle","name":"Blessing Bundle","shortDesc":"Herbs and cord tied in a careful knot. Smells like safety and smoke.","boon":{"warmth":2,"morale":1},"upkeep":{"kind":"time","cost":1,"periodHours":36},"tags":["mythic","cult"]},{"id":"cur_oil_vial","name":"Sealed Oil Vial","shortDesc":"A sealed vial of black oil. It never freezes, no matter the pass.","boon":{"guardBonus":1},"upkeep":{"kind":"morale","cost":3,"periodHours":36},"tags":["mythic","hazard","infection"]},{"id":"cur_mirror_shard","name":"Mirror Shard","shortDesc":"A fragment that reflects roads not taken. Looking too long makes hours slip.","boon":{"travel":1,"mythicGuard":true},"upkeep":{"kind":"time","cost":1,"periodHours":24},"tags":["mythic","time"]},{"id":"cur_bone_whistle","name":"Bone Whistle","shortDesc":"A whistle carved from old bone. Sometimes it sounds without breath.","boon":{"guardBonus":1,"morale":1},"upkeep":{"kind":"morale","cost":2,"periodHours":48},"tags":["mythic","bones"]},{"id":"cur_mycelium_charm","name":"Mycelium Charm","shortDesc":"Dried fungus braided into twine. It 'remembers' where food grows.","boon":{"travel":1,"morale":1},"upkeep":{"kind":"wood","cost":1,"periodHours":48},"tags":["mythic","fungus"]},{"id":"cur_antler_talisman","name":"Antler Talisman","shortDesc":"Carved antler notches\u2014each one a warning. Oxen calm when it's near.","boon":{"guardBonus":1,"mythicGuard":true},"upkeep":{"kind":"time","cost":1,"periodHours":48},"tags":["mythic","cryptid"]},{"id":"cur_dull_medal","name":"Dull Medal","shortDesc":"Unmarked metal disc on frayed ribbon. Warm at dawn, cold at noon.","boon":{"morale":1,"mythicGuard":true},"upkeep":{"kind":"morale","cost":1,"periodHours":48},"tags":["mythic","ghost"]},{"id":"cur_gray_token_plus","name":"Stamped Gray Token","shortDesc":"A coin with no mint. Symbols run the rim like stitches.","boon":{"mythicGuard":true,"morale":1},"upkeep":{"kind":"morale","cost":2,"periodHours":36},"tags":["mythic","omen","alien"]}],"items":[{"id":"itm_alien_alloy","label":"Alien Alloy Shard","kind":"supply","category":"artifact","baseValue":18,"stackable":true,"notes":"Lightweight metal; used in repairs or traded to 'surveyors'."},{"id":"itm_etched_disc","label":"Etched Disc","kind":"supply","category":"artifact","baseValue":25,"stackable":true,"notes":"Thin disc with concentric scratches; sometimes warms in a pocket."},{"id":"itm_cinder_glass","label":"Cinder Glass","kind":"supply","category":"artifact","baseValue":10,"stackable":true,"notes":"Green-black glass from a melt scar; can be knapped into a blade."},{"id":"itm_star_map_scrap","label":"Star Map Scrap","kind":"supply","category":"document","baseValue":14,"stackable":true,"notes":"Oilcloth with unfamiliar constellations; improves navigation when studied."},{"id":"itm_agency_token","label":"Agency Token","kind":"supply","category":"credential","baseValue":20,"stackable":true,"notes":"Stamped brass token that opens doors (or closes mouths)."},{"id":"itm_inked_leaflet","label":"Inked Leaflet","kind":"supply","category":"document","baseValue":6,"stackable":true,"notes":"Paper marked with an open eye."},{"id":"itm_eye_charm","label":"Eye Charm","kind":"supply","category":"charm","baseValue":12,"stackable":true,"notes":"Bone or clay charm painted with an eye."},{"id":"itm_salt_cord","label":"Salt-Cord Bundle","kind":"supply","category":"ritual","baseValue":8,"stackable":true,"notes":"Twine stiff with salt and herbs; hung on wagon tongues."},{"id":"itm_blessed_herbs","label":"Blessed Herbs","kind":"supply","category":"medicine","baseValue":7,"stackable":true,"notes":"Smells like sage and pennyroyal; calms morale swings."},{"id":"itm_black_oil_vial","label":"Black Oil Vial","kind":"supply","category":"hazard","baseValue":22,"stackable":true,"notes":"Sealed in glass. Valuable and dangerous."},{"id":"itm_tar_grease","label":"Tar Grease","kind":"supply","category":"craft","baseValue":9,"stackable":true,"notes":"Useful for wagon axles; risky if mishandled."},{"id":"itm_ash_salve","label":"Ash Salve","kind":"supply","category":"medicine","baseValue":11,"stackable":true,"notes":"Charcoal and fat; rumored to 'draw out' the oil."},{"id":"itm_mirror_shard","label":"Mirror Shard","kind":"supply","category":"artifact","baseValue":16,"stackable":true,"notes":"Polished fragment that shows faint images of other roads."},{"id":"itm_time_chalk","label":"Time Chalk","kind":"supply","category":"tool","baseValue":5,"stackable":true,"notes":"Marks that don't wash away\u2014unless the day repeats."},{"id":"itm_brass_gear","label":"Brass Gear","kind":"supply","category":"craft","baseValue":8,"stackable":true,"notes":"Oddly precise teeth; fits nothing you own until it suddenly does."},{"id":"itm_fossil_tooth","label":"Fossil Tooth","kind":"supply","category":"curio","baseValue":13,"stackable":true,"notes":"Too big for a man; collectors pay well."},{"id":"itm_bone_whistle","label":"Bone Whistle","kind":"supply","category":"curio","baseValue":9,"stackable":true,"notes":"Whistles without breath on cold nights."},{"id":"itm_white_dust","label":"White Bone Dust","kind":"supply","category":"hazard","baseValue":4,"stackable":true,"notes":"Irritates lungs."},{"id":"itm_glow_cap","label":"Glow-Cap Mushroom","kind":"supply","category":"food","baseValue":6,"stackable":true,"notes":"Edible? Sometimes. Bright enough to read by."},{"id":"itm_spore_sample","label":"Spore Sample Jar","kind":"supply","category":"hazard","baseValue":12,"stackable":true,"notes":"Collectors want it. So do doctors who don't fear dreams."},{"id":"itm_bitter_tea","label":"Bitter Tea Bricks","kind":"supply","category":"food","baseValue":5,"stackable":true,"notes":"Staves off nausea; tastes like wet wood."},{"id":"itm_antler_talisman","label":"Antler Talisman","kind":"supply","category":"charm","baseValue":10,"stackable":true,"notes":"Worn antler carved with notches."},{"id":"itm_hollow_horn","label":"Hollow Horn","kind":"supply","category":"curio","baseValue":7,"stackable":true,"notes":"A horn that echoes wrong."},{"id":"itm_sinew_thread","label":"Sinew Thread","kind":"supply","category":"craft","baseValue":6,"stackable":true,"notes":"Strong thread for repairs."},{"id":"itm_dull_medal","label":"Dull Medal","kind":"supply","category":"curio","baseValue":9,"stackable":true,"notes":"Unmarked medal that grows warm at dawn."},{"id":"itm_powdered_ink","label":"Powdered Ink Packet","kind":"supply","category":"document","baseValue":4,"stackable":true,"notes":"For copying dispatches; stains like bruises."},{"id":"itm_dispatch_tape","label":"Dispatch Tape","kind":"supply","category":"tool","baseValue":6,"stackable":true,"notes":"Waxed cloth strip with numbers; telegraph men crave it."},{"id":"itm_register_rubbing","label":"Register Rock Rubbing","kind":"supply","category":"document","baseValue":3,"stackable":true,"notes":"Charcoal rubbing of names; sometimes includes one that isn't yours yet."},{"id":"itm_soda_bottle","label":"Soda Springs Bottle","kind":"supply","category":"food","baseValue":3,"stackable":true,"notes":"Carbonated water in glass; boosts morale briefly."},{"id":"itm_strange_battery","label":"Strange Battery","kind":"supply","category":"artifact","baseValue":20,"stackable":true,"notes":"Copper-zinc cell wired wrong; powers nothing you own\u2014until it does."}],"factions":[{"id":"star_watchers","label":"Star Watchers","description":"A loose network of surveyors and telegraph men who appear after 'falling stars'.","defaultRep":0,"repRange":[-100,100],"notes":"Optional; can be folded into men_in_gray."},{"id":"bone_pickers","label":"Bone Pickers","description":"Fossil hunters and grave-robbers posing as naturalists. They buy teeth and sell superstition.","defaultRep":0,"repRange":[-100,100]},{"id":"timekeepers","label":"Timekeepers","description":"A rumor more than a group: people who leave chalk marks where days repeat.","defaultRep":0,"repRange":[-100,100]},{"id":"mycelial_friends","label":"Mycelial Friends","description":"Foragers who swear the fungus is a medicine, not a curse. They trade spores and tea.","defaultRep":0,"repRange":[-100,100]}],"rumorLines":["A telegraph man swore he heard code coming from the sky\u2014three taps, then silence.","They say the Platte runs bad with sickness, but some nights the water runs with light.","A wagon passed yesterday with no tracks behind it. Folks blamed wind. No one laughed.","A preacher claims the Open Eye can 'see' through canvas and flesh alike.","Someone found a ring of burned grass with glass like green ice in the center.","In the high pass, a voice calls your name from under the snow. Don't answer it.","A man at a fort swore he met himself on the road. The other one was better fed.","They say you can buy safety with a stamped token, but the price is telling the truth.","If you see a clean mirror on the trail, turn it facedown. It steals hours.","The Bone Valley wind sounds like flute music, but no one carries a flute.","A peddler buys bone teeth and sells 'medicine' that tastes like chalk and fear.","A woman returned after a storm with stitches she couldn't explain and a calmer voice.","They say the men in gray won't hurt you if you never say what you saw aloud.","A set of tracks went backward for a mile, then turned into bare feet.","A fort clerk keeps a second ledger for trades that never happened. Or haven't yet.","A cracked bottle from Soda Springs kept fizzing for three days with no cork.","Some nights the stars are arranged wrong. Don't point it out. Just keep moving.","A black smear on a rock looked wet, but left no stain. It watched.","A bone whistle can keep wolves away\u2014unless the wolves are listening for it.","A lantern that burns without fuel will guide you\u2014until it guides something else to you.","At Soda Springs the bubbles spell letters\u2014if you stare long enough to read them.","A small metal gear fits nothing you own until the day it saves your wagon.","A badge without a name can open a door and close a mouth. Choose one.","They say there are two Oregon Trails: the one you walk, and the one that walks you.","The trail takes what it wants, but sometimes it gives back the wrong thing."]},"events":[{"id":"dw_seed_casefile_assign","kind":"breather","trigger":{"mode":["camp","travel"],"block":["evening","morning"],"milesTraveledMax":120,"mythicEnabled":true,"forbidsFlagsAny":["dw_casefile_assigned"]},"weight":6,"tension":{"min":0,"max":55},"tags":["seed","dreamwest","casefile"],"effects":[{"type":"assignCaseFileRandom","caseFileIds":["cf_gray_trail","cf_open_eye","cf_black_oil","cf_mirror_road","cf_bone_valley","cf_fungal_bloom","cf_hollow_herd","cf_lost_regiment"],"setStoryKey":"dw_caseFileId","setFlagsFromCaseFile":true,"seedHiddenTraitsByCaseFile":{"cf_gray_trail":["abductee","latent_psychic"],"cf_open_eye":["ink_touched","oathbound_eye"],"cf_black_oil":["oil_carrier"],"cf_mirror_road":["time_sense","mirrorstruck"],"cf_bone_valley":["bone_listener"],"cf_fungal_bloom":["mycelial_symbiote"],"cf_hollow_herd":["cryptid_hunter"],"cf_lost_regiment":["bluecoat_echo","gentle_medium"]},"alsoSetFlag":{"key":"dw_casefile_assigned","value":true}},{"type":"log","text":"A new case file begins, whether you want it or not.","tone":"event","locationFromCtx":true}],"encounter":{"title":"Case files in the dust","subtitleFromCtx":"location","body":["A page tears loose from a ledger you don't remember packing. It smells like ozone and campfire smoke.","In neat handwriting: CASE FILES \u2014 observations along the Oregon Trail. The first line is already filled in."],"tags":["camp","omen"],"options":[{"id":"accept","label":"Read the case file","tone":"neutral","hint":"Let the strange story take root."},{"id":"dismiss","label":"Stuff it away","tone":"danger","hint":"Pretend it isn't real."},{"id":"share","label":"Show the party","tone":"warm","hint":"Belief spreads faster than smoke."}],"defaultId":"accept"}},{"id":"dw_breather_rumor_board","kind":"breather","trigger":{"mode":["camp"],"block":["evening"],"locationContains":"Fort","mythicEnabled":true,"hoursSinceFlagAtLeast":{"dw_rumor_board_time":72}},"weight":3,"tension":{"min":0,"max":65},"tags":["rumor","fort"],"effects":[{"type":"setFlag","key":"dw_rumor_board_time","value":"NOW_HOUR"},{"type":"addRumorFromTable","table":"definitions.rumorLines","count":2},{"type":"mythicRumorDelta","delta":1},{"type":"choiceOutcomeMap","byChoice":{"copy":[{"type":"personAddThought","target":{"selector":"leader"},"thought":{"id":"dw_rumors","label":"Copied troubling rumors","value":-1,"hours":12,"source":"social"}}],"ignore":[{"type":"tensionDelta","delta":-1}],"ask":[{"type":"factionRepDelta","factionId":"forts","delta":-1},{"type":"mythicRumorDelta","delta":1},{"type":"personAddThought","target":{"selector":"leader"},"thought":{"id":"dw_clerk","label":"Clerk avoided your eyes","value":-1,"hours":10,"source":"social"}}]}},{"type":"log","text":"You leave with ink on your fingers and new worries.","tone":"event","locationFromCtx":true}],"encounter":{"title":"Rumor board behind the stores","subtitleFromCtx":"location","body":["Behind the trading post, scraps of paper are pinned to a board: lost oxen, bounties, prayers, warnings.","One scrap is written in a sharper hand: IF YOU SAW THE LIGHT, DON'T SAY WHAT IT WAS."],"tags":["trade","omen"],"options":[{"id":"copy","label":"Copy down rumors","tone":"warm","hint":"Knowledge is weightless cargo."},{"id":"ignore","label":"Ignore it","tone":"neutral","hint":"You're here to buy flour, not nightmares."},{"id":"ask","label":"Ask the clerk about it","tone":"neutral","hint":"The clerk's smile doesn't reach his eyes."}],"defaultId":"copy"}},{"id":"dw_minor_register_rock_rubbing","kind":"minor","trigger":{"mode":["travel","camp"],"block":["noon","evening"],"milesTraveledMin":340,"milesTraveledMax":410,"mythicEnabled":true,"hoursSinceFlagAtLeast":{"dw_register_rubbing_time":120}},"weight":2,"tension":{"min":0,"max":70},"tags":["landmark","register_rock","time"],"effects":[{"type":"setFlag","key":"dw_register_rubbing_time","value":"NOW_HOUR"},{"type":"choiceOutcomeMap","byChoice":{"rub":[{"type":"suppliesDelta","supplyId":"itm_register_rubbing","delta":1,"clampMin":0},{"type":"mythicRumorDelta","delta":1},{"type":"personAddThought","target":{"selector":"leader"},"thought":{"id":"dw_rock_future","label":"Future written in stone","value":-2,"hours":24,"source":"omen"}}],"scratch":[{"type":"mythicRumorDelta","delta":2},{"type":"personAddThought","target":{"selector":"leader"},"thought":{"id":"dw_defiance","label":"Defied the rock","value":-1,"hours":18,"source":"omen"}}],"leave":[{"type":"tensionDelta","delta":-1}]}},{"type":"log","text":"The rock keeps its secrets; you carry only guesses.","tone":"event","locationFromCtx":true}],"encounter":{"title":"Names on Register Rock","subtitle":"Register Rock","body":["Names and dates cover the stone\u2014thousands of them, pressed into charcoal and pride.","You find one that matches your leader's name, but the date is next year."],"tags":["travel","omen"],"options":[{"id":"rub","label":"Take a rubbing","tone":"warm","hint":"Proof for later\u2014if later arrives."},{"id":"scratch","label":"Scratch your name beside it","tone":"neutral","hint":"Make the future match the stone."},{"id":"leave","label":"Leave it alone","tone":"danger","hint":"Don't touch the thing that knows you."}],"defaultId":"rub"}},{"id":"dw_minor_cholera_corridor_glimmer","kind":"minor","trigger":{"mode":["travel"],"block":["noon","evening"],"regionKey":["plains","central_plains"],"mythicEnabled":true,"riskAny":["water_shortage"]},"weight":2,"tension":{"min":10,"max":80},"tags":["river","illness","omen"],"log":{"tone":"event","text":"Along the riverbank, a faint shimmer dances on the water\u2014like oil, like moonlight, like neither."},"effects":[{"type":"roll","chance":0.35,"then":[{"type":"personAddAffliction","target":{"selector":"randomAlive"},"afflictionId":"aff_gray_fever","severity":{"min":1,"max":2}},{"type":"personAddThought","target":{"selector":"randomAlive"},"thought":{"id":"dw_bad_water","label":"Bad water dread","value":-2,"hours":18,"source":"illness"}}],"else":[{"type":"personAddThought","target":{"selector":"randomAlive"},"thought":{"id":"dw_river_watch","label":"Felt watched by the river","value":-1,"hours":10,"source":"omen"}}]},{"type":"mythicRumorDelta","delta":1}],"cooldownHours":48},{"id":"dw_breather_soda_springs_bubbles","kind":"breather","trigger":{"mode":["camp"],"block":["evening"],"milesTraveledMin":820,"milesTraveledMax":900,"mythicEnabled":true,"hoursSinceFlagAtLeast":{"dw_soda_bubbles_time":96}},"weight":2,"tension":{"min":0,"max":60},"tags":["landmark","soda_springs","breather"],"effects":[{"type":"setFlag","key":"dw_soda_bubbles_time","value":"NOW_HOUR"},{"type":"choiceOutcomeMap","byChoice":{"bottle":[{"type":"suppliesDelta","supplyId":"water","delta":2,"clampMin":0},{"type":"suppliesDelta","supplyId":"itm_soda_bottle","delta":1,"clampMin":0},{"type":"personAddThought","target":{"selector":"randomAlive"},"thought":{"id":"dw_fizz","label":"Fizzy spring treat","value":2,"hours":10,"source":"camp"}}],"read":[{"type":"personAddThought","target":{"selector":"randomAlive"},"thought":{"id":"dw_bubbles","label":"Bubbles spelled something","value":-1,"hours":14,"source":"omen"}},{"type":"mythicRumorDelta","delta":1}],"move":[{"type":"tensionDelta","delta":-1}]}}],"encounter":{"title":"Soda Springs bubbles","subtitle":"Soda Springs","body":["The spring fizzes like it\u2019s alive. The bubbles gather in lines that almost look like letters.","Someone jokes it's a message. No one laughs on the second line."],"tags":["camp","water","omen"],"options":[{"id":"bottle","label":"Fill bottles","tone":"warm","hint":"A bright drink lifts spirits."},{"id":"read","label":"Try to 'read' the bubbles","tone":"neutral","hint":"You might see too much."},{"id":"move","label":"Move camp away","tone":"danger","hint":"Don't drink the talking water."}],"defaultId":"bottle"}},{"id":"dw_minor_metallic_rain","kind":"minor","trigger":{"mode":["travel"],"block":["noon","evening"],"mythicEnabled":true,"weatherAny":["rain","storm"],"hoursSinceFlagAtLeast":{"dw_metal_rain_time":72}},"weight":2,"tension":{"min":5,"max":85},"tags":["weather","omen"],"log":{"tone":"event","text":"Rain falls with a sharp scent, like pennies and smoke. Droplets leave tiny dark specks on canvas."},"effects":[{"type":"setFlag","key":"dw_metal_rain_time","value":"NOW_HOUR"},{"type":"personAddThought","target":{"selector":"randomAlive"},"thought":{"id":"dw_metal_rain","label":"Metallic rain","value":-1,"hours":12,"source":"weather"}},{"type":"roll","chance":0.25,"then":[{"type":"personAddAffliction","target":{"selector":"randomAlive"},"afflictionId":"aff_radiant_burn","severity":{"min":1,"max":2}}]}]},{"id":"dw_minor_silent_thunder","kind":"minor","trigger":{"mode":["camp"],"block":["night"],"mythicEnabled":true,"weatherAny":["storm"],"hoursSinceFlagAtLeast":{"dw_silent_thunder_time":60}},"weight":2,"tension":{"min":15,"max":95},"tags":["weather","night","omen"],"log":{"tone":"event","text":"Lightning forks behind the clouds, bright as noon\u2014yet the thunder arrives as a whisper, hours late."},"effects":[{"type":"setFlag","key":"dw_silent_thunder_time","value":"NOW_HOUR"},{"type":"tensionDelta","delta":2},{"type":"personAddThought","target":{"selector":"randomAlive"},"thought":{"id":"dw_silent_thunder","label":"Silent thunder unease","value":-2,"hours":10,"source":"weather"}}]},{"id":"dw_gray_lights_over_camp","kind":"minor","trigger":{"mode":["camp"],"block":["night"],"mythicEnabled":true,"requiresFlagsAll":["cf_gray_trail_active"],"hoursSinceFlagAtLeast":{"dw_gray_lights_time":48}},"weight":3,"tension":{"min":10,"max":90},"tags":["alien","lights","night"],"log":{"tone":"event","text":"A pale light moves across the clouds in clean angles\u2014too steady for a lantern, too low for a star."},"effects":[{"type":"setFlag","key":"dw_gray_lights_time","value":"NOW_HOUR"},{"type":"personAddThought","target":{"selector":"randomAlive"},"thought":{"id":"dw_watched","label":"Felt watched from above","value":-2,"hours":12,"source":"omen"}},{"type":"roll","chance":0.22,"then":[{"type":"personAddHiddenTrait","target":{"selector":"randomAlive"},"traitId":"abductee"},{"type":"mythicRumorDelta","delta":1}]}]},{"id":"dw_gray_owl_on_canvas","kind":"breather","trigger":{"mode":["camp"],"block":["morning"],"mythicEnabled":true,"requiresFlagsAll":["cf_gray_trail_active"],"hoursSinceFlagAtLeast":{"dw_gray_owl_time":72}},"weight":2,"tension":{"min":0,"max":70},"tags":["alien","omen","breather"],"effects":[{"type":"setFlag","key":"dw_gray_owl_time","value":"NOW_HOUR"},{"type":"choiceOutcomeMap","byChoice":{"shoo":[{"type":"personAddThought","target":{"selector":"randomAlive"},"thought":{"id":"dw_shoo","label":"Chased off a watcher","value":-1,"hours":10,"source":"omen"}},{"type":"tensionDelta","delta":1}],"watch":[{"type":"personAddThought","target":{"selector":"leader"},"thought":{"id":"dw_missing_time","label":"Missing time","value":-2,"hours":18,"source":"omen"}},{"type":"mythicRumorDelta","delta":1}],"shoot":[{"type":"suppliesDelta","supplyId":"ammo","delta":-1,"clampMin":0},{"type":"personAddThought","target":{"selector":"randomAlive"},"thought":{"id":"dw_shot","label":"Shot at an owl","value":-2,"hours":12,"source":"social"}},{"type":"tensionDelta","delta":2}]}},{"type":"roll","chance":0.18,"then":[{"type":"personAddHiddenTrait","target":{"selector":"randomAlive"},"traitId":"latent_psychic"}]}],"encounter":{"title":"The owl on the canvas","subtitleFromCtx":"location","body":["At dawn, an owl sits on the wagon canvas, staring as if it owns the inventory.","When you blink, you realize you can't remember the last few minutes."],"tags":["camp","omen"],"options":[{"id":"shoo","label":"Shoo it away","tone":"neutral","hint":"Break the spell with noise."},{"id":"watch","label":"Watch it quietly","tone":"warm","hint":"See if it leaves a sign."},{"id":"shoot","label":"Shoot it","tone":"danger","hint":"No more watchers."}],"defaultId":"watch"}},{"id":"dw_gray_night_hum","kind":"minor","trigger":{"mode":["camp"],"block":["night"],"mythicEnabled":true,"requiresFlagsAll":["cf_gray_trail_active"],"hoursSinceFlagAtLeast":{"dw_gray_hum_time":36}},"weight":3,"tension":{"min":15,"max":95},"tags":["alien","sound","night"],"log":{"tone":"event","text":"A low hum rolls over the prairie like a distant wire vibrating. The fire burns lower than it should."},"effects":[{"type":"setFlag","key":"dw_gray_hum_time","value":"NOW_HOUR"},{"type":"personStatDelta","target":{"selector":"randomAlive"},"stat":"energy","delta":-2},{"type":"personAddThought","target":{"selector":"randomAlive"},"thought":{"id":"dw_hum","label":"Could not sleep for the hum","value":-2,"hours":10,"source":"omen"}},{"type":"roll","chance":0.15,"then":[{"type":"personAddHiddenTrait","target":{"selector":"randomAlive"},"traitId":"abductee"}]}]},{"id":"dw_gray_surveyors_checkpoint","kind":"major","trigger":{"mode":["travel"],"block":["noon","evening"],"mythicEnabled":true,"requiresFlagsAll":["cf_gray_trail_active"],"hoursSinceFlagAtLeast":{"dw_gray_checkpoint_time":96}},"weight":2,"tension":{"min":25,"max":95},"tags":["alien","men_in_gray","social","trade"],"effects":[{"type":"setFlag","key":"dw_gray_checkpoint_time","value":"NOW_HOUR"},{"type":"choiceOutcomeMap","byChoice":{"truth":[{"type":"factionRepDelta","factionId":"men_in_gray","delta":5},{"type":"mythicRumorDelta","delta":2},{"type":"personAddThought","target":{"selector":"randomAlive"},"thought":{"id":"dw_spoken","label":"Spoke of the light aloud","value":-1,"hours":12,"source":"omen"}}],"lie":[{"type":"factionRepDelta","factionId":"men_in_gray","delta":-1},{"type":"personAddThought","target":{"selector":"randomAlive"},"thought":{"id":"dw_lie","label":"Lied to strangers","value":-1,"hours":10,"source":"social"}}],"bribe":[{"type":"suppliesDelta","supplyId":"treasure","delta":-1,"clampMin":0},{"type":"factionRepDelta","factionId":"men_in_gray","delta":2},{"type":"tensionDelta","delta":-1}],"refuse":[{"type":"factionRepDelta","factionId":"men_in_gray","delta":-5},{"type":"tensionDelta","delta":3},{"type":"personAddThought","target":{"selector":"randomAlive"},"thought":{"id":"dw_refused","label":"Refused the gray riders","value":-2,"hours":12,"source":"social"}}]}}],"encounter":{"title":"Surveyors on the road","subtitleFromCtx":"location","body":["Two riders in gray coats wave you down. Their saddlebags are too clean for the trail.","They ask, politely, whether you've seen a falling star\u2014or heard anything 'unusual' at night."],"tags":["travel","social"],"options":[{"id":"truth","label":"Tell them what you saw","tone":"neutral","hint":"Cooperation might buy safety."},{"id":"lie","label":"Say you saw nothing","tone":"neutral","hint":"Keep your own counsel."},{"id":"bribe","label":"Offer goods to pass","tone":"warm","hint":"Make it a transaction."},{"id":"refuse","label":"Refuse and move on","tone":"danger","hint":"They don't like refusal."}],"defaultId":"lie"}},{"id":"dw_gray_missing_person","kind":"setpiece","trigger":{"mode":["camp"],"block":["night"],"mythicEnabled":true,"requiresFlagsAll":["cf_gray_trail_active"],"guardCoverageMax":0.6,"hoursSinceFlagAtLeast":{"dw_gray_missing_person_time":144},"forbidsFlagsAny":["dw_gray_missing_person_pending"]},"weight":1,"tension":{"min":35,"max":100},"tags":["alien","abduction","setpiece","night"],"effects":[{"type":"setFlag","key":"dw_gray_missing_person_time","value":"NOW_HOUR"},{"type":"setFlag","key":"dw_gray_missing_person_pending","value":true},{"type":"markPersonMissing","target":{"selector":"randomNonLeader"},"missingHours":12,"setFlagKey":"dw_gray_missing_target"},{"type":"tensionDelta","delta":4},{"type":"personAddThought","target":{"selector":"leader"},"thought":{"id":"dw_missing","label":"Someone vanished","value":-4,"hours":24,"source":"loss"}},{"type":"choiceOutcomeMap","byChoice":{"search":[{"type":"personStatDelta","target":{"selector":"randomAlive"},"stat":"energy","delta":-3},{"type":"roll","chance":0.35,"then":[{"type":"suppliesDelta","supplyId":"ammo","delta":-1,"clampMin":0},{"type":"personAddAffliction","target":{"selector":"randomAlive"},"afflictionId":"sprain","severity":{"min":1,"max":2}}]}],"circle":[{"type":"tensionDelta","delta":-1}],"fire":[{"type":"suppliesDelta","supplyId":"wood","delta":-2,"clampMin":0},{"type":"tensionDelta","delta":-2},{"type":"mythicRumorDelta","delta":1}],"pray":[{"type":"personAddThought","target":{"selector":"randomAlive"},"thought":{"id":"dw_prayer","label":"Held a vigil","value":1,"hours":12,"source":"camp"}}]}}],"encounter":{"title":"A bedroll is empty","subtitleFromCtx":"location","body":["A shout cuts through the night. One bedroll is empty\u2014still warm, as if the sleeper stood up mid-breath.","No tracks. No struggle. Just a faint smell of ozone."],"tags":["camp","danger","omen"],"options":[{"id":"search","label":"Search with lanterns","tone":"neutral","hint":"Risk the dark to find them."},{"id":"circle","label":"Circle the wagons","tone":"warm","hint":"Protect the rest; wait for dawn."},{"id":"fire","label":"Build a bigger fire","tone":"warm","hint":"Light keeps some things away."},{"id":"pray","label":"Pray / keep watch","tone":"neutral","hint":"Hold the line until morning."}],"defaultId":"circle"}},{"id":"dw_gray_returned_with_stitches","kind":"major","trigger":{"mode":["camp","travel"],"block":["morning","evening"],"mythicEnabled":true,"requiresFlagsAll":["dw_gray_missing_person_pending"]},"weight":4,"tension":{"min":10,"max":100},"tags":["alien","abduction","followup"],"effects":[{"type":"setFlag","key":"dw_gray_missing_person_pending","value":false},{"type":"resolveMissingPerson","flagKey":"dw_gray_missing_target"},{"type":"roll","chance":0.75,"then":[{"type":"personAddTrait","target":{"selector":"randomNonLeader"},"traitId":"implanted"},{"type":"personAddAffliction","target":{"selector":"randomNonLeader"},"afflictionId":"aff_implant_stitches","severity":{"min":1,"max":2}}]},{"type":"mythicRumorDelta","delta":2},{"type":"choiceOutcomeMap","byChoice":{"question":[{"type":"personAddThought","target":{"selector":"randomNonLeader"},"thought":{"id":"dw_fragments","label":"Fragmented memory","value":-1,"hours":24,"source":"omen"}},{"type":"factionRepDelta","factionId":"men_in_gray","delta":1}],"examine":[{"type":"personSkillDelta","target":{"selector":"highestSkill:doctoring"},"skill":"doctoring","delta":0.1},{"type":"personAddThought","target":{"selector":"highestSkill:doctoring"},"thought":{"id":"dw_anatomy","label":"Saw strange stitches","value":-1,"hours":18,"source":"doctoring"}}],"accuse":[{"type":"tensionDelta","delta":2},{"type":"personAddThought","target":{"selector":"randomNonLeader"},"thought":{"id":"dw_accused","label":"Accused after returning","value":-3,"hours":18,"source":"social"}}],"accept":[{"type":"tensionDelta","delta":-1}]}}],"encounter":{"title":"Returned","subtitleFromCtx":"location","body":["They return at the edge of camp as if stepping out from behind a curtain.","Their clothes are damp with dew. Their eyes are tired. A bandage sits where no wound was yesterday."],"tags":["social","omen"],"options":[{"id":"question","label":"Question them gently","tone":"warm","hint":"Try to learn without breaking them."},{"id":"examine","label":"Examine the bandage","tone":"neutral","hint":"Let the best doctor look."},{"id":"accuse","label":"Accuse them of lying","tone":"danger","hint":"Paranoia spreads."},{"id":"accept","label":"Accept it and move on","tone":"neutral","hint":"On the trail, you take what you can get back."}],"defaultId":"question"}},{"id":"dw_gray_crash_fireball","kind":"setpiece","trigger":{"mode":["travel","camp"],"block":["evening","night"],"mythicEnabled":true,"requiresFlagsAll":["cf_gray_trail_active"],"hoursSinceFlagAtLeast":{"dw_gray_crash_time":180}},"weight":1,"tension":{"min":30,"max":100},"tags":["alien","crash","setpiece"],"effects":[{"type":"setFlag","key":"dw_gray_crash_time","value":"NOW_HOUR"},{"type":"mythicRumorDelta","delta":3},{"type":"choiceOutcomeMap","byChoice":{"investigate":[{"type":"tensionDelta","delta":4},{"type":"roll","chance":0.65,"then":[{"type":"suppliesDelta","supplyId":"itm_alien_alloy","delta":1,"clampMin":0},{"type":"suppliesDelta","supplyId":"itm_cinder_glass","delta":2,"clampMin":0},{"type":"moneyDelta","delta":6}],"else":[{"type":"suppliesDelta","supplyId":"treasure","delta":1,"clampMin":0}]},{"type":"roll","chance":0.35,"then":[{"type":"personAddAffliction","target":{"selector":"randomAlive"},"afflictionId":"aff_radiant_burn","severity":{"min":1,"max":3}}]},{"type":"factionRepDelta","factionId":"men_in_gray","delta":-2}],"mark":[{"type":"tensionDelta","delta":1},{"type":"personAddThought","target":{"selector":"leader"},"thought":{"id":"dw_unfinished","label":"Left something behind","value":-1,"hours":12,"source":"omen"}}],"avoid":[{"type":"tensionDelta","delta":-1}]}}],"encounter":{"title":"Fireball beyond the ridge","subtitleFromCtx":"location","body":["A streak of fire tears the sky and vanishes behind a ridge. A second later: a soft boom, like faraway thunder.","The air smells briefly of hot stone and copper."],"tags":["travel","danger","omen"],"options":[{"id":"investigate","label":"Investigate the crash","tone":"neutral","hint":"Risk for reward."},{"id":"mark","label":"Mark the place and move on","tone":"neutral","hint":"Survival first."},{"id":"avoid","label":"Avoid it entirely","tone":"warm","hint":"Some curiosities cost too much."}],"defaultId":"mark"}},{"id":"dw_gray_token_peddler","kind":"lifeline","trigger":{"mode":["travel"],"block":["noon","evening"],"mythicEnabled":true,"requiresFlagsAll":["cf_gray_trail_active"],"hoursSinceFlagAtLeast":{"dw_gray_token_time":120}},"weight":2,"tension":{"min":10,"max":70},"tags":["trade","alien","lifeline"],"effects":[{"type":"setFlag","key":"dw_gray_token_time","value":"NOW_HOUR"},{"type":"choiceOutcomeMap","byChoice":{"buy_treasure":[{"type":"suppliesDelta","supplyId":"treasure","delta":-1,"clampMin":0},{"type":"giveCurio","curioId":"cur_gray_token_plus"},{"type":"factionRepDelta","factionId":"men_in_gray","delta":2},{"type":"tensionDelta","delta":-1}],"buy_coffee":[{"type":"suppliesDelta","supplyId":"coffee","delta":-2,"clampMin":0},{"type":"giveCurio","curioId":"cur_gray_token_plus"},{"type":"factionRepDelta","factionId":"men_in_gray","delta":1},{"type":"tensionDelta","delta":-1}],"refuse":[{"type":"factionRepDelta","factionId":"men_in_gray","delta":-1},{"type":"personAddThought","target":{"selector":"leader"},"thought":{"id":"dw_refused_token","label":"Refused the token","value":-1,"hours":10,"source":"social"}}],"press":[{"type":"factionRepDelta","factionId":"men_in_gray","delta":-3},{"type":"tensionDelta","delta":2},{"type":"personAddThought","target":{"selector":"leader"},"thought":{"id":"dw_pressed","label":"Pressed a peddler","value":-2,"hours":12,"source":"social"}}]}}],"encounter":{"title":"A peddler with clean hands","subtitleFromCtx":"location","body":["A lone peddler approaches on a pale horse. His hands are clean. His eyes are tired.","He offers a stamped gray token. 'Keeps the watchers polite,' he says. 'Costs you something you can afford.'"],"tags":["trade","social","omen"],"options":[{"id":"buy_treasure","label":"Trade 1 treasure for the token","tone":"neutral","hint":"A small price for a large promise."},{"id":"buy_coffee","label":"Trade 2 coffee for the token","tone":"neutral","hint":"Luxury for protection."},{"id":"refuse","label":"Refuse","tone":"neutral","hint":"You don't buy superstition."},{"id":"press","label":"Press him for details","tone":"danger","hint":"He doesn't like questions."}],"defaultId":"buy_treasure"}},{"id":"dw_gray_implant_flare","kind":"minor","trigger":{"mode":["camp"],"block":["night"],"mythicEnabled":true,"requiresFlagsAll":["cf_gray_trail_active"],"requiresPartyTraitAny":["implanted"],"hoursSinceFlagAtLeast":{"dw_gray_implant_flare_time":48}},"weight":2,"tension":{"min":15,"max":95},"tags":["alien","body","night"],"log":{"tone":"event","text":"Someone wakes with a sharp pain under the skin\u2014then a brief, distant chorus like singing wire."},"effects":[{"type":"setFlag","key":"dw_gray_implant_flare_time","value":"NOW_HOUR"},{"type":"personAddThought","target":{"selector":"randomWithTrait:implanted"},"thought":{"id":"dw_implant","label":"Implant pain","value":-2,"hours":14,"source":"illness"}},{"type":"roll","chance":0.35,"then":[{"type":"personRevealHiddenTrait","target":{"selector":"randomWithTrait:implanted"},"reason":"implant flare"}]}]},{"id":"dw_gray_star_map_scrap","kind":"breather","trigger":{"mode":["travel"],"block":["noon"],"mythicEnabled":true,"requiresFlagsAll":["cf_gray_trail_active"],"hoursSinceFlagAtLeast":{"dw_gray_star_map_time":120}},"weight":2,"tension":{"min":0,"max":75},"tags":["alien","wayfinding","breather"],"log":{"tone":"event","text":"Tangled in sagebrush you find oilcloth covered in star marks that don't match the sky. It feels important anyway."},"effects":[{"type":"setFlag","key":"dw_gray_star_map_time","value":"NOW_HOUR"},{"type":"suppliesDelta","supplyId":"itm_star_map_scrap","delta":1,"clampMin":0},{"type":"roll","chance":0.3,"then":[{"type":"giveCurio","curioId":"cur_star_map_scrap"}]}]},{"id":"dw_eye_leaflets_blow_in","kind":"minor","trigger":{"mode":["camp"],"block":["morning"],"mythicEnabled":true,"requiresFlagsAll":["cf_open_eye_active"],"hoursSinceFlagAtLeast":{"dw_eye_leaflets_time":48}},"weight":3,"tension":{"min":0,"max":70},"tags":["cult","omen","paper"],"log":{"tone":"event","text":"Leaflets tumble through camp like dry leaves. Each shows the same inked open eye, staring up at the sky."},"effects":[{"type":"setFlag","key":"dw_eye_leaflets_time","value":"NOW_HOUR"},{"type":"suppliesDelta","supplyId":"itm_inked_leaflet","delta":2,"clampMin":0},{"type":"mythicRumorDelta","delta":1},{"type":"roll","chance":0.25,"then":[{"type":"personAddAffliction","target":{"selector":"randomAlive"},"afflictionId":"aff_ink_sickness","severity":{"min":1,"max":2}}]}]},{"id":"dw_eye_procession_on_trail","kind":"major","trigger":{"mode":["travel"],"block":["noon","evening"],"mythicEnabled":true,"requiresFlagsAll":["cf_open_eye_active"],"hoursSinceFlagAtLeast":{"dw_eye_procession_time":120}},"weight":2,"tension":{"min":10,"max":90},"tags":["cult","trade","social"],"effects":[{"type":"setFlag","key":"dw_eye_procession_time","value":"NOW_HOUR"},{"type":"choiceOutcomeMap","byChoice":{"trade":[{"type":"suppliesDelta","supplyId":"treasure","delta":-1,"clampMin":0},{"type":"suppliesDelta","supplyId":"itm_eye_charm","delta":1,"clampMin":0},{"type":"suppliesDelta","supplyId":"itm_blessed_herbs","delta":1,"clampMin":0},{"type":"factionRepDelta","factionId":"open_eye","delta":3}],"listen":[{"type":"mythicRumorDelta","delta":2},{"type":"personAddThought","target":{"selector":"randomAlive"},"thought":{"id":"dw_sermon","label":"Strange comfort in doctrine","value":1,"hours":18,"source":"social"}},{"type":"factionRepDelta","factionId":"open_eye","delta":2}],"mock":[{"type":"tensionDelta","delta":3},{"type":"personAddThought","target":{"selector":"randomAlive"},"thought":{"id":"dw_mocked","label":"Mocked the faithful","value":-2,"hours":12,"source":"social"}},{"type":"factionRepDelta","factionId":"open_eye","delta":-4}],"join":[{"type":"personAddTrait","target":{"selector":"randomAlive"},"traitId":"oathbound_eye"},{"type":"factionRepDelta","factionId":"open_eye","delta":5},{"type":"personAddThought","target":{"selector":"randomAlive"},"thought":{"id":"dw_belief","label":"Felt protected by belief","value":2,"hours":24,"source":"omen"}}]}}],"encounter":{"title":"Procession of the Open Eye","subtitleFromCtx":"location","body":["A line of travelers walks beside the trail, quiet as a funeral. Their necklaces are charms painted with eyes.","Their leader offers trade\u2014then asks if you have 'seen the watchers in the clouds.'"],"tags":["travel","trade","social"],"options":[{"id":"trade","label":"Trade with them","tone":"neutral","hint":"They carry odd goods."},{"id":"listen","label":"Listen to their doctrine","tone":"warm","hint":"It might steady morale\u2014or break it."},{"id":"mock","label":"Mock them and move on","tone":"danger","hint":"Insulting strangers has a cost."},{"id":"join","label":"Accept a charm and walk a mile with them","tone":"warm","hint":"Belief is contagious."}],"defaultId":"trade"}},{"id":"dw_eye_river_baptism","kind":"breather","trigger":{"mode":["camp"],"block":["evening"],"mythicEnabled":true,"requiresFlagsAll":["cf_open_eye_active"],"riskAny":["water_shortage"],"hoursSinceFlagAtLeast":{"dw_eye_baptism_time":96}},"weight":2,"tension":{"min":0,"max":75},"tags":["cult","river","breather"],"effects":[{"type":"setFlag","key":"dw_eye_baptism_time","value":"NOW_HOUR"},{"type":"choiceOutcomeMap","byChoice":{"accept":[{"type":"suppliesDelta","supplyId":"water","delta":2,"clampMin":0},{"type":"personAddThought","target":{"selector":"randomAlive"},"thought":{"id":"dw_blessed","label":"Felt blessed","value":2,"hours":18,"source":"omen"}},{"type":"factionRepDelta","factionId":"open_eye","delta":2}],"pay":[{"type":"suppliesDelta","supplyId":"treasure","delta":-1,"clampMin":0},{"type":"suppliesDelta","supplyId":"itm_salt_cord","delta":1,"clampMin":0},{"type":"suppliesDelta","supplyId":"itm_blessed_herbs","delta":1,"clampMin":0},{"type":"factionRepDelta","factionId":"open_eye","delta":3}],"decline":[{"type":"factionRepDelta","factionId":"open_eye","delta":-1}],"burn":[{"type":"factionRepDelta","factionId":"open_eye","delta":-5},{"type":"tensionDelta","delta":2},{"type":"personAddThought","target":{"selector":"leader"},"thought":{"id":"dw_burned","label":"Burned a blessing","value":-2,"hours":12,"source":"social"}}]}}],"encounter":{"title":"A river blessing","subtitleFromCtx":"location","body":["A traveler offers to tie a salt cord to your wagon tongue and speak a blessing over the water skins.","They say the Open Eye hates thirst and loves witnesses."],"tags":["camp","water","omen"],"options":[{"id":"accept","label":"Accept the blessing","tone":"warm","hint":"Hope is a resource."},{"id":"pay","label":"Pay for extra cord and herbs","tone":"neutral","hint":"Turn it into trade."},{"id":"decline","label":"Decline politely","tone":"neutral","hint":"You don't want new gods."},{"id":"burn","label":"Burn the cord as a warning","tone":"danger","hint":"This will offend someone."}],"defaultId":"accept"}},{"id":"dw_eye_inked_dream","kind":"minor","trigger":{"mode":["camp"],"block":["night"],"mythicEnabled":true,"requiresFlagsAll":["cf_open_eye_active"],"hoursSinceFlagAtLeast":{"dw_eye_dream_time":72}},"weight":2,"tension":{"min":10,"max":85},"tags":["cult","dream","night"],"log":{"tone":"event","text":"Someone dreams of an eye drawn in smoke. They wake with their hand stained as if they\u2019d been writing."},"effects":[{"type":"setFlag","key":"dw_eye_dream_time","value":"NOW_HOUR"},{"type":"personAddThought","target":{"selector":"randomAlive"},"thought":{"id":"dw_eye_dream","label":"Inked dream","value":-1,"hours":16,"source":"omen"}},{"type":"roll","chance":0.35,"then":[{"type":"personAddHiddenTrait","target":{"selector":"randomAlive"},"traitId":"ink_touched"}]},{"type":"roll","chance":0.2,"then":[{"type":"personRevealHiddenTrait","target":{"selector":"randomAlive"},"reason":"inked dream"}]}]},{"id":"dw_eye_salt_circle","kind":"minor","trigger":{"mode":["camp"],"block":["night"],"mythicEnabled":true,"requiresFlagsAll":["cf_open_eye_active"],"riskAny":["no_guard"],"hoursSinceFlagAtLeast":{"dw_eye_salt_circle_time":96}},"weight":2,"tension":{"min":15,"max":95},"tags":["cult","defense","night"],"effects":[{"type":"setFlag","key":"dw_eye_salt_circle_time","value":"NOW_HOUR"},{"type":"choiceOutcomeMap","byChoice":{"make":[{"type":"suppliesDelta","supplyId":"itm_salt_cord","delta":-1,"clampMin":0},{"type":"tensionDelta","delta":-2},{"type":"personAddThought","target":{"selector":"randomAlive"},"thought":{"id":"dw_circle","label":"Slept inside a salt circle","value":1,"hours":12,"source":"camp"}},{"type":"factionRepDelta","factionId":"open_eye","delta":1}],"proper_guard":[{"type":"tensionDelta","delta":-1},{"type":"personAddThought","target":{"selector":"leader"},"thought":{"id":"dw_practical","label":"Chose practicality","value":1,"hours":10,"source":"social"}}],"laugh":[{"type":"tensionDelta","delta":2},{"type":"personAddThought","target":{"selector":"randomAlive"},"thought":{"id":"dw_laughed","label":"Laughed at omens","value":-2,"hours":12,"source":"social"}}]}}],"encounter":{"title":"Salt circle","subtitleFromCtx":"location","body":["With no one posted on guard, someone suggests a salt circle around the wagons.","It feels foolish. It also feels\u2026 necessary."],"tags":["camp","danger","omen"],"options":[{"id":"make","label":"Make the circle","tone":"warm","hint":"Use cord and salt to buy a night of sleep."},{"id":"proper_guard","label":"Assign a guard instead","tone":"neutral","hint":"Trust people, not symbols."},{"id":"laugh","label":"Laugh it off","tone":"danger","hint":"The night doesn't laugh back."}],"defaultId":"make"}},{"id":"dw_eye_charm_peddler","kind":"lifeline","trigger":{"mode":["travel"],"block":["noon"],"mythicEnabled":true,"requiresFlagsAll":["cf_open_eye_active"],"hoursSinceFlagAtLeast":{"dw_eye_charm_time":96}},"weight":2,"tension":{"min":0,"max":80},"tags":["trade","cult","lifeline"],"effects":[{"type":"setFlag","key":"dw_eye_charm_time","value":"NOW_HOUR"},{"type":"choiceOutcomeMap","byChoice":{"buy":[{"type":"suppliesDelta","supplyId":"treasure","delta":-1,"clampMin":0},{"type":"suppliesDelta","supplyId":"itm_eye_charm","delta":1,"clampMin":0},{"type":"factionRepDelta","factionId":"open_eye","delta":1}],"barter_pelts":[{"type":"suppliesDelta","supplyId":"pelts","delta":-2,"clampMin":0},{"type":"suppliesDelta","supplyId":"itm_eye_charm","delta":1,"clampMin":0},{"type":"suppliesDelta","supplyId":"itm_blessed_herbs","delta":1,"clampMin":0},{"type":"factionRepDelta","factionId":"open_eye","delta":2}],"decline":[{"type":"factionRepDelta","factionId":"open_eye","delta":-1}],"test":[{"type":"tensionDelta","delta":2},{"type":"personAddThought","target":{"selector":"leader"},"thought":{"id":"dw_tested","label":"Tested a charm seller","value":-2,"hours":12,"source":"social"}},{"type":"factionRepDelta","factionId":"open_eye","delta":-2}]}}],"encounter":{"title":"Charm seller","subtitleFromCtx":"location","body":["A peddler lays out eye charms and bundles of herbs on a blanket. 'Protection,' he says, 'priced for travelers.'","His shadow doesn't quite match his movements."],"tags":["trade","omen"],"options":[{"id":"buy","label":"Buy a charm (1 treasure)","tone":"neutral","hint":"A small wager against the unknown."},{"id":"barter_pelts","label":"Barter with pelts (2 pelts)","tone":"neutral","hint":"Trade proof of survival for promises."},{"id":"decline","label":"Decline","tone":"neutral","hint":"You don't need more gods."},{"id":"test","label":"Test his story","tone":"danger","hint":"He dislikes doubt."}],"defaultId":"buy"}},{"id":"dw_eye_false_prophet","kind":"major","trigger":{"mode":["camp"],"block":["evening"],"mythicEnabled":true,"requiresFlagsAll":["cf_open_eye_active"],"hoursSinceFlagAtLeast":{"dw_eye_prophet_time":168}},"weight":1,"tension":{"min":20,"max":100},"tags":["cult","social","setpiece"],"effects":[{"type":"setFlag","key":"dw_eye_prophet_time","value":"NOW_HOUR"},{"type":"choiceOutcomeMap","byChoice":{"hear":[{"type":"mythicRumorDelta","delta":2},{"type":"personAddThought","target":{"selector":"randomAlive"},"thought":{"id":"dw_prophecy","label":"Heard a prophecy","value":-1,"hours":24,"source":"omen"}},{"type":"tensionDelta","delta":1}],"banish":[{"type":"tensionDelta","delta":-1},{"type":"factionRepDelta","factionId":"open_eye","delta":-3},{"type":"personAddThought","target":{"selector":"leader"},"thought":{"id":"dw_banish","label":"Banished a prophet","value":-1,"hours":12,"source":"social"}}],"challenge":[{"type":"tensionDelta","delta":3},{"type":"personAddThought","target":{"selector":"randomAlive"},"thought":{"id":"dw_schism","label":"Argument over faith","value":-3,"hours":18,"source":"social"}},{"type":"factionRepDelta","factionId":"open_eye","delta":-2}],"offer":[{"type":"suppliesDelta","supplyId":"meal_simple","delta":-1,"clampMin":0},{"type":"personAddTrait","target":{"selector":"randomAlive"},"traitId":"oathbound_eye"},{"type":"factionRepDelta","factionId":"open_eye","delta":3},{"type":"personAddThought","target":{"selector":"randomAlive"},"thought":{"id":"dw_blessing","label":"Received a blessing","value":2,"hours":24,"source":"omen"}}]}}],"encounter":{"title":"The prophet by the fire","subtitleFromCtx":"location","body":["A stranger sits by your fire as if invited. He speaks in soft certainty about who will live and who will not.","He says the Open Eye showed him your wagon on the trail weeks ago."],"tags":["camp","social","omen"],"options":[{"id":"hear","label":"Hear him out","tone":"neutral","hint":"Knowledge, even false, can guide choices."},{"id":"banish","label":"Ban him from camp","tone":"danger","hint":"Certainty is a weapon."},{"id":"challenge","label":"Challenge his 'visions'","tone":"danger","hint":"Public doubt sparks conflict."},{"id":"offer","label":"Offer food and ask for a blessing","tone":"warm","hint":"Turn fear into ritual."}],"defaultId":"hear"}},{"id":"dw_eye_ink_sickness","kind":"minor","trigger":{"mode":["camp"],"block":["evening","night"],"mythicEnabled":true,"requiresFlagsAll":["cf_open_eye_active"],"requiresSupplyAtLeast":{"itm_inked_leaflet":1},"hoursSinceFlagAtLeast":{"dw_eye_ink_sickness_time":72}},"weight":2,"tension":{"min":10,"max":85},"tags":["cult","illness"],"log":{"tone":"event","text":"Someone handled the leaflets for too long. Their fingers stain dark, and a low fever follows."},"effects":[{"type":"setFlag","key":"dw_eye_ink_sickness_time","value":"NOW_HOUR"},{"type":"personAddAffliction","target":{"selector":"randomAlive"},"afflictionId":"aff_ink_sickness","severity":{"min":1,"max":2}},{"type":"personAddThought","target":{"selector":"randomAlive"},"thought":{"id":"dw_ink","label":"Ink under the nails","value":-1,"hours":12,"source":"illness"}}]},{"id":"dw_oil_sheen_in_creek","kind":"minor","trigger":{"mode":["travel","camp"],"block":["noon","evening"],"mythicEnabled":true,"requiresFlagsAll":["cf_black_oil_active"],"hoursSinceFlagAtLeast":{"dw_oil_sheen_time":60}},"weight":3,"tension":{"min":10,"max":90},"tags":["infection","water","omen"],"log":{"tone":"event","text":"A thin black sheen drifts on the creek. It moves against the current like it's thinking."},"effects":[{"type":"setFlag","key":"dw_oil_sheen_time","value":"NOW_HOUR"},{"type":"roll","chance":0.35,"then":[{"type":"personAddAffliction","target":{"selector":"randomAlive"},"afflictionId":"aff_black_oil","severity":{"min":1,"max":2}},{"type":"mythicRumorDelta","delta":1}]},{"type":"personAddThought","target":{"selector":"randomAlive"},"thought":{"id":"dw_sheen","label":"Unnerved by the sheen","value":-1,"hours":12,"source":"omen"}}]},{"id":"dw_oil_tar_pit","kind":"major","trigger":{"mode":["travel"],"block":["noon","evening"],"mythicEnabled":true,"requiresFlagsAll":["cf_black_oil_active"],"hoursSinceFlagAtLeast":{"dw_oil_tar_pit_time":120}},"weight":2,"tension":{"min":20,"max":100},"tags":["infection","craft","danger"],"effects":[{"type":"setFlag","key":"dw_oil_tar_pit_time","value":"NOW_HOUR"},{"type":"choiceOutcomeMap","byChoice":{"harvest":[{"type":"suppliesDelta","supplyId":"itm_tar_grease","delta":1,"clampMin":0},{"type":"personSkillDelta","target":{"selector":"highestSkill:repair"},"skill":"repair","delta":0.1},{"type":"roll","chance":0.45,"then":[{"type":"personAddAffliction","target":{"selector":"randomAlive"},"afflictionId":"aff_black_oil","severity":{"min":1,"max":3}}]}],"burn":[{"type":"suppliesDelta","supplyId":"wood","delta":-2,"clampMin":0},{"type":"tensionDelta","delta":-1},{"type":"mythicRumorDelta","delta":1}],"avoid":[{"type":"tensionDelta","delta":-1}]}}],"encounter":{"title":"Tar pit","subtitleFromCtx":"location","body":["You find a tar pit bubbling quietly. The smell is sharp and sweet, like burnt sugar.","A little grease could help the wagon axles. Or poison the whole trip."],"tags":["travel","danger"],"options":[{"id":"harvest","label":"Harvest tar grease","tone":"neutral","hint":"Risk illness for repairs."},{"id":"burn","label":"Burn it away from camp","tone":"danger","hint":"Fire solves problems. Sometimes."},{"id":"avoid","label":"Avoid it","tone":"warm","hint":"Leave the thinking tar alone."}],"defaultId":"avoid"}},{"id":"dw_oil_strange_meat","kind":"major","trigger":{"mode":["camp"],"block":["evening"],"mythicEnabled":true,"requiresFlagsAll":["cf_black_oil_active"],"hoursSinceFlagAtLeast":{"dw_oil_meat_time":96}},"weight":2,"tension":{"min":10,"max":95},"tags":["infection","food","choice"],"effects":[{"type":"setFlag","key":"dw_oil_meat_time","value":"NOW_HOUR"},{"type":"choiceOutcomeMap","byChoice":{"cook":[{"type":"suppliesDelta","supplyId":"fresh_meat","delta":2,"clampMin":0},{"type":"personAddThought","target":{"selector":"randomAlive"},"thought":{"id":"dw_full","label":"A filling meal","value":2,"hours":12,"source":"food"}},{"type":"roll","chance":0.5,"then":[{"type":"personAddAffliction","target":{"selector":"randomAlive"},"afflictionId":"aff_black_oil","severity":{"min":1,"max":3}},{"type":"personAddThought","target":{"selector":"randomAlive"},"thought":{"id":"dw_sick","label":"A bad meal","value":-3,"hours":18,"source":"illness"}}]}],"bury":[{"type":"tensionDelta","delta":-1},{"type":"personAddThought","target":{"selector":"leader"},"thought":{"id":"dw_refused_gift","label":"Refused a gift","value":1,"hours":12,"source":"social"}}],"trade":[{"type":"suppliesDelta","supplyId":"treasure","delta":1,"clampMin":0},{"type":"tensionDelta","delta":1}],"burn":[{"type":"suppliesDelta","supplyId":"wood","delta":-1,"clampMin":0},{"type":"tensionDelta","delta":-1}]}}],"encounter":{"title":"Meat that shouldn't be here","subtitleFromCtx":"location","body":["Someone finds a bundle of fresh meat wrapped in cloth, left near camp as if a gift.","The fat gleams with a dark sheen in the firelight."],"tags":["camp","food","danger"],"options":[{"id":"cook","label":"Cook it thoroughly","tone":"neutral","hint":"Food is food when you're hungry."},{"id":"bury","label":"Bury it","tone":"warm","hint":"Refuse the gift."},{"id":"trade","label":"Save it to trade","tone":"neutral","hint":"Let someone else take the risk."},{"id":"burn","label":"Burn it","tone":"danger","hint":"No more temptations."}],"defaultId":"bury"}},{"id":"dw_oil_fire_snuffed","kind":"setpiece","trigger":{"mode":["camp"],"block":["night"],"mythicEnabled":true,"requiresFlagsAll":["cf_black_oil_active"],"requiresPartyTraitAny":["oil_carrier"],"hoursSinceFlagAtLeast":{"dw_oil_fire_time":120}},"weight":1,"tension":{"min":25,"max":100},"tags":["infection","night","setpiece"],"effects":[{"type":"setFlag","key":"dw_oil_fire_time","value":"NOW_HOUR"},{"type":"choiceOutcomeMap","byChoice":{"relight":[{"type":"suppliesDelta","supplyId":"wood","delta":-2,"clampMin":0},{"type":"tensionDelta","delta":-1},{"type":"personAddThought","target":{"selector":"randomAlive"},"thought":{"id":"dw_relief","label":"Fire relit","value":1,"hours":10,"source":"camp"}}],"wait":[{"type":"tensionDelta","delta":3},{"type":"roll","chance":0.6,"then":[{"type":"personAddAffliction","target":{"selector":"randomAlive"},"afflictionId":"aff_black_oil","severity":{"min":1,"max":2}}]},{"type":"personAddThought","target":{"selector":"randomAlive"},"thought":{"id":"dw_dark","label":"Waited in unnatural dark","value":-3,"hours":14,"source":"omen"}}],"torches":[{"type":"suppliesDelta","supplyId":"wood","delta":-1,"clampMin":0},{"type":"tensionDelta","delta":1},{"type":"personAddThought","target":{"selector":"leader"},"thought":{"id":"dw_torches","label":"Kept light moving","value":-1,"hours":10,"source":"camp"}}]}}],"encounter":{"title":"The fire goes out","subtitleFromCtx":"location","body":["The campfire gutters, then dies as if a hand pressed it down. No wind. No rain.","In the darkness, someone whispers: 'Don't light it.'"],"tags":["camp","danger","night"],"options":[{"id":"relight","label":"Relight it immediately","tone":"neutral","hint":"Spend wood; reclaim control."},{"id":"wait","label":"Wait in the dark","tone":"danger","hint":"Listen for what wants the fire dead."},{"id":"torches","label":"Light torches and spread out","tone":"neutral","hint":"Use fuel, reduce panic."}],"defaultId":"relight"}},{"id":"dw_oil_ash_salve_trader","kind":"lifeline","trigger":{"mode":["travel"],"block":["noon"],"mythicEnabled":true,"requiresFlagsAll":["cf_black_oil_active"],"hoursSinceFlagAtLeast":{"dw_oil_salve_time":144}},"weight":2,"tension":{"min":0,"max":90},"tags":["trade","lifeline","medicine"],"effects":[{"type":"setFlag","key":"dw_oil_salve_time","value":"NOW_HOUR"},{"type":"choiceOutcomeMap","byChoice":{"buy":[{"type":"suppliesDelta","supplyId":"treasure","delta":-1,"clampMin":0},{"type":"suppliesDelta","supplyId":"itm_ash_salve","delta":1,"clampMin":0},{"type":"personAddThought","target":{"selector":"leader"},"thought":{"id":"dw_prepared","label":"Felt prepared","value":1,"hours":12,"source":"medicine"}}],"trade_herbs":[{"type":"suppliesDelta","supplyId":"herbs","delta":-2,"clampMin":0},{"type":"suppliesDelta","supplyId":"itm_ash_salve","delta":1,"clampMin":0}],"ask":[{"type":"mythicRumorDelta","delta":2},{"type":"personAddThought","target":{"selector":"randomAlive"},"thought":{"id":"dw_warning","label":"Heard a warning","value":1,"hours":18,"source":"social"}}],"refuse":[{"type":"tensionDelta","delta":1}]}}],"encounter":{"title":"A healer with soot on her hands","subtitleFromCtx":"location","body":["A traveler approaches with hands stained black\u2014not with oil, but with ash.","She offers ash salve and warns: 'Don't share cups when the oil is near.'"],"tags":["trade","medicine"],"options":[{"id":"buy","label":"Buy ash salve (1 treasure)","tone":"neutral","hint":"A cure is worth weight."},{"id":"trade_herbs","label":"Trade herbs for salve (2 herbs)","tone":"neutral","hint":"Swap medicine for medicine."},{"id":"ask","label":"Ask about the oil","tone":"warm","hint":"Knowledge might prevent the next sickness."},{"id":"refuse","label":"Refuse","tone":"neutral","hint":"Save your goods."}],"defaultId":"buy"}},{"id":"dw_mirror_chalk_marks","kind":"minor","trigger":{"mode":["travel"],"block":["morning","noon"],"mythicEnabled":true,"requiresFlagsAll":["cf_mirror_road_active"],"hoursSinceFlagAtLeast":{"dw_mirror_chalk_time":72}},"weight":3,"tension":{"min":10,"max":90},"tags":["time","omen","travel"],"log":{"tone":"event","text":"Chalk marks line a boulder: a circle, a line, a number. The marks look new, but the rock is old."},"effects":[{"type":"setFlag","key":"dw_mirror_chalk_time","value":"NOW_HOUR"},{"type":"suppliesDelta","supplyId":"itm_time_chalk","delta":1,"clampMin":0},{"type":"mythicRumorDelta","delta":1},{"type":"roll","chance":0.2,"then":[{"type":"personAddHiddenTrait","target":{"selector":"randomAlive"},"traitId":"time_sense"}]}]},{"id":"dw_mirror_shard_glint","kind":"breather","trigger":{"mode":["travel"],"block":["noon"],"mythicEnabled":true,"requiresFlagsAll":["cf_mirror_road_active"],"hoursSinceFlagAtLeast":{"dw_mirror_shard_time":96}},"weight":2,"tension":{"min":0,"max":75},"tags":["time","artifact","breather"],"log":{"tone":"event","text":"Sunlight catches a shard in the grass. It reflects your wagon\u2014then, for a blink, a different wagon behind you."},"effects":[{"type":"setFlag","key":"dw_mirror_shard_time","value":"NOW_HOUR"},{"type":"suppliesDelta","supplyId":"itm_mirror_shard","delta":1,"clampMin":0},{"type":"roll","chance":0.4,"then":[{"type":"giveCurio","curioId":"cur_mirror_shard"}]},{"type":"personAddThought","target":{"selector":"randomAlive"},"thought":{"id":"dw_glint","label":"Unsettled by a reflection","value":-1,"hours":10,"source":"omen"}}]},{"id":"dw_mirror_no_reflection","kind":"minor","trigger":{"mode":["camp"],"block":["evening"],"mythicEnabled":true,"requiresFlagsAll":["cf_mirror_road_active"],"hoursSinceFlagAtLeast":{"dw_mirror_reflection_time":120}},"weight":2,"tension":{"min":15,"max":95},"tags":["time","doubles","social"],"effects":[{"type":"setFlag","key":"dw_mirror_reflection_time","value":"NOW_HOUR"},{"type":"choiceOutcomeMap","byChoice":{"comfort":[{"type":"personAddThought","target":{"selector":"randomAlive"},"thought":{"id":"dw_supported","label":"Felt supported","value":2,"hours":14,"source":"social"}},{"type":"tensionDelta","delta":-1}],"test":[{"type":"personAddThought","target":{"selector":"randomAlive"},"thought":{"id":"dw_tested","label":"Tested like a specimen","value":-2,"hours":12,"source":"social"}},{"type":"tensionDelta","delta":1}],"accuse":[{"type":"tensionDelta","delta":3},{"type":"personAddThought","target":{"selector":"randomAlive"},"thought":{"id":"dw_accused_double","label":"Accused of being a double","value":-4,"hours":18,"source":"social"}}]}},{"type":"roll","chance":0.35,"then":[{"type":"personAddHiddenTrait","target":{"selector":"randomAlive"},"traitId":"mirrorstruck"}]},{"type":"roll","chance":0.25,"then":[{"type":"personRevealHiddenTrait","target":{"selector":"randomAlive"},"reason":"missing reflection"}]}],"encounter":{"title":"No reflection","subtitleFromCtx":"location","body":["At the creek, someone notices their reflection isn't there. The water shows only reeds and sky.","Everyone pretends not to stare. Everyone stares."],"tags":["camp","social","omen"],"options":[{"id":"comfort","label":"Comfort them","tone":"warm","hint":"Keep the group together."},{"id":"test","label":"Test it again","tone":"neutral","hint":"Certainty is safer than doubt."},{"id":"accuse","label":"Accuse them of being a double","tone":"danger","hint":"Paranoia fractures the party."}],"defaultId":"comfort"}},{"id":"dw_time_loop_morning","kind":"setpiece","trigger":{"mode":["camp"],"block":["morning"],"mythicEnabled":true,"requiresFlagsAll":["cf_mirror_road_active"],"hoursSinceFlagAtLeast":{"dw_time_loop_time":200},"forbidsFlagsAny":["dw_time_loop_active"]},"weight":1,"tension":{"min":25,"max":100},"tags":["time","setpiece","loop"],"effects":[{"type":"setFlag","key":"dw_time_loop_time","value":"NOW_HOUR"},{"type":"setFlag","key":"dw_time_loop_active","value":true},{"type":"choiceOutcomeMap","byChoice":{"exploit":[{"type":"suppliesDelta","supplyId":"wood","delta":2,"clampMin":0},{"type":"suppliesDelta","supplyId":"water","delta":1,"clampMin":0},{"type":"personSkillDelta","target":{"selector":"randomAlive"},"skill":"repair","delta":0.05},{"type":"personAddAffliction","target":{"selector":"randomAlive"},"afflictionId":"aff_time_sickness","severity":{"min":1,"max":2}},{"type":"tensionDelta","delta":2}],"break":[{"type":"personStatDelta","target":{"selector":"randomAlive"},"stat":"energy","delta":-3},{"type":"tensionDelta","delta":-1}],"accept":[{"type":"personAddThought","target":{"selector":"randomAlive"},"thought":{"id":"dw_loop","label":"Lived the same hour twice","value":-2,"hours":18,"source":"omen"}},{"type":"tensionDelta","delta":1}]}},{"type":"setFlag","key":"dw_time_loop_active","value":false}],"encounter":{"title":"The morning repeats","subtitleFromCtx":"location","body":["You wake to the same birdsong, the same ash pattern, the same crack in the wagon yoke.","Someone says: 'Didn't we already do this?'"],"tags":["camp","omen","danger"],"options":[{"id":"exploit","label":"Exploit the loop (work twice)","tone":"neutral","hint":"Gain supplies; risk sickness."},{"id":"break","label":"Break the loop (move immediately)","tone":"danger","hint":"Spend energy; keep sanity."},{"id":"accept","label":"Accept it (act normal)","tone":"neutral","hint":"Maybe it ends on its own."}],"defaultId":"break"}},{"id":"dw_mirror_double_wagon","kind":"major","trigger":{"mode":["travel"],"block":["noon","evening"],"mythicEnabled":true,"requiresFlagsAll":["cf_mirror_road_active"],"hoursSinceFlagAtLeast":{"dw_mirror_double_time":180}},"weight":1,"tension":{"min":20,"max":100},"tags":["time","doubles","trade"],"effects":[{"type":"setFlag","key":"dw_mirror_double_time","value":"NOW_HOUR"},{"type":"choiceOutcomeMap","byChoice":{"hail":[{"type":"mythicRumorDelta","delta":2},{"type":"personAddThought","target":{"selector":"leader"},"thought":{"id":"dw_hail","label":"Spoke to your own shadow","value":-2,"hours":24,"source":"omen"}},{"type":"tensionDelta","delta":2}],"trade":[{"type":"roll","chance":0.6,"then":[{"type":"suppliesDelta","supplyId":"treasure","delta":2,"clampMin":0}],"else":[{"type":"suppliesDelta","supplyId":"flour","delta":-2,"clampMin":0}]},{"type":"tensionDelta","delta":1}],"race":[{"type":"personStatDelta","target":{"selector":"randomAlive"},"stat":"energy","delta":-3},{"type":"tensionDelta","delta":3},{"type":"roll","chance":0.3,"then":[{"type":"personAddAffliction","target":{"selector":"randomAlive"},"afflictionId":"sprain","severity":{"min":1,"max":2}}]}],"avoid":[{"type":"tensionDelta","delta":-1},{"type":"timeSkipHours","hours":2,"note":"Detour around the impossible."}]}}],"encounter":{"title":"Your wagon, ahead of you","subtitleFromCtx":"location","body":["Ahead on the trail is your wagon. Same canvas patch. Same chipped wheel rim.","The driver turns. It's your leader's face\u2014then not, then yes again."],"tags":["travel","danger","omen"],"options":[{"id":"hail","label":"Hail them","tone":"neutral","hint":"Answers might cost."},{"id":"trade","label":"Trade quickly and leave","tone":"neutral","hint":"Profit from the impossible."},{"id":"race","label":"Race past them","tone":"danger","hint":"Don't let your future overtake you."},{"id":"avoid","label":"Avoid and detour","tone":"warm","hint":"Lose time; keep reality."}],"defaultId":"avoid"}},{"id":"dw_bone_wind_whistle","kind":"minor","trigger":{"mode":["travel"],"block":["evening"],"mythicEnabled":true,"requiresFlagsAll":["cf_bone_valley_active"],"hoursSinceFlagAtLeast":{"dw_bone_wind_time":72}},"weight":3,"tension":{"min":10,"max":85},"tags":["bones","omen","sound"],"log":{"tone":"event","text":"Wind crosses a dry gulch and whistles through something like ribs. The sound follows you longer than it should."},"effects":[{"type":"setFlag","key":"dw_bone_wind_time","value":"NOW_HOUR"},{"type":"personAddThought","target":{"selector":"randomAlive"},"thought":{"id":"dw_bone_wind","label":"Unnerved by bone-whistling wind","value":-2,"hours":12,"source":"omen"}},{"type":"mythicRumorDelta","delta":1}]},{"id":"dw_bone_whistle_find","kind":"breather","trigger":{"mode":["travel"],"block":["noon"],"mythicEnabled":true,"requiresFlagsAll":["cf_bone_valley_active"],"hoursSinceFlagAtLeast":{"dw_bone_whistle_time":120}},"weight":2,"tension":{"min":0,"max":75},"tags":["bones","artifact","breather"],"log":{"tone":"event","text":"Half-buried in chalky soil is a small bone whistle. It feels warm, like it was just held."},"effects":[{"type":"setFlag","key":"dw_bone_whistle_time","value":"NOW_HOUR"},{"type":"suppliesDelta","supplyId":"itm_bone_whistle","delta":1,"clampMin":0},{"type":"roll","chance":0.4,"then":[{"type":"giveCurio","curioId":"cur_bone_whistle"}]}]},{"id":"dw_bone_dust_cough","kind":"minor","trigger":{"mode":["travel"],"block":["noon","evening"],"mythicEnabled":true,"requiresFlagsAll":["cf_bone_valley_active"],"weatherAny":["heat"],"hoursSinceFlagAtLeast":{"dw_bone_dust_time":72}},"weight":2,"tension":{"min":10,"max":90},"tags":["bones","illness","weather"],"log":{"tone":"event","text":"A gust kicks up white dust that coats teeth and tongue. Someone coughs until their eyes water."},"effects":[{"type":"setFlag","key":"dw_bone_dust_time","value":"NOW_HOUR"},{"type":"personAddAffliction","target":{"selector":"randomAlive"},"afflictionId":"aff_bone_dust_cough","severity":{"min":1,"max":2}},{"type":"personAddThought","target":{"selector":"randomAlive"},"thought":{"id":"dw_dust","label":"Choked on dust","value":-1,"hours":10,"source":"illness"}}]},{"id":"dw_bone_pickers_trader","kind":"lifeline","trigger":{"mode":["travel"],"block":["noon"],"mythicEnabled":true,"requiresFlagsAll":["cf_bone_valley_active"],"hoursSinceFlagAtLeast":{"dw_bone_trader_time":144}},"weight":2,"tension":{"min":0,"max":85},"tags":["bones","trade","lifeline"],"effects":[{"type":"setFlag","key":"dw_bone_trader_time","value":"NOW_HOUR"},{"type":"choiceOutcomeMap","byChoice":{"sell":[{"type":"suppliesDelta","supplyId":"itm_fossil_tooth","delta":-1,"clampMin":0},{"type":"moneyDelta","delta":10},{"type":"factionRepDelta","factionId":"bone_pickers","delta":3}],"buy":[{"type":"suppliesDelta","supplyId":"treasure","delta":-1,"clampMin":0},{"type":"suppliesDelta","supplyId":"itm_bone_whistle","delta":1,"clampMin":0},{"type":"factionRepDelta","factionId":"bone_pickers","delta":1}],"question":[{"type":"mythicRumorDelta","delta":2},{"type":"personAddThought","target":{"selector":"leader"},"thought":{"id":"dw_directions","label":"Got bleak directions","value":-1,"hours":12,"source":"social"}}],"refuse":[{"type":"factionRepDelta","factionId":"bone_pickers","delta":-1}]}}],"encounter":{"title":"A naturalist with too many teeth","subtitleFromCtx":"location","body":["A 'naturalist' opens a sack filled with fossil teeth and small bones.","He offers coin for anything white and old. He offers superstition for free."],"tags":["trade","social"],"options":[{"id":"sell","label":"Sell a fossil tooth (1)","tone":"neutral","hint":"Easy money, strange buyer."},{"id":"buy","label":"Buy a whistle and leave","tone":"neutral","hint":"A charm with history."},{"id":"question","label":"Question him about Bone Valley","tone":"warm","hint":"Get directions and warnings."},{"id":"refuse","label":"Refuse and move on","tone":"neutral","hint":"Keep your bones."}],"defaultId":"question"}},{"id":"dw_fungus_glow_caps","kind":"breather","trigger":{"mode":["camp"],"block":["evening"],"mythicEnabled":true,"requiresFlagsAll":["cf_fungal_bloom_active"],"hoursSinceFlagAtLeast":{"dw_fungus_caps_time":72}},"weight":3,"tension":{"min":0,"max":70},"tags":["fungus","food","breather"],"log":{"tone":"event","text":"Under a fallen log, mushrooms glow faintly blue-green. Bright enough to read by, if you dare."},"effects":[{"type":"setFlag","key":"dw_fungus_caps_time","value":"NOW_HOUR"},{"type":"suppliesDelta","supplyId":"itm_glow_cap","delta":2,"clampMin":0},{"type":"roll","chance":0.3,"then":[{"type":"suppliesDelta","supplyId":"itm_spore_sample","delta":1,"clampMin":0}]},{"type":"personAddThought","target":{"selector":"randomAlive"},"thought":{"id":"dw_glow","label":"Found glowing mushrooms","value":1,"hours":10,"source":"camp"}}]},{"id":"dw_fungus_spore_cloud","kind":"major","trigger":{"mode":["travel"],"block":["noon","evening"],"mythicEnabled":true,"requiresFlagsAll":["cf_fungal_bloom_active"],"hoursSinceFlagAtLeast":{"dw_fungus_cloud_time":120}},"weight":2,"tension":{"min":20,"max":100},"tags":["fungus","illness","danger"],"effects":[{"type":"setFlag","key":"dw_fungus_cloud_time","value":"NOW_HOUR"},{"type":"choiceOutcomeMap","byChoice":{"detour":[{"type":"timeSkipHours","hours":2,"note":"Detour around the spore cloud."},{"type":"tensionDelta","delta":-1}],"cover":[{"type":"suppliesDelta","supplyId":"clothing","delta":-1,"clampMin":0},{"type":"roll","chance":0.35,"then":[{"type":"personAddAffliction","target":{"selector":"randomAlive"},"afflictionId":"aff_spore_lung","severity":{"min":1,"max":2}}]},{"type":"tensionDelta","delta":1}],"charge":[{"type":"roll","chance":0.65,"then":[{"type":"personAddAffliction","target":{"selector":"randomAlive"},"afflictionId":"aff_spore_lung","severity":{"min":1,"max":3}},{"type":"personAddAffliction","target":{"selector":"randomAlive"},"afflictionId":"aff_dream_bleed","severity":{"min":1,"max":2}}]},{"type":"tensionDelta","delta":2}]}}],"encounter":{"title":"Spore cloud","subtitleFromCtx":"location","body":["A pale cloud drifts from the trees like lantern smoke. It smells sweet and wet.","Birds avoid it. So do your lungs."],"tags":["travel","danger"],"options":[{"id":"detour","label":"Detour around it","tone":"warm","hint":"Lose time; save health."},{"id":"cover","label":"Cover faces and push through","tone":"neutral","hint":"Spend cloth; risk less."},{"id":"charge","label":"Charge through quickly","tone":"danger","hint":"Risk sickness; save time."}],"defaultId":"cover"}},{"id":"dw_fungus_mushroom_dream","kind":"minor","trigger":{"mode":["camp"],"block":["night"],"mythicEnabled":true,"requiresFlagsAll":["cf_fungal_bloom_active"],"requiresSupplyAtLeast":{"itm_glow_cap":1},"hoursSinceFlagAtLeast":{"dw_mushroom_dream_time":96}},"weight":1,"tension":{"min":15,"max":95},"tags":["fungus","dream","night"],"log":{"tone":"event","text":"Someone sleeps too close to the glowing caps. They wake certain the ground is listening."},"effects":[{"type":"setFlag","key":"dw_mushroom_dream_time","value":"NOW_HOUR"},{"type":"personAddThought","target":{"selector":"randomAlive"},"thought":{"id":"dw_ground_listens","label":"Felt the ground listening","value":-1,"hours":18,"source":"omen"}},{"type":"roll","chance":0.35,"then":[{"type":"personAddHiddenTrait","target":{"selector":"randomAlive"},"traitId":"mycelial_symbiote"}]},{"type":"roll","chance":0.25,"then":[{"type":"personAddAffliction","target":{"selector":"randomAlive"},"afflictionId":"aff_dream_bleed","severity":{"min":1,"max":2}}]}]},{"id":"dw_fungus_mycelial_friends","kind":"lifeline","trigger":{"mode":["travel"],"block":["noon"],"mythicEnabled":true,"requiresFlagsAll":["cf_fungal_bloom_active"],"hoursSinceFlagAtLeast":{"dw_mycelial_friends_time":144}},"weight":2,"tension":{"min":0,"max":85},"tags":["fungus","trade","lifeline"],"effects":[{"type":"setFlag","key":"dw_mycelial_friends_time","value":"NOW_HOUR"},{"type":"choiceOutcomeMap","byChoice":{"trade":[{"type":"suppliesDelta","supplyId":"treasure","delta":-1,"clampMin":0},{"type":"suppliesDelta","supplyId":"itm_bitter_tea","delta":2,"clampMin":0},{"type":"factionRepDelta","factionId":"mycelial_friends","delta":3}],"ask":[{"type":"mythicRumorDelta","delta":2},{"type":"personAddTrait","target":{"selector":"randomAlive"},"traitId":"star_mapper"},{"type":"factionRepDelta","factionId":"mycelial_friends","delta":2}],"refuse":[{"type":"factionRepDelta","factionId":"mycelial_friends","delta":-1}]}}],"encounter":{"title":"Foragers with braided fungus","subtitleFromCtx":"location","body":["A small group of foragers offers bitter tea bricks and advice: 'Don't burn the old logs. Let them feed the ground.'","They look at your wagon like it\u2019s a garden."],"tags":["trade","social"],"options":[{"id":"trade","label":"Trade for tea (1 treasure)","tone":"neutral","hint":"Stomach medicine with a strange aftertaste."},{"id":"ask","label":"Ask for safe paths","tone":"warm","hint":"Navigation by mushroom lore."},{"id":"refuse","label":"Refuse","tone":"neutral","hint":"Keep moving."}],"defaultId":"trade"}},{"id":"dw_herd_oxen_stare","kind":"minor","trigger":{"mode":["camp"],"block":["evening"],"mythicEnabled":true,"requiresFlagsAll":["cf_hollow_herd_active"],"hoursSinceFlagAtLeast":{"dw_herd_oxen_time":60}},"weight":3,"tension":{"min":10,"max":90},"tags":["cryptid","animals","omen"],"log":{"tone":"event","text":"The oxen stand in a line facing north. They won't eat. They won't look at you."},"effects":[{"type":"setFlag","key":"dw_herd_oxen_time","value":"NOW_HOUR"},{"type":"personAddThought","target":{"selector":"randomAlive"},"thought":{"id":"dw_oxen","label":"Oxen unnerved","value":-2,"hours":12,"source":"omen"}},{"type":"tensionDelta","delta":1}]},{"id":"dw_herd_tracks_backward","kind":"breather","trigger":{"mode":["travel"],"block":["morning","noon"],"mythicEnabled":true,"requiresFlagsAll":["cf_hollow_herd_active"],"hoursSinceFlagAtLeast":{"dw_herd_tracks_time":72}},"weight":2,"tension":{"min":0,"max":80},"tags":["cryptid","tracks","breather"],"effects":[{"type":"setFlag","key":"dw_herd_tracks_time","value":"NOW_HOUR"},{"type":"choiceOutcomeMap","byChoice":{"follow":[{"type":"tensionDelta","delta":3},{"type":"roll","chance":0.45,"then":[{"type":"personAddAffliction","target":{"selector":"randomAlive"},"afflictionId":"aff_cryptid_bite","severity":{"min":1,"max":3}}],"else":[{"type":"suppliesDelta","supplyId":"fresh_meat","delta":2,"clampMin":0}]},{"type":"mythicRumorDelta","delta":2}],"mark":[{"type":"mythicRumorDelta","delta":1},{"type":"tensionDelta","delta":1}],"ward":[{"type":"suppliesDelta","supplyId":"itm_antler_talisman","delta":1,"clampMin":0},{"type":"tensionDelta","delta":-1}]}}],"encounter":{"title":"Tracks backward","subtitleFromCtx":"location","body":["You find a set of tracks that seem to walk backward along the trail, away from you.","The prints change\u2014hoof to boot to bare foot\u2014without any sign of where."],"tags":["travel","omen"],"options":[{"id":"follow","label":"Follow them","tone":"danger","hint":"Curiosity can cost flesh."},{"id":"mark","label":"Mark the spot and move on","tone":"neutral","hint":"Remember without chasing."},{"id":"ward","label":"Hang a talisman and hurry","tone":"warm","hint":"Symbols for comfort."}],"defaultId":"mark"}},{"id":"dw_herd_howl_night","kind":"minor","trigger":{"mode":["camp"],"block":["night"],"mythicEnabled":true,"requiresFlagsAll":["cf_hollow_herd_active"],"hoursSinceFlagAtLeast":{"dw_herd_howl_time":48}},"weight":3,"tension":{"min":20,"max":100},"tags":["cryptid","night","sound"],"log":{"tone":"event","text":"A howl rolls over the sage. Halfway through, it almost sounds like your name."},"effects":[{"type":"setFlag","key":"dw_herd_howl_time","value":"NOW_HOUR"},{"type":"tensionDelta","delta":2},{"type":"personAddThought","target":{"selector":"randomAlive"},"thought":{"id":"dw_howl","label":"Heard a name in a howl","value":-2,"hours":12,"source":"omen"}}]},{"id":"dw_herd_antlered_man","kind":"major","trigger":{"mode":["travel"],"block":["evening"],"mythicEnabled":true,"requiresFlagsAll":["cf_hollow_herd_active"],"hoursSinceFlagAtLeast":{"dw_herd_antler_time":144}},"weight":1,"tension":{"min":30,"max":100},"tags":["cryptid","setpiece","social"],"effects":[{"type":"setFlag","key":"dw_herd_antler_time","value":"NOW_HOUR"},{"type":"choiceOutcomeMap","byChoice":{"shoot":[{"type":"suppliesDelta","supplyId":"ammo","delta":-2,"clampMin":0},{"type":"roll","chance":0.4,"then":[{"type":"suppliesDelta","supplyId":"treasure","delta":2,"clampMin":0}],"else":[{"type":"personAddAffliction","target":{"selector":"randomAlive"},"afflictionId":"aff_cryptid_bite","severity":{"min":1,"max":3}}]},{"type":"tensionDelta","delta":3}],"talk":[{"type":"mythicRumorDelta","delta":2},{"type":"personAddTrait","target":{"selector":"randomAlive"},"traitId":"cryptid_hunter"},{"type":"tensionDelta","delta":1}],"offer":[{"type":"suppliesDelta","supplyId":"treasure","delta":-1,"clampMin":0},{"type":"suppliesDelta","supplyId":"itm_antler_talisman","delta":1,"clampMin":0},{"type":"tensionDelta","delta":-1}],"flee":[{"type":"personStatDelta","target":{"selector":"randomAlive"},"stat":"energy","delta":-4},{"type":"tensionDelta","delta":2}]}}],"encounter":{"title":"The antlered man","subtitleFromCtx":"location","body":["At the edge of the sage stands a figure with antlers or branches where a head should be.","It doesn't advance. It just watches like a judge."],"tags":["travel","danger","omen"],"options":[{"id":"shoot","label":"Shoot","tone":"danger","hint":"End the threat."},{"id":"talk","label":"Speak calmly","tone":"neutral","hint":"Treat it like a person until it proves otherwise."},{"id":"offer","label":"Offer salt and back away","tone":"warm","hint":"Appease whatever it is."},{"id":"flee","label":"Flee","tone":"danger","hint":"Don't test it."}],"defaultId":"offer"}},{"id":"dw_herd_stolen_oxen","kind":"setpiece","trigger":{"mode":["camp"],"block":["morning"],"mythicEnabled":true,"requiresFlagsAll":["cf_hollow_herd_active"],"hoursSinceFlagAtLeast":{"dw_herd_stolen_time":200}},"weight":1,"tension":{"min":30,"max":100},"tags":["cryptid","loss","setpiece"],"effects":[{"type":"setFlag","key":"dw_herd_stolen_time","value":"NOW_HOUR"},{"type":"suppliesDelta","supplyId":"oxen","delta":-1,"clampMin":0},{"type":"choiceOutcomeMap","byChoice":{"track":[{"type":"tensionDelta","delta":3},{"type":"roll","chance":0.5,"then":[{"type":"suppliesDelta","supplyId":"oxen","delta":1,"clampMin":0},{"type":"personAddThought","target":{"selector":"leader"},"thought":{"id":"dw_recovered","label":"Recovered oxen","value":3,"hours":18,"source":"success"}}],"else":[{"type":"personAddAffliction","target":{"selector":"randomAlive"},"afflictionId":"aff_cryptid_bite","severity":{"min":1,"max":3}},{"type":"personAddThought","target":{"selector":"leader"},"thought":{"id":"dw_failed","label":"Failed to recover oxen","value":-3,"hours":18,"source":"loss"}}]}],"trade":[{"type":"tensionDelta","delta":1},{"type":"personAddThought","target":{"selector":"leader"},"thought":{"id":"dw_loss","label":"Lost an ox","value":-2,"hours":18,"source":"loss"}}],"bait":[{"type":"suppliesDelta","supplyId":"fresh_meat","delta":-1,"clampMin":0},{"type":"roll","chance":0.35,"then":[{"type":"suppliesDelta","supplyId":"oxen","delta":1,"clampMin":0}],"else":[{"type":"tensionDelta","delta":2}]}]}}],"encounter":{"title":"Oxen gone","subtitleFromCtx":"location","body":["In the morning, a yoke lies in the grass. The oxen are gone.","No sign of struggle. Just shallow prints leading into sage, then vanishing."],"tags":["camp","danger","loss"],"options":[{"id":"track","label":"Track immediately","tone":"danger","hint":"Risk the party to recover them."},{"id":"trade","label":"Accept the loss; plan to buy replacements","tone":"neutral","hint":"Live to trade another day."},{"id":"bait","label":"Set bait and wait","tone":"neutral","hint":"Turn the theft into a trap."}],"defaultId":"trade"}},{"id":"dw_regiment_marching_dawn","kind":"minor","trigger":{"mode":["camp"],"block":["morning"],"mythicEnabled":true,"requiresFlagsAll":["cf_lost_regiment_active"],"hoursSinceFlagAtLeast":{"dw_reg_march_time":72}},"weight":3,"tension":{"min":10,"max":90},"tags":["ghost","sound","morning"],"log":{"tone":"event","text":"At dawn you hear marching\u2014bootsteps on hard ground. You look out and see empty prairie."},"effects":[{"type":"setFlag","key":"dw_reg_march_time","value":"NOW_HOUR"},{"type":"personAddThought","target":{"selector":"randomAlive"},"thought":{"id":"dw_marching","label":"Heard marching with no men","value":-2,"hours":12,"source":"omen"}},{"type":"roll","chance":0.25,"then":[{"type":"personAddAffliction","target":{"selector":"randomAlive"},"afflictionId":"aff_battle_fugue","severity":{"min":1,"max":2}}]}]},{"id":"dw_regiment_drumbeat_night","kind":"minor","trigger":{"mode":["camp"],"block":["night"],"mythicEnabled":true,"requiresFlagsAll":["cf_lost_regiment_active"],"hoursSinceFlagAtLeast":{"dw_reg_drum_time":60}},"weight":3,"tension":{"min":15,"max":95},"tags":["ghost","night","sound"],"log":{"tone":"event","text":"A drumbeat taps in the distance: slow, steady, patient. Then it stops exactly when you hold your breath."},"effects":[{"type":"setFlag","key":"dw_reg_drum_time","value":"NOW_HOUR"},{"type":"tensionDelta","delta":2},{"type":"personAddThought","target":{"selector":"randomAlive"},"thought":{"id":"dw_drum","label":"Unsettled by distant drums","value":-2,"hours":10,"source":"omen"}}]},{"id":"dw_regiment_dispatch_tape","kind":"breather","trigger":{"mode":["travel"],"block":["noon"],"mythicEnabled":true,"requiresFlagsAll":["cf_lost_regiment_active"],"hoursSinceFlagAtLeast":{"dw_reg_tape_time":120}},"weight":2,"tension":{"min":0,"max":80},"tags":["ghost","artifact","breather"],"log":{"tone":"event","text":"Caught on a thorn is a strip of waxed cloth with numbers stamped into it. It feels like an order."},"effects":[{"type":"setFlag","key":"dw_reg_tape_time","value":"NOW_HOUR"},{"type":"suppliesDelta","supplyId":"itm_dispatch_tape","delta":1,"clampMin":0},{"type":"suppliesDelta","supplyId":"itm_powdered_ink","delta":1,"clampMin":0},{"type":"mythicRumorDelta","delta":1}]},{"id":"dw_regiment_bluecoat_encounter","kind":"major","trigger":{"mode":["travel"],"block":["evening"],"mythicEnabled":true,"requiresFlagsAll":["cf_lost_regiment_active"],"hoursSinceFlagAtLeast":{"dw_reg_bluecoat_time":180}},"weight":1,"tension":{"min":25,"max":100},"tags":["ghost","social","setpiece"],"effects":[{"type":"setFlag","key":"dw_reg_bluecoat_time","value":"NOW_HOUR"},{"type":"choiceOutcomeMap","byChoice":{"truth":[{"type":"mythicRumorDelta","delta":2},{"type":"personAddThought","target":{"selector":"leader"},"thought":{"id":"dw_salute","label":"Saluted by a ghost","value":-1,"hours":18,"source":"omen"}},{"type":"personAddTrait","target":{"selector":"randomAlive"},"traitId":"bluecoat_echo"}],"lie":[{"type":"tensionDelta","delta":3},{"type":"personAddThought","target":{"selector":"leader"},"thought":{"id":"dw_lied_ghost","label":"Lied to a soldier","value":-3,"hours":18,"source":"social"}}],"ask":[{"type":"personAddThought","target":{"selector":"randomAlive"},"thought":{"id":"dw_story","label":"Heard a lost regiment story","value":-1,"hours":24,"source":"omen"}},{"type":"mythicRumorDelta","delta":2}],"flee":[{"type":"personStatDelta","target":{"selector":"randomAlive"},"stat":"energy","delta":-4},{"type":"tensionDelta","delta":2}]}}],"encounter":{"title":"A blue coat on the trail","subtitleFromCtx":"location","body":["A soldier in a faded blue coat stands by the road as if waiting for orders.","He salutes your wagon and asks, quietly: 'What year is it?'"],"tags":["travel","social","omen"],"options":[{"id":"truth","label":"Tell the truth","tone":"neutral","hint":"Respect the dead."},{"id":"lie","label":"Lie","tone":"danger","hint":"See if the trail rewards deceit."},{"id":"ask","label":"Ask what he's doing here","tone":"neutral","hint":"Let him speak."},{"id":"flee","label":"Flee","tone":"danger","hint":"Don't bargain with ghosts."}],"defaultId":"ask"}},{"id":"dw_regiment_medal_find","kind":"breather","trigger":{"mode":["travel"],"block":["noon"],"mythicEnabled":true,"requiresFlagsAll":["cf_lost_regiment_active"],"hoursSinceFlagAtLeast":{"dw_reg_medal_time":144}},"weight":2,"tension":{"min":0,"max":75},"tags":["ghost","artifact","breather"],"log":{"tone":"event","text":"In the grass you find an unmarked medal on a frayed ribbon. It's warm though the day is cold."},"effects":[{"type":"setFlag","key":"dw_reg_medal_time","value":"NOW_HOUR"},{"type":"suppliesDelta","supplyId":"itm_dull_medal","delta":1,"clampMin":0},{"type":"roll","chance":0.4,"then":[{"type":"giveCurio","curioId":"cur_dull_medal"}]},{"type":"mythicRumorDelta","delta":1}]},{"id":"dw_gray_fever_break","kind":"major","trigger":{"mode":["camp"],"block":["night"],"mythicEnabled":true,"requiresFlagsAll":["cf_gray_trail_active"],"requiresPartyAfflictionAny":["aff_gray_fever"],"hoursSinceFlagAtLeast":{"dw_gray_fever_break_time":120}},"weight":1,"tension":{"min":30,"max":100},"tags":["alien","illness","transformation"],"effects":[{"type":"setFlag","key":"dw_gray_fever_break_time","value":"NOW_HOUR"},{"type":"choiceOutcomeMap","byChoice":{"treat":[{"type":"suppliesDelta","supplyId":"med_kits","delta":-1,"clampMin":0},{"type":"personSkillDelta","target":{"selector":"highestSkill:doctoring"},"skill":"doctoring","delta":0.1},{"type":"roll","chance":0.6,"then":[{"type":"personAddTrait","target":{"selector":"randomWithAffliction:aff_gray_fever"},"traitId":"hybrid_blood"},{"type":"personAddThought","target":{"selector":"randomWithAffliction:aff_gray_fever"},"thought":{"id":"dw_changed","label":"Came back changed","value":-1,"hours":48,"source":"omen"}}],"else":[{"type":"personAddAffliction","target":{"selector":"randomWithAffliction:aff_gray_fever"},"afflictionId":"aff_gray_fever","severity":{"min":1,"max":1}}]}],"isolate":[{"type":"tensionDelta","delta":2},{"type":"personAddThought","target":{"selector":"randomWithAffliction:aff_gray_fever"},"thought":{"id":"dw_isolated","label":"Isolated while sick","value":-2,"hours":24,"source":"social"}}],"listen":[{"type":"mythicRumorDelta","delta":3},{"type":"personAddThought","target":{"selector":"leader"},"thought":{"id":"dw_listened","label":"Listened to the fever","value":-2,"hours":24,"source":"omen"}},{"type":"roll","chance":0.35,"then":[{"type":"personAddHiddenTrait","target":{"selector":"leader"},"traitId":"conspiracy_mind"}]}]}}],"encounter":{"title":"Gray fever spikes","subtitleFromCtx":"location","body":["The sick one shivers though the fire is hot. Their eyes track something above the canvas.","For a moment they speak in a flat, unfamiliar cadence\u2014as if reading a report."],"tags":["camp","danger","illness"],"options":[{"id":"treat","label":"Treat aggressively","tone":"neutral","hint":"Spend medicine; stabilize them."},{"id":"isolate","label":"Isolate them and keep watch","tone":"neutral","hint":"Protect the rest."},{"id":"listen","label":"Listen to what they say","tone":"danger","hint":"Sometimes knowledge bites back."}],"defaultId":"treat"}},{"id":"dw_oil_possession","kind":"setpiece","trigger":{"mode":["camp"],"block":["night"],"mythicEnabled":true,"requiresFlagsAll":["cf_black_oil_active"],"requiresPartyAfflictionAny":["aff_black_oil"],"hoursSinceFlagAtLeast":{"dw_oil_possession_time":168}},"weight":1,"tension":{"min":35,"max":100},"tags":["infection","setpiece","transformation"],"effects":[{"type":"setFlag","key":"dw_oil_possession_time","value":"NOW_HOUR"},{"type":"choiceOutcomeMap","byChoice":{"restrain":[{"type":"tensionDelta","delta":3},{"type":"personAddThought","target":{"selector":"randomWithAffliction:aff_black_oil"},"thought":{"id":"dw_restrained","label":"Restrained in the night","value":-3,"hours":24,"source":"social"}},{"type":"roll","chance":0.5,"then":[{"type":"personAddTrait","target":{"selector":"randomWithAffliction:aff_black_oil"},"traitId":"hard_case"}]}],"talk":[{"type":"personAddThought","target":{"selector":"leader"},"thought":{"id":"dw_talked","label":"Talked someone down","value":1,"hours":12,"source":"social"}},{"type":"roll","chance":0.45,"then":[{"type":"personAddTrait","target":{"selector":"randomWithAffliction:aff_black_oil"},"traitId":"oil_carrier"}]}],"relight":[{"type":"suppliesDelta","supplyId":"wood","delta":-1,"clampMin":0},{"type":"tensionDelta","delta":-1},{"type":"roll","chance":0.35,"then":[{"type":"personAddAffliction","target":{"selector":"randomAlive"},"afflictionId":"aff_black_oil","severity":{"min":1,"max":2}}]}]}}],"encounter":{"title":"Hands in the ashes","subtitleFromCtx":"location","body":["You wake to scraping. Someone is kneeling at the cold fire pit, smearing black ash on their arms like paint.","They whisper: 'No light. No witness.'"],"tags":["camp","danger","night"],"options":[{"id":"restrain","label":"Restrain them","tone":"danger","hint":"Prevent sabotage."},{"id":"talk","label":"Talk them down","tone":"neutral","hint":"Keep it human."},{"id":"relight","label":"Relight the fire","tone":"neutral","hint":"Force light into the moment."}],"defaultId":"relight"}},{"id":"dw_spore_symbiosis","kind":"major","trigger":{"mode":["camp"],"block":["morning"],"mythicEnabled":true,"requiresFlagsAll":["cf_fungal_bloom_active"],"requiresPartyAfflictionAny":["aff_spore_lung"],"hoursSinceFlagAtLeast":{"dw_spore_symbiosis_time":144}},"weight":1,"tension":{"min":20,"max":90},"tags":["fungus","transformation"],"log":{"tone":"event","text":"The coughing eases. The sick one insists they can 'smell' where food grows, like the earth is whispering."},"effects":[{"type":"setFlag","key":"dw_spore_symbiosis_time","value":"NOW_HOUR"},{"type":"roll","chance":0.6,"then":[{"type":"personAddTrait","target":{"selector":"randomWithAffliction:aff_spore_lung"},"traitId":"mycelial_symbiote"},{"type":"personAddThought","target":{"selector":"randomWithAffliction:aff_spore_lung"},"thought":{"id":"dw_symbiote","label":"Recovered\u2026 different","value":-1,"hours":36,"source":"omen"}}]}]},{"id":"dw_mirror_split_escalation","kind":"major","trigger":{"mode":["camp"],"block":["evening"],"mythicEnabled":true,"requiresFlagsAll":["cf_mirror_road_active"],"requiresPartyAfflictionAny":["aff_mirror_split"],"hoursSinceFlagAtLeast":{"dw_mirror_split_time":144}},"weight":1,"tension":{"min":25,"max":100},"tags":["time","transformation"],"effects":[{"type":"setFlag","key":"dw_mirror_split_time","value":"NOW_HOUR"},{"type":"choiceOutcomeMap","byChoice":{"ground":[{"type":"suppliesDelta","supplyId":"coffee","delta":-1,"clampMin":0},{"type":"personAddThought","target":{"selector":"randomWithAffliction:aff_mirror_split"},"thought":{"id":"dw_anchored","label":"Felt anchored","value":2,"hours":18,"source":"social"}},{"type":"personAddTrait","target":{"selector":"randomWithAffliction:aff_mirror_split"},"traitId":"time_sense"}],"observe":[{"type":"mythicRumorDelta","delta":2},{"type":"personSkillDelta","target":{"selector":"leader"},"skill":"craft","delta":0.05},{"type":"personAddThought","target":{"selector":"leader"},"thought":{"id":"dw_notes","label":"Took impossible notes","value":-1,"hours":24,"source":"omen"}}],"panic":[{"type":"tensionDelta","delta":3},{"type":"personAddThought","target":{"selector":"randomWithAffliction:aff_mirror_split"},"thought":{"id":"dw_shunned","label":"Shunned for being strange","value":-4,"hours":24,"source":"social"}}]}}],"encounter":{"title":"Two shadows","subtitleFromCtx":"location","body":["At sunset, someone casts two shadows from one body. The second shadow points east while the first points west.","The air smells like struck flint."],"tags":["camp","omen","danger"],"options":[{"id":"ground","label":"Ground them (warm drink, company)","tone":"warm","hint":"Anchor them to the present."},{"id":"observe","label":"Observe and take notes","tone":"neutral","hint":"Knowledge over comfort."},{"id":"panic","label":"Panic / isolate them","tone":"danger","hint":"Fear makes choices for you."}],"defaultId":"ground"}},{"id":"dw_agency_dropbox","kind":"major","trigger":{"mode":["camp"],"block":["evening"],"mythicEnabled":true,"locationContains":"Fort","requiresSupplyAtLeast":{"itm_alien_alloy":1},"hoursSinceFlagAtLeast":{"dw_agency_dropbox_time":168}},"weight":1,"tension":{"min":10,"max":95},"tags":["men_in_gray","trade","conspiracy"],"effects":[{"type":"setFlag","key":"dw_agency_dropbox_time","value":"NOW_HOUR"},{"type":"choiceOutcomeMap","byChoice":{"deposit":[{"type":"suppliesDelta","supplyId":"itm_alien_alloy","delta":-1,"clampMin":0},{"type":"moneyDelta","delta":18},{"type":"factionRepDelta","factionId":"men_in_gray","delta":3},{"type":"factionRepDelta","factionId":"star_watchers","delta":2}],"peek":[{"type":"tensionDelta","delta":3},{"type":"personAddThought","target":{"selector":"leader"},"thought":{"id":"dw_conspiracy","label":"Touched a conspiracy","value":-2,"hours":24,"source":"omen"}},{"type":"mythicRumorDelta","delta":2}],"ignore":[{"type":"factionRepDelta","factionId":"men_in_gray","delta":-1}]}}],"encounter":{"title":"A drop box behind the fort","subtitleFromCtx":"location","body":["Behind the fort's stores sits a nailed wooden box with a slot and a number stamped into it.","A chalk note reads: DEPOSIT METAL. COLLECT PAYMENT. DO NOT SPEAK."],"tags":["trade","omen"],"options":[{"id":"deposit","label":"Deposit alien alloy","tone":"neutral","hint":"Trade the unknown for money."},{"id":"peek","label":"Peek inside","tone":"danger","hint":"Curiosity is how conspiracies recruit you."},{"id":"ignore","label":"Ignore it","tone":"neutral","hint":"Keep your oddities."}],"defaultId":"deposit"}},{"id":"dw_agency_wagon_search","kind":"setpiece","trigger":{"mode":["camp"],"block":["night"],"mythicEnabled":true,"requiresSupplyAtLeast":{"itm_etched_disc":1},"requiresFactionRepMax":{"men_in_gray":-5},"hoursSinceFlagAtLeast":{"dw_agency_search_time":240}},"weight":1,"tension":{"min":40,"max":100},"tags":["men_in_gray","setpiece","conspiracy"],"effects":[{"type":"setFlag","key":"dw_agency_search_time","value":"NOW_HOUR"},{"type":"choiceOutcomeMap","byChoice":{"comply":[{"type":"suppliesDelta","supplyId":"itm_etched_disc","delta":-1,"clampMin":0},{"type":"tensionDelta","delta":-2},{"type":"factionRepDelta","factionId":"men_in_gray","delta":2}],"hide":[{"type":"tensionDelta","delta":4},{"type":"roll","chance":0.5,"then":[{"type":"suppliesDelta","supplyId":"itm_etched_disc","delta":-1,"clampMin":0},{"type":"factionRepDelta","factionId":"men_in_gray","delta":1}],"else":[{"type":"factionRepDelta","factionId":"men_in_gray","delta":-3},{"type":"personAddThought","target":{"selector":"leader"},"thought":{"id":"dw_got_away","label":"Kept the artifact","value":1,"hours":12,"source":"social"}}]}],"bribe":[{"type":"moneyDelta","delta":-10},{"type":"tensionDelta","delta":-1},{"type":"factionRepDelta","factionId":"men_in_gray","delta":1}],"run":[{"type":"personStatDelta","target":{"selector":"randomAlive"},"stat":"energy","delta":-5},{"type":"tensionDelta","delta":5},{"type":"roll","chance":0.3,"then":[{"type":"suppliesDelta","supplyId":"itm_etched_disc","delta":-1,"clampMin":0}]}]}}],"encounter":{"title":"Lanterns at the edge of camp","subtitleFromCtx":"location","body":["Two lanterns approach in the dark\u2014steady, unhurried. Riders in gray stop outside the firelight.","One says: 'We have reason to believe you carry property that is not yours.'"],"tags":["camp","danger","social"],"options":[{"id":"comply","label":"Comply","tone":"neutral","hint":"Give up the artifact; keep the peace."},{"id":"hide","label":"Hide the artifact","tone":"danger","hint":"Risk a search."},{"id":"bribe","label":"Bribe them","tone":"neutral","hint":"Money speaks."},{"id":"run","label":"Run","tone":"danger","hint":"Try to flee into the dark."}],"defaultId":"bribe"}},{"id":"dw_agency_offer_badge","kind":"lifeline","trigger":{"mode":["travel"],"block":["noon"],"mythicEnabled":true,"requiresFactionRepMin":{"men_in_gray":10},"hoursSinceFlagAtLeast":{"dw_agency_badge_time":240}},"weight":1,"tension":{"min":0,"max":80},"tags":["men_in_gray","lifeline","conspiracy"],"effects":[{"type":"setFlag","key":"dw_agency_badge_time","value":"NOW_HOUR"},{"type":"choiceOutcomeMap","byChoice":{"accept":[{"type":"suppliesDelta","supplyId":"itm_agency_token","delta":1,"clampMin":0},{"type":"personAddTrait","target":{"selector":"leader"},"traitId":"telegraph_tinker"},{"type":"factionRepDelta","factionId":"men_in_gray","delta":2}],"decline":[{"type":"factionRepDelta","factionId":"men_in_gray","delta":-2},{"type":"personAddThought","target":{"selector":"leader"},"thought":{"id":"dw_declined","label":"Declined an agency offer","value":1,"hours":12,"source":"social"}}],"negotiate":[{"type":"suppliesDelta","supplyId":"ammo","delta":2,"clampMin":0},{"type":"suppliesDelta","supplyId":"med_kits","delta":1,"clampMin":0},{"type":"factionRepDelta","factionId":"men_in_gray","delta":-1}]}}],"encounter":{"title":"An offer in plain words","subtitleFromCtx":"location","body":["A rider in gray matches pace beside your wagon, close enough to speak without raising his voice.","He offers an agency token. 'It opens the right doors. And closes the wrong conversations.'"],"tags":["travel","social","trade"],"options":[{"id":"accept","label":"Accept","tone":"neutral","hint":"Take protection, owe nothing. Maybe."},{"id":"decline","label":"Decline","tone":"neutral","hint":"Stay free."},{"id":"negotiate","label":"Negotiate for supplies","tone":"neutral","hint":"Turn it into trade."}],"defaultId":"accept"}},{"id":"dw_generic_ball_lightning_wagon","kind":"major","trigger":{"mode":["camp","travel"],"block":["night"],"mythicEnabled":true,"weatherAny":["storm"],"hoursSinceFlagAtLeast":{"dw_ball_lightning_time":180}},"weight":1,"tension":{"min":20,"max":100},"tags":["weather","anomaly","danger"],"effects":[{"type":"setFlag","key":"dw_ball_lightning_time","value":"NOW_HOUR"},{"type":"choiceOutcomeMap","byChoice":{"ground":[{"type":"personSkillDelta","target":{"selector":"highestSkill:craft"},"skill":"craft","delta":0.1},{"type":"roll","chance":0.6,"then":[{"type":"suppliesDelta","supplyId":"itm_strange_battery","delta":1,"clampMin":0}],"else":[{"type":"suppliesDelta","supplyId":"wood","delta":-1,"clampMin":0}]}],"hide":[{"type":"tensionDelta","delta":2},{"type":"roll","chance":0.4,"then":[{"type":"suppliesDelta","supplyId":"wheels","delta":-1,"clampMin":0},{"type":"personAddThought","target":{"selector":"leader"},"thought":{"id":"dw_damage","label":"Wagon damage","value":-2,"hours":12,"source":"loss"}}]}],"chase":[{"type":"personStatDelta","target":{"selector":"randomAlive"},"stat":"health","delta":-2},{"type":"roll","chance":0.5,"then":[{"type":"suppliesDelta","supplyId":"itm_strange_battery","delta":1,"clampMin":0}],"else":[{"type":"personAddAffliction","target":{"selector":"randomAlive"},"afflictionId":"sprain","severity":{"min":1,"max":2}}]}]}}],"encounter":{"title":"Ball lightning","subtitleFromCtx":"location","body":["A bright sphere rolls out of the storm and drifts toward the wagon as if curious.","Hair rises on arms. The air tastes like metal."],"tags":["weather","danger","omen"],"options":[{"id":"ground","label":"Ground it (wet rope, iron)","tone":"neutral","hint":"Use craft knowledge; reduce damage."},{"id":"hide","label":"Hide under canvas","tone":"danger","hint":"Hope it passes."},{"id":"chase","label":"Chase it off with poles","tone":"danger","hint":"Risk shock."}],"defaultId":"ground"}},{"id":"dw_generic_dimensional_fog","kind":"minor","trigger":{"mode":["travel"],"block":["morning","evening"],"mythicEnabled":true,"weatherAny":["fog"],"hoursSinceFlagAtLeast":{"dw_fog_time":120}},"weight":2,"tension":{"min":10,"max":90},"tags":["fog","time","anomaly"],"log":{"tone":"event","text":"Fog thickens until the world is only hoofbeats and breath. When it lifts, the sun feels\u2026 wrong."},"effects":[{"type":"setFlag","key":"dw_fog_time","value":"NOW_HOUR"},{"type":"roll","chance":0.5,"then":[{"type":"timeSkipHours","hours":2,"note":"Lost time in fog."}],"else":[{"type":"timeSkipHours","hours":-1,"note":"Gained an hour you didn't earn."}]},{"type":"personAddThought","target":{"selector":"randomAlive"},"thought":{"id":"dw_fog","label":"Fog stole time","value":-1,"hours":14,"source":"omen"}}]},{"id":"dw_generic_strange_migration","kind":"breather","trigger":{"mode":["travel"],"block":["noon"],"mythicEnabled":true,"hoursSinceFlagAtLeast":{"dw_migration_time":96}},"weight":3,"tension":{"min":0,"max":70},"tags":["anomaly","nature","breather"],"log":{"tone":"event","text":"Birds fly overhead in a perfect grid, as if following invisible fences. For a moment, you feel counted."},"effects":[{"type":"setFlag","key":"dw_migration_time","value":"NOW_HOUR"},{"type":"mythicRumorDelta","delta":1},{"type":"roll","chance":0.25,"then":[{"type":"personAddHiddenTrait","target":{"selector":"randomAlive"},"traitId":"conspiracy_mind"}]}]},{"id":"dw_generic_dream_letter","kind":"breather","trigger":{"mode":["camp"],"block":["night"],"mythicEnabled":true,"hoursSinceFlagAtLeast":{"dw_dream_letter_time":72}},"weight":3,"tension":{"min":0,"max":80},"tags":["dream","breather"],"effects":[{"type":"setFlag","key":"dw_dream_letter_time","value":"NOW_HOUR"},{"type":"choiceOutcomeMap","byChoice":{"read":[{"type":"mythicRumorDelta","delta":2},{"type":"personAddThought","target":{"selector":"leader"},"thought":{"id":"dw_read","label":"Read a dream-letter","value":-1,"hours":18,"source":"omen"}},{"type":"tensionDelta","delta":1}],"burn":[{"type":"tensionDelta","delta":-1},{"type":"personAddThought","target":{"selector":"leader"},"thought":{"id":"dw_burned_letter","label":"Burned a message","value":1,"hours":12,"source":"omen"}}],"pocket":[{"type":"suppliesDelta","supplyId":"itm_register_rubbing","delta":1,"clampMin":0},{"type":"personAddThought","target":{"selector":"leader"},"thought":{"id":"dw_secret","label":"Kept a secret omen","value":-1,"hours":12,"source":"social"}}]}}],"encounter":{"title":"Letter from a dream","subtitleFromCtx":"location","body":["Someone wakes clutching a folded letter. The paper is damp, as if carried through rain.","The handwriting matches no one in camp\u2014yet the letter is addressed to you."],"tags":["camp","omen"],"options":[{"id":"read","label":"Read it aloud","tone":"neutral","hint":"Share the omen."},{"id":"burn","label":"Burn it","tone":"danger","hint":"Refuse the message."},{"id":"pocket","label":"Pocket it silently","tone":"neutral","hint":"Keep it private."}],"defaultId":"pocket"}},{"id":"dw_gray_flattened_ring","kind":"major","trigger":{"mode":["travel"],"block":["noon","evening"],"mythicEnabled":true,"requiresFlagsAll":["cf_gray_trail_active"],"hoursSinceFlagAtLeast":{"dw_gray_ring_time":144}},"weight":1,"tension":{"min":15,"max":95},"tags":["alien","landmark","omen"],"effects":[{"type":"setFlag","key":"dw_gray_ring_time","value":"NOW_HOUR"},{"type":"choiceOutcomeMap","byChoice":{"scavenge":[{"type":"suppliesDelta","supplyId":"itm_cinder_glass","delta":2,"clampMin":0},{"type":"roll","chance":0.35,"then":[{"type":"suppliesDelta","supplyId":"itm_etched_disc","delta":1,"clampMin":0}]},{"type":"mythicRumorDelta","delta":2}],"camp":[{"type":"tensionDelta","delta":3},{"type":"roll","chance":0.4,"then":[{"type":"personAddHiddenTrait","target":{"selector":"randomAlive"},"traitId":"abductee"}]},{"type":"mythicRumorDelta","delta":2}],"avoid":[{"type":"tensionDelta","delta":-1}]}}],"encounter":{"title":"Flattened ring","subtitleFromCtx":"location","body":["Grass lies flattened in a perfect ring, as if pressed down by something heavy and round.","At the center, the soil is fused into green-black glass."],"tags":["travel","omen"],"options":[{"id":"scavenge","label":"Scavenge the center","tone":"neutral","hint":"Risk for artifacts."},{"id":"camp","label":"Camp nearby to watch the sky","tone":"danger","hint":"You might get what you're watching for."},{"id":"avoid","label":"Avoid it","tone":"warm","hint":"Not all clues are meant to be handled."}],"defaultId":"scavenge"}},{"id":"dw_gray_telegraph_code","kind":"lifeline","trigger":{"mode":["camp"],"block":["evening"],"mythicEnabled":true,"requiresFlagsAll":["cf_gray_trail_active"],"locationContains":"Fort","hoursSinceFlagAtLeast":{"dw_gray_telegraph_time":168}},"weight":1,"tension":{"min":0,"max":85},"tags":["alien","conspiracy","trade"],"effects":[{"type":"setFlag","key":"dw_gray_telegraph_time","value":"NOW_HOUR"},{"type":"choiceOutcomeMap","byChoice":{"pay":[{"type":"suppliesDelta","supplyId":"treasure","delta":-1,"clampMin":0},{"type":"suppliesDelta","supplyId":"itm_dispatch_tape","delta":1,"clampMin":0},{"type":"personAddTrait","target":{"selector":"leader"},"traitId":"telegraph_tinker"},{"type":"factionRepDelta","factionId":"star_watchers","delta":2}],"listen":[{"type":"mythicRumorDelta","delta":3},{"type":"personAddThought","target":{"selector":"leader"},"thought":{"id":"dw_code","label":"Heard sky-code","value":-2,"hours":24,"source":"omen"}},{"type":"roll","chance":0.3,"then":[{"type":"personAddAffliction","target":{"selector":"leader"},"afflictionId":"aff_gray_fever","severity":{"min":1,"max":2}}]}],"refuse":[{"type":"factionRepDelta","factionId":"star_watchers","delta":-1}]}}],"encounter":{"title":"A telegraph man with shaking hands","subtitleFromCtx":"location","body":["A telegraph man catches you near the office and presses a strip of paper into your hand.","'They've been tapping from the sky,' he whispers. 'If you hear it too, don't answer.'"],"tags":["social","trade","omen"],"options":[{"id":"pay","label":"Pay for the strip (1 treasure)","tone":"neutral","hint":"Information is worth coin."},{"id":"listen","label":"Listen to the code","tone":"danger","hint":"Some messages are traps."},{"id":"refuse","label":"Refuse","tone":"neutral","hint":"Keep walking."}],"defaultId":"pay"}},{"id":"dw_eye_mark_on_palm","kind":"minor","trigger":{"mode":["camp"],"block":["morning"],"mythicEnabled":true,"requiresFlagsAll":["cf_open_eye_active"],"hoursSinceFlagAtLeast":{"dw_eye_palm_time":96}},"weight":2,"tension":{"min":10,"max":85},"tags":["cult","omen","social"],"log":{"tone":"event","text":"Someone wakes with an inked eye on their palm. They swear they didn't draw it."},"effects":[{"type":"setFlag","key":"dw_eye_palm_time","value":"NOW_HOUR"},{"type":"roll","chance":0.5,"then":[{"type":"personAddHiddenTrait","target":{"selector":"randomAlive"},"traitId":"ink_touched"}]},{"type":"tensionDelta","delta":1},{"type":"personAddThought","target":{"selector":"randomAlive"},"thought":{"id":"dw_palm","label":"Woke marked","value":-2,"hours":18,"source":"omen"}}]},{"id":"dw_eye_nurse_the_sick","kind":"lifeline","trigger":{"mode":["camp"],"block":["evening"],"mythicEnabled":true,"requiresFlagsAll":["cf_open_eye_active"],"requiresPartyAnyIllness":true,"hoursSinceFlagAtLeast":{"dw_eye_nurse_time":168}},"weight":1,"tension":{"min":0,"max":90},"tags":["cult","medicine","lifeline"],"effects":[{"type":"setFlag","key":"dw_eye_nurse_time","value":"NOW_HOUR"},{"type":"choiceOutcomeMap","byChoice":{"accept":[{"type":"suppliesDelta","supplyId":"med_kits","delta":-1,"clampMin":0},{"type":"treatIllnessBestChance","bonus":0.25},{"type":"factionRepDelta","factionId":"open_eye","delta":2}],"decline":[{"type":"factionRepDelta","factionId":"open_eye","delta":-1}],"pray":[{"type":"personAddThought","target":{"selector":"randomAlive"},"thought":{"id":"dw_prayed","label":"Prayed with a stranger","value":2,"hours":18,"source":"social"}},{"type":"factionRepDelta","factionId":"open_eye","delta":1}]}}],"encounter":{"title":"A quiet nurse","subtitleFromCtx":"location","body":["A traveler offers help for the sick. Their hands are steady. Their charm is painted with an eye.","'Witness the pain,' they say. 'Then let it go.'"],"tags":["camp","medicine","social"],"options":[{"id":"accept","label":"Accept help (spend 1 med kit)","tone":"warm","hint":"Stabilize illness."},{"id":"decline","label":"Decline","tone":"neutral","hint":"Keep your distance."},{"id":"pray","label":"Ask for a blessing instead","tone":"warm","hint":"Morale over medicine."}],"defaultId":"accept"}},{"id":"dw_oil_tainted_waterskin","kind":"minor","trigger":{"mode":["camp"],"block":["morning"],"mythicEnabled":true,"requiresFlagsAll":["cf_black_oil_active"],"hoursSinceFlagAtLeast":{"dw_oil_waterskin_time":96}},"weight":2,"tension":{"min":15,"max":95},"tags":["infection","water","omen"],"log":{"tone":"event","text":"A waterskin leaks. The seepage is clear at first\u2014then darkens to a thin black thread."},"effects":[{"type":"setFlag","key":"dw_oil_waterskin_time","value":"NOW_HOUR"},{"type":"suppliesDelta","supplyId":"water","delta":-2,"clampMin":0},{"type":"roll","chance":0.35,"then":[{"type":"personAddAffliction","target":{"selector":"randomAlive"},"afflictionId":"aff_black_oil","severity":{"min":1,"max":2}}]},{"type":"personAddThought","target":{"selector":"leader"},"thought":{"id":"dw_taint","label":"Fear of tainted water","value":-2,"hours":18,"source":"illness"}}]},{"id":"dw_oil_apply_ash_salve","kind":"lifeline","trigger":{"mode":["camp"],"block":["evening"],"mythicEnabled":true,"requiresFlagsAll":["cf_black_oil_active"],"requiresSupplyAtLeast":{"itm_ash_salve":1},"requiresPartyAfflictionAny":["aff_black_oil"],"hoursSinceFlagAtLeast":{"dw_oil_apply_salve_time":120}},"weight":1,"tension":{"min":0,"max":90},"tags":["infection","medicine","lifeline"],"effects":[{"type":"setFlag","key":"dw_oil_apply_salve_time","value":"NOW_HOUR"},{"type":"choiceOutcomeMap","byChoice":{"use":[{"type":"suppliesDelta","supplyId":"itm_ash_salve","delta":-1,"clampMin":0},{"type":"reduceAfflictionSeverity","afflictionId":"aff_black_oil","delta":-1},{"type":"personAddThought","target":{"selector":"leader"},"thought":{"id":"dw_treated","label":"Treated the oil","value":2,"hours":12,"source":"medicine"}}],"save":[{"type":"personAddThought","target":{"selector":"leader"},"thought":{"id":"dw_saved","label":"Saved medicine","value":-1,"hours":12,"source":"social"}}]}}],"encounter":{"title":"Ash salve","subtitleFromCtx":"location","body":["You have ash salve. Someone is sick with the oil.","The salve smells like a cold fireplace and bitter hope."],"tags":["camp","medicine"],"options":[{"id":"use","label":"Use the salve","tone":"warm","hint":"Spend salve; reduce severity."},{"id":"save","label":"Save it for later","tone":"neutral","hint":"You might need it worse later."}],"defaultId":"use"}},{"id":"dw_bone_giant_tracks","kind":"minor","trigger":{"mode":["travel"],"block":["noon"],"mythicEnabled":true,"requiresFlagsAll":["cf_bone_valley_active"],"hoursSinceFlagAtLeast":{"dw_bone_tracks_time":120}},"weight":2,"tension":{"min":15,"max":95},"tags":["bones","cryptid","omen"],"log":{"tone":"event","text":"In chalky soil you find prints too big for any ox. The stride suggests something that didn't hurry."},"effects":[{"type":"setFlag","key":"dw_bone_tracks_time","value":"NOW_HOUR"},{"type":"tensionDelta","delta":2},{"type":"mythicRumorDelta","delta":2},{"type":"personAddThought","target":{"selector":"randomAlive"},"thought":{"id":"dw_big_tracks","label":"Saw giant tracks","value":-2,"hours":12,"source":"omen"}}]},{"id":"dw_bone_whispering_valley","kind":"setpiece","trigger":{"mode":["camp"],"block":["night"],"mythicEnabled":true,"requiresFlagsAll":["cf_bone_valley_active"],"hoursSinceFlagAtLeast":{"dw_bone_whisper_time":200}},"weight":1,"tension":{"min":30,"max":100},"tags":["bones","setpiece","night"],"effects":[{"type":"setFlag","key":"dw_bone_whisper_time","value":"NOW_HOUR"},{"type":"choiceOutcomeMap","byChoice":{"listen":[{"type":"tensionDelta","delta":3},{"type":"mythicRumorDelta","delta":3},{"type":"personAddTrait","target":{"selector":"randomAlive"},"traitId":"gentle_medium"},{"type":"roll","chance":0.35,"then":[{"type":"personAddAffliction","target":{"selector":"randomAlive"},"afflictionId":"aff_battle_fugue","severity":{"min":1,"max":2}}]}],"leave":[{"type":"timeSkipHours","hours":1,"note":"Packed and left in the dark."},{"type":"tensionDelta","delta":-1}],"sing":[{"type":"personAddThought","target":{"selector":"randomAlive"},"thought":{"id":"dw_song","label":"Sang against the wind","value":2,"hours":12,"source":"camp"}},{"type":"tensionDelta","delta":-1}]}}],"encounter":{"title":"Whispers in the ribs","subtitleFromCtx":"location","body":["The wind rises and the valley answers. It sounds like voices speaking through old ribs.","Someone insists they recognized a name in the chorus."],"tags":["camp","danger","omen"],"options":[{"id":"listen","label":"Listen","tone":"danger","hint":"Hear what it wants to say."},{"id":"leave","label":"Leave camp immediately","tone":"neutral","hint":"Lose sleep; keep sanity."},{"id":"sing","label":"Sing over it","tone":"warm","hint":"Drown fear with human sound."}],"defaultId":"leave"}},{"id":"dw_fungus_read_by_glow","kind":"breather","trigger":{"mode":["camp"],"block":["night"],"mythicEnabled":true,"requiresFlagsAll":["cf_fungal_bloom_active"],"requiresSupplyAtLeast":{"itm_glow_cap":1},"hoursSinceFlagAtLeast":{"dw_fungus_read_time":120}},"weight":2,"tension":{"min":0,"max":85},"tags":["fungus","dream","breather"],"effects":[{"type":"setFlag","key":"dw_fungus_read_time","value":"NOW_HOUR"},{"type":"choiceOutcomeMap","byChoice":{"work":[{"type":"personSkillDelta","target":{"selector":"leader"},"skill":"craft","delta":0.08},{"type":"mythicRumorDelta","delta":1},{"type":"roll","chance":0.4,"then":[{"type":"personAddAffliction","target":{"selector":"leader"},"afflictionId":"aff_dream_bleed","severity":{"min":1,"max":2}}]}],"sleep":[{"type":"tensionDelta","delta":-1}]}}],"encounter":{"title":"Reading by mushroom light","subtitleFromCtx":"location","body":["The glow-caps make enough light to read by. Someone suggests using the time to copy maps or notes.","The shadows under the log seem to shift like breathing."],"tags":["camp","omen"],"options":[{"id":"work","label":"Work by the glow","tone":"neutral","hint":"Gain skill; risk strange dreams."},{"id":"sleep","label":"Sleep instead","tone":"warm","hint":"Don't bargain with fungus."}],"defaultId":"sleep"}},{"id":"dw_herd_hollow_horn_find","kind":"breather","trigger":{"mode":["travel"],"block":["noon"],"mythicEnabled":true,"requiresFlagsAll":["cf_hollow_herd_active"],"hoursSinceFlagAtLeast":{"dw_herd_horn_time":120}},"weight":2,"tension":{"min":0,"max":80},"tags":["cryptid","artifact","breather"],"log":{"tone":"event","text":"Caught in brush is a hollow horn, polished smooth. When you lift it, you hear an echo that isn't yours."},"effects":[{"type":"setFlag","key":"dw_herd_horn_time","value":"NOW_HOUR"},{"type":"suppliesDelta","supplyId":"itm_hollow_horn","delta":1,"clampMin":0},{"type":"mythicRumorDelta","delta":1}]},{"id":"dw_regiment_bivouac_smoke","kind":"setpiece","trigger":{"mode":["travel"],"block":["evening"],"mythicEnabled":true,"requiresFlagsAll":["cf_lost_regiment_active"],"hoursSinceFlagAtLeast":{"dw_reg_smoke_time":200}},"weight":1,"tension":{"min":30,"max":100},"tags":["ghost","setpiece","scavenge"],"effects":[{"type":"setFlag","key":"dw_reg_smoke_time","value":"NOW_HOUR"},{"type":"choiceOutcomeMap","byChoice":{"approach":[{"type":"tensionDelta","delta":4},{"type":"roll","chance":0.55,"then":[{"type":"suppliesDelta","supplyId":"ammo","delta":2,"clampMin":0},{"type":"suppliesDelta","supplyId":"coffee","delta":1,"clampMin":0}],"else":[{"type":"personAddAffliction","target":{"selector":"randomAlive"},"afflictionId":"aff_battle_fugue","severity":{"min":1,"max":2}}]},{"type":"mythicRumorDelta","delta":2}],"salute":[{"type":"personAddThought","target":{"selector":"leader"},"thought":{"id":"dw_respect","label":"Paid respect","value":1,"hours":12,"source":"social"}},{"type":"tensionDelta","delta":-1}],"avoid":[{"type":"tensionDelta","delta":-1}]}}],"encounter":{"title":"Bivouac smoke","subtitleFromCtx":"location","body":["Smoke rises from a low draw where there should be no camp.","When you approach, you smell coffee and gun oil and something older."],"tags":["travel","danger","omen"],"options":[{"id":"approach","label":"Approach","tone":"danger","hint":"Scavenge from ghosts."},{"id":"salute","label":"Salute and pass by","tone":"neutral","hint":"Respect the dead and keep moving."},{"id":"avoid","label":"Avoid it","tone":"warm","hint":"Leave what is not meant for you."}],"defaultId":"salute"}},{"id":"dw_generic_black_sun","kind":"setpiece","trigger":{"mode":["travel"],"block":["noon"],"mythicEnabled":true,"hoursSinceFlagAtLeast":{"dw_black_sun_time":300}},"weight":1,"tension":{"min":25,"max":100},"tags":["anomaly","sky","setpiece"],"log":{"tone":"event","text":"The sun dims as if covered by a hand. Shadows sharpen. Birds fall silent. Then the light returns too quickly."},"effects":[{"type":"setFlag","key":"dw_black_sun_time","value":"NOW_HOUR"},{"type":"tensionDelta","delta":3},{"type":"mythicRumorDelta","delta":2},{"type":"personAddThought","target":{"selector":"randomAlive"},"thought":{"id":"dw_black_sun","label":"Saw the sun go wrong","value":-3,"hours":18,"source":"omen"}}]},{"id":"dw_generic_whispering_wire","kind":"minor","trigger":{"mode":["travel"],"block":["evening"],"mythicEnabled":true,"locationContains":"Fort","hoursSinceFlagAtLeast":{"dw_wire_time":168}},"weight":2,"tension":{"min":10,"max":90},"tags":["conspiracy","sound","omen"],"log":{"tone":"event","text":"Telegraph wire sings in the wind, but you swear the rhythm matches speech\u2014short, short, long."},"effects":[{"type":"setFlag","key":"dw_wire_time","value":"NOW_HOUR"},{"type":"mythicRumorDelta","delta":1},{"type":"roll","chance":0.25,"then":[{"type":"suppliesDelta","supplyId":"itm_strange_battery","delta":1,"clampMin":0},{"type":"personAddTrait","target":{"selector":"randomAlive"},"traitId":"telegraph_tinker"}]}]}],"eventTemplates":[{"id":"tpl_night_sky_omen","kind":"minor","trigger":{"mode":["camp"],"block":["night"],"mythicEnabled":true},"weight":1,"tags":["template","omen","night"],"slots":{"title":["Wrong stars","A silent aurora","Lanterns in the clouds","The sky blinks"],"log":["Stars shift into a pattern you don't recognize. Everyone pretends not to notice.","An aurora glows without sound, then vanishes as soon as you point at it.","Lights drift in a slow line above camp, too steady to be fireflies.","For a heartbeat, the sky goes dark\u2014as if it blinked."],"thoughtLabel":["Felt watched by the sky","Unsettled by the night sky","Sky omen","Night anxiety"]},"effectPattern":{"tensionDeltaRange":[0,2],"mythicRumorDeltaRange":[0,2],"optionalHiddenTrait":["latent_psychic","conspiracy_mind"]}},{"id":"tpl_traveler_trade_weird","kind":"lifeline","trigger":{"mode":["travel"],"block":["noon","evening"],"mythicEnabled":true},"weight":1,"tags":["template","trade","traveler"],"slots":{"title":["A trader with odd goods","A polite stranger","A peddler with secrets"],"body":["A traveler offers a deal that sounds fair until you notice how carefully they avoid your eyes.","A peddler's blanket holds ordinary goods\u2014and one thing that seems to drink the light.","A stranger asks a question first, then offers trade as if it was the answer."],"offer":[{"give":"itm_star_map_scrap","cost":{"treasure":1}},{"give":"itm_eye_charm","cost":{"pelts":2}},{"give":"itm_strange_battery","cost":{"ammo":2}}]},"effectPattern":{"repDelta":[{"factionId":"caravans","deltaRange":[-1,2]},{"factionId":"men_in_gray","deltaRange":[-2,2]}],"rumorDeltaRange":[0,2]}},{"id":"tpl_river_anomaly","kind":"minor","trigger":{"mode":["travel","camp"],"block":["noon","evening"],"mythicEnabled":true,"riskAny":["water_shortage"]},"weight":1,"tags":["template","river","anomaly"],"slots":{"log":["The river's surface looks wrong\u2014too smooth, too reflective. Ripples move like thoughts.","Your cup fills with clear water, then darkens for a blink, then clears again.","A fish breaks the surface, then falls back like it forgot how to be a fish."],"outcome":["safe","sick","omen"]},"effectPattern":{"ifSafe":{"suppliesDelta":{"water":[1,3]},"thought":{"value":[1,2]}},"ifSick":{"affliction":"aff_gray_fever","severityRange":[1,2]},"ifOmen":{"rumorDeltaRange":[1,2],"tensionDeltaRange":[0,2]}}},{"id":"tpl_dream_event","kind":"breather","trigger":{"mode":["camp"],"block":["night"],"mythicEnabled":true},"weight":1,"tags":["template","dream"],"slots":{"title":["A shared dream","A dream with teeth","A dream of light"],"body":["In the morning, two people describe the same dream in the same words.","Someone wakes with dirt under their nails and no memory of leaving the bedroll.","A dream leaves a smell behind\u2014ozone, mushrooms, or gunpowder."],"reward":["rumor","item","trait_hint"]},"effectPattern":{"rumorDeltaRange":[0,2],"optionalItem":["itm_register_rubbing","itm_powdered_ink","itm_bitter_tea"],"optionalHiddenTrait":["latent_psychic","ink_touched","time_sense"]}},{"id":"tpl_artifact_find","kind":"breather","trigger":{"mode":["travel"],"block":["noon"],"mythicEnabled":true},"weight":1,"tags":["template","artifact"],"slots":{"log":["Something glints in the dirt\u2014too clean to be natural, too old to be new.","In the grass, you find an object that feels colder than shade.","A crow drops something at your feet and flies away without looking back."],"artifact":["itm_mirror_shard","itm_etched_disc","itm_cinder_glass","itm_dull_medal"]},"effectPattern":{"giveItem":true,"rumorDeltaRange":[0,1],"tensionDeltaRange":[0,1]}}]};
function getDreamWestTarget(ctx, selector) {
const people = (ctx && ctx.people && ctx.people.length ? ctx.people : getAllPeople()).filter(function (p) {
return p && p.alive;
});
if (!people.length) return null;
const leader = gameState.leader;
if (!selector || selector === "leader") return leader || people[0];
if (selector === "randomNonLeader") {
const nonLeaders = people.filter(function (p) { return !leader || p.id !== leader.id; });
return nonLeaders.length ? choice(nonLeaders) : people[0];
}
return choice(people);
}
function applyDreamWestEffects(ctx, effects, choiceId) {
let capturedLog = null;
let capturedTone = "event";
let capturedLocation = null;
const ss = ctx && ctx.storyState ? ctx.storyState : ensureStoryState();
function applyOne(effect) {
if (!effect || typeof effect !== "object") return;
const type = effect.type;
if (type === "choiceOutcomeMap") {
const table = effect.byChoice || {};
const bucket = table[choiceId] || table.any;
if (bucket && Array.isArray(bucket)) bucket.forEach(applyOne);
return;
}
if (type === "roll") {
const chance = typeof effect.chance === "number" ? effect.chance : 0;
const branch = Math.random() < chance ? effect.then : effect.else;
if (Array.isArray(branch)) branch.forEach(applyOne);
return;
}
if (type === "setFlag") {
const key = effect.key;
if (key) {
const val = effect.value === "NOW_HOUR" ? getCurrentTrailHour(gameState) : effect.value;
setEventFlag(key, val);
}
return;
}
if (type === "suppliesDelta") {
const id = effect.supplyId;
if (id) {
const current = gameState.supplies[id] || 0;
const next = current + (effect.delta || 0);
const min = effect.clampMin != null ? effect.clampMin : 0;
gameState.supplies[id] = Math.max(min, next);
}
return;
}
if (type === "moneyDelta") {
const delta = typeof effect.delta === "number" ? effect.delta : 0;
gameState.money = Math.max(0, (gameState.money || 0) + delta);
return;
}
if (type === "factionRepDelta") {
const delta = typeof effect.delta === "number" ? effect.delta : 0;
if (effect.factionId) adjustFactionRep(effect.factionId, delta, null, ctx);
return;
}
if (type === "mythicRumorDelta") {
const delta = typeof effect.delta === "number" ? effect.delta : 0;
ss.mythicRumor = clamp((ss.mythicRumor || 0) + delta, 0, 100);
return;
}
if (type === "tensionDelta") {
const delta = typeof effect.delta === "number" ? effect.delta : 0;
ss.tension = clamp((ss.tension || 0) + delta, 0, 100);
return;
}
if (type === "personStatDelta") {
const target = getDreamWestTarget(ctx, effect.target && effect.target.selector);
if (target && effect.stat) adjustPersonStat(target, effect.stat, effect.delta || 0);
return;
}
if (type === "personAddThought") {
const target = getDreamWestTarget(ctx, effect.target && effect.target.selector);
if (target && effect.thought) {
const cfg = Object.assign({}, effect.thought);
if (cfg.hours != null && cfg.hoursLeft == null) cfg.hoursLeft = cfg.hours;
addThought(target, cfg);
}
return;
}
if (type === "personAddAffliction") {
const target = getDreamWestTarget(ctx, effect.target && effect.target.selector);
if (target && effect.afflictionId) {
let severity = effect.severity;
if (severity && typeof severity === "object") {
const min = typeof severity.min === "number" ? severity.min : 1;
const max = typeof severity.max === "number" ? severity.max : min;
severity = randInt(min, max);
}
addAffliction(target, effect.afflictionId, { severity: severity });
}
return;
}
if (type === "log") {
capturedLog = effect.text || capturedLog;
capturedTone = effect.tone || capturedTone;
if (effect.locationFromCtx) capturedLocation = ctx && ctx.location;
return;
}
if (type === "assignCaseFileRandom") {
const pool = Array.isArray(effect.caseFileIds) ? effect.caseFileIds : [];
if (pool.length) {
const pick = choice(pool);
const key = effect.setStoryKey || "dw_caseFileId";
setEventFlag(key, pick);
if (effect.alsoSetFlag && effect.alsoSetFlag.key) {
setEventFlag(effect.alsoSetFlag.key, effect.alsoSetFlag.value != null ? effect.alsoSetFlag.value : true);
}
}
return;
}
if (type === "addRumorFromTable") {
const delta = effect.count || 1;
ss.mythicRumor = clamp((ss.mythicRumor || 0) + delta, 0, 100);
return;
}
if (type === "markPersonMissing") {
const target = getDreamWestTarget(ctx, effect.target && effect.target.selector);
if (target) {
const key = effect.setFlagKey || "dw_missing_person";
setEventFlag(key, target.id);
}
return;
}
if (type === "resolveMissingPerson") {
const key = effect.flagKey || "dw_missing_person";
setEventFlag(key, null);
return;
}
}
(effects || []).forEach(applyOne);
return { logText: capturedLog, logTone: capturedTone, logLocation: capturedLocation };
}
function buildDreamWestEventDefs(pack) {
if (!pack || !Array.isArray(pack.events)) return [];
const cooldownByKind = { breather: 24, minor: 48, major: 96, setpiece: 168, lifeline: 24 };
return pack.events.map(function (ev, idx) {
const id = ev && ev.id ? (ev.id.indexOf("dw_") === 0 ? ev.id : "dw_" + ev.id) : "dw_evt_" + idx;
const trigger = ev.trigger || {};
const minTension = ev.tension && ev.tension.min != null ? ev.tension.min : null;
const maxTension = ev.tension && ev.tension.max != null ? ev.tension.max : null;
const eventCooldown = typeof ev.cooldownHours === "number" ? ev.cooldownHours : cooldownByKind[ev.kind] || 36;
const defaultMinMiles = ev.kind === "setpiece" ? 400 : ev.kind === "major" ? 120 : 0;
return {
id: id,
kind: ev.kind || "minor",
...
if (!ctx || runHasEnded()) return false;
const ss = ctx.storyState || ensureStoryState();
const nowHour = getCurrentTrailHour(gameState);
if (ev.kind !== "lifeline") {
const lastAny = ss.eventFlags && ss.eventFlags["dw:lastAny"];
if (typeof lastAny === "number" && nowHour - lastAny < 12) return false;
}
const lastThis = ss.eventFlags && ss.eventFlags["dw:last:" + id];
if (typeof lastThis === "number" && nowHour - lastThis < eventCooldown) return false;
const modeOk = !trigger.mode || trigger.mode.indexOf("any") >= 0 || trigger.mode.indexOf(ctx.mode) >= 0;
if (!modeOk) return false;
const blockOk = !trigger.block || trigger.block.indexOf(ctx.block) >= 0;
if (!blockOk) return false;
if (trigger.regionKey) {
const regions = Array.isArray(trigger.regionKey) ? trigger.regionKey : [trigger.regionKey];
if (regions.indexOf(ctx.regionKey) < 0) return false;
}
if (trigger.milesTraveledMin != null) {
if ((gameState.milesTraveled || 0) < trigger.milesTraveledMin) return false;
} else if (defaultMinMiles && (gameState.milesTraveled || 0) < defaultMinMiles) return false;
if (trigger.milesTraveledMax != null && (gameState.milesTraveled || 0) > trigger.milesTraveledMax) return false;
if (trigger.locationContains) {
const loc = (ctx.location || "").toLowerCase();
if (loc.indexOf((trigger.locationContains || "").toLowerCase()) < 0) return false;
}
if (trigger.guardCoverageMax != null && ctx.guardCoverage > trigger.guardCoverageMax) return false;
if (trigger.requiresSupplyAtLeast) {
const needed = trigger.requiresSupplyAtLeast;
const supplyKeys = Object.keys(needed);
for (let i = 0; i < supplyKeys.length; i++) {
const key = supplyKeys[i];
const val = needed[key];
if ((gameState.supplies[key] || 0) < val) return false;
}
}
if (trigger.requiresFactionRepMin) {
const req = trigger.requiresFactionRepMin;
const entries = [];
if (req.factionId) entries.push({ factionId: req.factionId, value: req.value });
else if (typeof req === "object") {
Object.keys(req).forEach(function (k) {
entries.push({ factionId: k, value: req[k] });
});
}
for (let i = 0; i < entries.length; i++) {
const ent = entries[i];
const rep = (ss.factionRep && ss.factionRep[ent.factionId]) || 0;
if (rep < (ent.value || 0)) return false;
}
}
if (trigger.requiresFactionRepMax) {
const req = trigger.requiresFactionRepMax;
const entries = [];
if (req.factionId) entries.push({ factionId: req.factionId, value: req.value });
else if (typeof req === "object") {
Object.keys(req).forEach(function (k) {
...
const ent = entries[i];
const rep = (ss.factionRep && ss.factionRep[ent.factionId]) || 0;
if (rep > ent.value) return false;
}
}
if (trigger.requiresPartyTraitAny) {
const traits = trigger.requiresPartyTraitAny;
const ok = (ctx.people || getAllPeople()).some(function (p) {
return p && p.traits && traits.some(function (tid) { return p.traits.indexOf(tid) >= 0; });
});
if (!ok) return false;
}
if (trigger.requiresPartyAfflictionAny) {
const affs = trigger.requiresPartyAfflictionAny;
const ok = (ctx.people || getAllPeople()).some(function (p) {
return p && Array.isArray(p.afflictions) && p.afflictions.some(function (a) { return affs.indexOf(a.id) >= 0; });
});
if (!ok) return false;
}
if (trigger.requiresPartyAnyIllness) {
const ok = (ctx.people || getAllPeople()).some(function (p) {
return p && Array.isArray(p.afflictions) && p.afflictions.length > 0;
});
if (!ok) return false;
}
if (trigger.requiresFlagsAll) {
const flags = trigger.requiresFlagsAll || [];
const allOk = flags.every(function (f) { return ss.eventFlags && ss.eventFlags[f]; });
if (!allOk) return false;
}
if (trigger.forbidsFlagsAny) {
const flags = trigger.forbidsFlagsAny || [];
const anyHit = flags.some(function (f) { return ss.eventFlags && ss.eventFlags[f]; });
if (anyHit) return false;
}
if (trigger.hoursSinceFlagAtLeast) {
const rules = trigger.hoursSinceFlagAtLeast;
const keys = Object.keys(rules);
for (let i = 0; i < keys.length; i++) {
const key = keys[i];
const minHours = rules[key];
if (hoursSinceFlag(key) < minHours) return false;
}
}
if (trigger.weatherAny) {
const weather = ctx.weather || {};
const ok = trigger.weatherAny.some(function (w) { return weather[w]; });
if (!ok) return false;
}
if (trigger.riskAny) {
const risks = trigger.riskAny || [];
const ok = risks.some(function (r) { return ctx.risk && ctx.risk[r]; });
if (!ok) return false;
}
return true;
},
...
let selection = null;
let logText = ev.log && ev.log.text ? ev.log.text : null;
let logTone = (ev.log && ev.log.tone) || "event";
let logLocation = ev.log && ev.log.locationFromCtx ? ctx.location : null;
if (encounter) {
selection = await presentEncounter({
id: id,
title: encounter.title || "Strange encounter",
subtitle: encounter.subtitleFromCtx === "location" ? ctx.location : encounter.subtitle,
body: encounter.body || [],
tags: encounter.tags || [],
options: (encounter.options || []).map(function (opt, idx) {
return {
id: opt.id || "opt_" + idx,
label: opt.label || opt.id || "Choose",
tone: opt.tone,
hint: opt.hint,
};
}),
defaultId: encounter.defaultId,
});
if (!selection && encounter.options && encounter.options[0]) {
selection = encounter.options[0].id;
}
}
const effectsResult = applyDreamWestEffects(ctx, ev.effects, selection);
if (effectsResult && effectsResult.logText) {
logText = effectsResult.logText;
logTone = effectsResult.logTone || logTone;
logLocation = effectsResult.logLocation || logLocation;
}
const nowHour = getCurrentTrailHour(gameState);
setEventFlag("dw:lastAny", nowHour);
setEventFlag("dw:last:" + id, nowHour);
const optLabel = encounter && selection
? (encounter.options || []).find(function (o) { return o.id === selection; })
: null;
const fallback = encounter ? encounter.title : "Dream-West ripple";
const line = logText || (optLabel ? fallback + " — " + (optLabel.label || selection) : fallback);
addLog(line, { tone: logTone || "event", tag: "DAY " + ctx.dayTag, location: logLocation || ctx.location });
},
};
});
}
const DREAMWEST_EVENT_DEFS = buildDreamWestEventDefs(DREAMWEST_PACK);
...
{
id: "seed_b04_mirror_wagon_echo",
kind: "breather",
condition: function (ctx) {
const windowOk = ctx.mode === "camp" && ctx.block === "evening";
return (
getEventFlag("mirror_wagon_signal") &&
!getEventFlag("seed_b04_mirror_wagon_echo_done") &&
hoursSinceFlag("seed_b04_mirror_wagon_time") >= 48 &&
hoursSinceFlag("seed_b_global_time") >= 36 &&
windowOk
);
},
...
const selection = await presentEncounter({
id: "seed_b04_mirror_wagon_echo",
title: "Echo of the mirror wagon",
subtitle: ctx.location,
body: [
"A lone lantern bobs where no wagon should be, the light moving as if through glass just beyond reach.",
],
tags: ["camp", "omen"],
options: [
{ id: "follow", label: "Follow the lantern", tone: "warm", hint: "Maybe guidance, maybe nothing." },
{ id: "mark", label: "Mark it and move on", tone: "neutral", hint: "Note the spot; settle nerves." },
{ id: "ignore", label: "Ignore it", tone: "danger", hint: "Keep routine; hope the light fades." },
],
defaultId: "follow",
});
const nowHour = getCurrentTrailHour(gameState);
setEventFlag("seed_b_global_time", nowHour);
setEventFlag("seed_b04_mirror_wagon_echo_done", true);
setEventFlag("mirror_wagon_signal", false);
let logText = null;
if (selection === "follow") {
let curioGranted = false;
if (ctx.storyState.mythicEnabled !== false) {
const curioState = ensureMythicCurioState();
const candidates = ["home_marker", "wisp_lantern"].filter(function (id) {
return curioState.owned.indexOf(id) < 0;
});
const pool = candidates.length ? candidates : [];
if (pool.length && Math.random() < 0.18) {
const curioId = choice(pool);
gainMythicCurio(curioId, "Followed a mirrored lantern through the dark");
curioGranted = true;
}
}
if (!curioGranted) {
if (Math.random() < 0.5) {
gameState.supplies.ammo = Math.max(0, (gameState.supplies.ammo || 0) + 1);
logText = "You pace after the light and find only a forgotten cartridge box near a rock cairn.";
} else {
gameState.supplies.medicine = Math.max(0, (gameState.supplies.medicine || 0) + 1);
logText = "The lantern leads you to a tucked-away tonic bottle before winking out.";
}
}
...
logText = "You stake a marker and sketch the bend; the crew exhales as the strange light drifts on.";
} else if (selection === "ignore") {
ctx.storyState.tension = clamp((ctx.storyState.tension || 0) + 1, 0, 100);
logText = "You let the lantern bob away. The night stays ordinary, if a little colder.";
}
if (logText) {
addLog(logText, { tone: "event", tag: "DAY " + ctx.dayTag, location: ctx.location });
}
recordStoryBeat("seed", "omen", "Echo of the mirror wagon", { id: "seed_b04_mirror_wagon_echo", choice: selection });
},
},
{
...
{
id: "seed_b07_men_in_gray_resonance",
kind: "minor",
condition: function (ctx) {
const traceSeen = getEventFlag("men_in_gray_token") || getEventFlag("men_in_gray_footprints");
return (
ctx.storyState.mythicEnabled !== false &&
ctx.mode === "camp" &&
ctx.block === "night" &&
traceSeen &&
!getEventFlag("seed_b07_men_in_gray_resonance_done") &&
hoursSinceFlag("seed_b07_men_in_gray_offer_time") >= 24 &&
hoursSinceFlag("seed_b_global_time") >= 36
);
},
weight: function () {
...
const selection = await presentEncounter({
id: "seed_b07_men_in_gray_resonance",
title: "Gray token hums in the dark",
subtitle: ctx.location,
body: [
"A flat humming rolls through camp. The gray token feels warm, and bootprints near the wagons point everywhere at once.",
],
tags: ["camp", "mythic"],
options: [
{ id: "attune", label: "Attune / keep it close", tone: "warm", hint: "Lean into their unseen favor." },
{ id: "bury", label: "Bury it / scrub the prints", tone: "neutral", hint: "Ease tension; step away from omens." },
{ id: "discard", label: "Throw it away", tone: "danger", hint: "Break the link, whatever the cost." },
],
defaultId: "attune",
});
const nowHour = getCurrentTrailHour(gameState);
let logText = null;
if (selection === "attune") {
if (getEventFlag("men_in_gray_token")) {
gainMythicCurio("gray_token", "Kept the gray token close");
}
adjustFactionRep("men_in_gray", 3, null, ctx);
} else if (selection === "bury") {
ctx.storyState.tension = clamp((ctx.storyState.tension || 0) - 2, 0, 100);
(ctx.people || getAllPeople()).forEach(function (p) {
adjustPersonStat(p, "morale", 1);
});
adjustFactionRep("men_in_gray", -1, null, ctx);
logText = "You bury the token and scrub the prints into mud. Camp exhales, uneasy but calmer.";
} else if (selection === "discard") {
adjustFactionRep("men_in_gray", -3, null, ctx);
ctx.storyState.tension = clamp((ctx.storyState.tension || 0) + 1, 0, 100);
logText = "You fling the gray trace into the brush. The humming stops, leaving the dark to listen.";
}
setEventFlag("men_in_gray_token", false);
setEventFlag("men_in_gray_footprints", false);
setEventFlag("men_in_gray_resolved", true);
setEventFlag("seed_b07_men_in_gray_resonance_done", true);
setEventFlag("seed_b07_men_in_gray_offer_time", nowHour);
setEventFlag("seed_b_global_time", nowHour);
if (logText) {
addLog(logText, { tone: "event", tag: "DAY " + ctx.dayTag, location: ctx.location });
}
recordStoryBeat("seed", "mythic", "Men in Gray resonance settled", {
id: "seed_b07_men_in_gray_resonance",
choice: selection,
});
},
...
{
id: "seed_b14_telegraph_choir",
kind: "breather",
condition: function (ctx) {
return (
ctx.mode === "travel" &&
ctx.block === "evening" &&
hoursSinceFlag("seed_b14_telegraph_choir_time") >= 168 &&
hoursSinceFlag("seed_b_global_time") >= 36
);
},
weight: function () {
...
const selection = await presentEncounter({
id: "seed_b14_telegraph_choir",
title: "Telegraph wire choir",
subtitle: ctx.location,
body: [
"A sagging telegraph line hums in the dusk. The wire vibrates like a choir of kettle whistles and ghostly hymns.",
],
tags: ["travel", "omen"],
options: [
{ id: "listen", label: "Listen to the song", tone: "warm", hint: "Morale lifts; tension eases." },
{ id: "clip", label: "Clip a length for scrap", tone: "danger", hint: "Pocket copper; unsettles the team." },
{ id: "ignore", label: "Ignore it", tone: "neutral", hint: "Keep rolling." },
],
defaultId: "listen",
});
const nowHour = getCurrentTrailHour(gameState);
setEventFlag("seed_b_global_time", nowHour);
setEventFlag("seed_b14_telegraph_choir_time", nowHour);
let logText = "";
if (selection === "listen") {
(ctx.people || getAllPeople()).forEach(function (p) {
adjustPersonStat(p, "morale", 1);
...
ctx.storyState.tension = clamp((ctx.storyState.tension || 0) - 2, 0, 100);
logText = "You rein in and listen. The wire sings until the last light fades and nerves settle.";
} else if (selection === "clip") {
gameState.money = (gameState.money || 0) + 3;
ctx.storyState.tension = clamp((ctx.storyState.tension || 0) + 1, 0, 100);
logText = "You snip a gleaming length of wire, coil it, and feel eyes on your back until camp.";
} else if (selection === "ignore") {
ctx.storyState.tension = clamp((ctx.storyState.tension || 0) - 1, 0, 100);
logText = "You keep the team steady while the wire wails past.";
}
if (logText) addLog(logText, { tone: "event", tag: "DAY " + ctx.dayTag, location: ctx.location });
recordStoryBeat("seed", "seed_b14_telegraph_choir", "Telegraph wire hummed along the trail", {
choice: selection,
});
},
},
{
id: "seed_b15_black_dog_in_snow",
kind: "minor",
condition: function (ctx) {
return (
ctx.mode === "camp" &&
ctx.block === "night" &&
hoursSinceFlag("seed_b15_black_dog_in_snow_time") >= 168 &&
hoursSinceFlag("seed_b_global_time") >= 36
);
},
weight: function () {
...
const selection = await presentEncounter({
id: "seed_b15_black_dog_in_snow",
title: "Black dog in the snow",
subtitle: ctx.location,
body: [
"Frost rims the wagons. A black dog sits beyond the firelight, silent, eyes reflecting sparks as snow drifts settle.",
],
tags: ["camp", "omen"],
options: [
{ id: "feed", label: "Feed the dog", tone: "warm", hint: "Costs a meal; lifts morale." },
{ id: "chase", label: "Chase it off", tone: "danger", hint: "Risk a stumble in the dark." },
{ id: "dismiss", label: "Let it watch", tone: "neutral", hint: "Move on uneasily." },
],
defaultId: "feed",
});
const nowHour = getCurrentTrailHour(gameState);
setEventFlag("seed_b_global_time", nowHour);
setEventFlag("seed_b15_black_dog_in_snow_time", nowHour);
let logText = "";
if (selection === "feed") {
if ((gameState.supplies.meal_simple || 0) > 0) {
gameState.supplies.meal_simple = Math.max(0, (gameState.supplies.meal_simple || 0) - 1);
}
(ctx.people || getAllPeople()).forEach(function (p) {
adjustPersonStat(p, "morale", 1);
});
logText = "You slide a ration toward the dog. It eats, leaves a warm patch in the snow, and vanishes.";
} else if (selection === "chase") {
const target = choice(ctx.people || getAllPeople());
if (target) {
target.energy = clamp((target.energy || 50) - 4, 0, 100);
target.condition = clamp((target.condition || 50) - 3, 0, 100);
}
ctx.storyState.tension = clamp((ctx.storyState.tension || 0) + 1, 0, 100);
logText = target
? target.name + " slips in the snow driving the omen-hound away."
: "You chase the dog; the snow hides the ruts and someone stumbles.";
} else if (selection === "dismiss") {
ctx.storyState.tension = clamp((ctx.storyState.tension || 0) + 1, 0, 100);
logText = "You let the dog watch until it melts into the snow and unease settles in.";
}
if (logText) addLog(logText, { tone: "event", tag: "DAY " + ctx.dayTag, location: ctx.location });
recordStoryBeat("seed", "seed_b15_black_dog_in_snow", "Encountered a black dog omen", { choice: selection });
},
},
{
id: "seed_b16_dead_mailbag",
kind: "minor",
condition: function (ctx) {
return (
(ctx.mode === "camp" || ctx.mode === "travel") &&
(ctx.block === "evening" || ctx.block === "night") &&
hoursSinceFlag("seed_b16_dead_mailbag_time") >= 168 &&
hoursSinceFlag("seed_b_global_time") >= 36
);
},
weight: function () {
...
const selection = await presentEncounter({
id: "seed_b16_dead_mailbag",
title: "Mailbag from nowhere",
subtitle: ctx.location,
body: [
"A torn mailbag lies in the ruts. Letters spill out addressed to people not yet born, postmarks a decade ahead.",
],
tags: ["omen", "trade"],
options: [
{ id: "read", label: "Read a handful", tone: "neutral", hint: "Raises tension; earns a stray clue." },
{ id: "burn", label: "Burn the lot", tone: "warm", hint: "Lower tension; lose a little faith with someone." },
{ id: "keep", label: "Tie it shut and keep", tone: "danger", hint: "Pocket a curiosity; risks gossip." },
],
defaultId: "read",
});
const nowHour = getCurrentTrailHour(gameState);
setEventFlag("seed_b_global_time", nowHour);
setEventFlag("seed_b16_dead_mailbag_time", nowHour);
let logText = "";
if (selection === "read") {
ctx.storyState.tension = clamp((ctx.storyState.tension || 0) + 2, 0, 100);
const pair = ctx.rivalPair || null;
if (pair) adjustOpinion(pair[0], pair[1], 1, "mailbag_secret");
logText = "You read enough to know the dates are wrong. The letters whisper until the fire drowns them out.";
} else if (selection === "burn") {
ctx.storyState.tension = clamp((ctx.storyState.tension || 0) - 2, 0, 100);
adjustFactionRep("men_in_gray", -2, null, ctx);
logText = "You burn the future mail. The smoke twists oddly and a gray-coated rider on the ridge turns away.";
} else if (selection === "keep") {
setEventFlag("seed_b16_mailbag_kept", true);
ctx.storyState.tension = clamp((ctx.storyState.tension || 0) + 1, 0, 100);
logText = "You tie the bag shut and stow it. Someone mutters that debts might come due later.";
}
if (logText) addLog(logText, { tone: "event", tag: "DAY " + ctx.dayTag, location: ctx.location });
recordStoryBeat("seed", "seed_b16_dead_mailbag", "Found a mailbag with future dates", { choice: selection });
},
},
{
id: "seed_b17_campfire_census",
kind: "minor",
condition: function (ctx) {
return (
ctx.mode === "camp" &&
ctx.block === "night" &&
hoursSinceFlag("seed_b17_campfire_census_time") >= 168 &&
hoursSinceFlag("seed_b_global_time") >= 36
);
},
weight: function () {
...
const selection = await presentEncounter({
id: "seed_b17_campfire_census",
title: "Campfire census",
subtitle: ctx.location,
body: [
"Men in Gray step into the light with a leather ledger. They ask absurd questions: number of dreams per night, how many times you've bitten your tongue this week.",
],
tags: ["camp", "mythic"],
options: [
{ id: "cooperate", label: "Answer straight", tone: "warm", hint: "Builds standing with them." },
{ id: "lie", label: "Feed them nonsense", tone: "danger", hint: "Might amuse; might offend." },
{ id: "refuse", label: "Refuse the ledger", tone: "danger", hint: "Raises tension." },
],
defaultId: "cooperate",
});
const nowHour = getCurrentTrailHour(gameState);
setEventFlag("seed_b_global_time", nowHour);
setEventFlag("seed_b17_campfire_census_time", nowHour);
let logText = "";
if (selection === "cooperate") {
adjustFactionRep("men_in_gray", 4, null, ctx);
ctx.storyState.tension = clamp((ctx.storyState.tension || 0) - 1, 0, 100);
logText = "You answer every strange question. The ledgers snap shut with a nod.";
} else if (selection === "lie") {
adjustFactionRep("men_in_gray", -2, null, ctx);
(ctx.people || getAllPeople()).forEach(function (p) {
adjustPersonStat(p, "morale", 1);
});
logText = "You spin tall tales until the gray coats close the book in irritation.";
} else if (selection === "refuse") {
adjustFactionRep("men_in_gray", -4, null, ctx);
ctx.storyState.tension = clamp((ctx.storyState.tension || 0) + 2, 0, 100);
logText = "You bar the ledger from the firelight. The men in gray leave without a word.";
}
if (logText) addLog(logText, { tone: "event", tag: "DAY " + ctx.dayTag, location: ctx.location });
recordStoryBeat("seed", "seed_b17_campfire_census", "Men in Gray took a census", { choice: selection });
},
},
{
id: "seed_b18_open_eye_leaflet",
kind: "breather",
condition: function (ctx) {
return (
ctx.mode === "camp" &&
ctx.block === "evening" &&
hoursSinceFlag("seed_b18_open_eye_leaflet_time") >= 168 &&
hoursSinceFlag("seed_b_global_time") >= 36
);
},
weight: function () {
...
const selection = await presentEncounter({
id: "seed_b18_open_eye_leaflet",
title: "Open Eye hymn leaflet",
subtitle: ctx.location,
body: [
"Wind pushes a crumpled leaflet against a wagon wheel. It holds a hymn to the Open Eye written in careful hand.",
],
tags: ["camp", "cult"],
options: [
{ id: "memorize", label: "Memorize the verse", tone: "warm", hint: "Bolsters morale; pleases the Open Eye." },
{ id: "mock", label: "Mock it by the fire", tone: "danger", hint: "Risks offense." },
{ id: "trade", label: "Trade it for coin", tone: "neutral", hint: "A peddler pays for curios." },
],
defaultId: "memorize",
});
const nowHour = getCurrentTrailHour(gameState);
setEventFlag("seed_b_global_time", nowHour);
setEventFlag("seed_b18_open_eye_leaflet_time", nowHour);
let logText = "";
if (selection === "memorize") {
(ctx.people || getAllPeople()).forEach(function (p) {
adjustPersonStat(p, "morale", 1);
});
adjustFactionRep("open_eye", 3, null, ctx);
logText = "You hum the hymn softly; the campfire feels warmer for a spell.";
} else if (selection === "mock") {
adjustFactionRep("open_eye", -4, null, ctx);
ctx.storyState.tension = clamp((ctx.storyState.tension || 0) + 1, 0, 100);
logText = "You make jokes over the hymn; someone snuffs the leaflet and the fire cracks sharply.";
} else if (selection === "trade") {
gameState.money = (gameState.money || 0) + 4;
logText = "A passing peddler gives a few coins for the curious hymn sheet.";
}
if (logText) addLog(logText, { tone: "event", tag: "DAY " + ctx.dayTag, location: ctx.location });
recordStoryBeat("seed", "seed_b18_open_eye_leaflet", "Found an Open Eye hymn", { choice: selection });
},
},
{
id: "seed_b19_mirror_wagon_sign",
kind: "breather",
condition: function (ctx) {
return (
ctx.mode === "travel" &&
(ctx.block === "noon" || ctx.block === "evening") &&
hoursSinceFlag("seed_b19_mirror_wagon_sign_time") >= 168 &&
hoursSinceFlag("seed_b_global_time") >= 36
);
},
weight: function () {
...
const selection = await presentEncounter({
id: "seed_b19_mirror_wagon_sign",
title: "Mirrored wagon sign",
subtitle: ctx.location,
body: [
"A nailed board flashes in a puddle like a mirror. Its painted arrow points toward a \"shorter\" path that shouldn't be there.",
],
tags: ["travel", "omen"],
options: [
{ id: "follow", label: "Follow the sign", tone: "danger", hint: "Push for extra miles; risk a mishap." },
{ id: "ignore", label: "Ignore it", tone: "neutral", hint: "Stay on the mapped trail." },
{ id: "mark", label: "Mark it on your map", tone: "warm", hint: "Flag it for later." },
],
defaultId: "ignore",
});
const nowHour = getCurrentTrailHour(gameState);
setEventFlag("seed_b_global_time", nowHour);
setEventFlag("seed_b19_mirror_wagon_sign_time", nowHour);
let logText = "";
if (selection === "follow") {
gameState.lastHourMiles = (gameState.lastHourMiles || 0) + 0.8;
if (Math.random() < 0.4) {
gameState.wagonCondition = clamp((gameState.wagonCondition || 50) - 4, 0, 100);
}
logText = "You push onto the gleaming side path. The team makes good time but the wagon creaks in protest.";
} else if (selection === "ignore") {
ctx.storyState.tension = clamp((ctx.storyState.tension || 0) - 1, 0, 100);
logText = "You stick to the ruts you know, letting the mirrored arrow fade behind.";
} else if (selection === "mark") {
setEventFlag("seed_b19_mirror_mark", true);
logText = "You sketch the strange sign on your map for later, then roll on.";
}
if (logText) addLog(logText, { tone: "event", tag: "DAY " + ctx.dayTag, location: ctx.location });
recordStoryBeat("seed", "seed_b19_mirror_wagon_sign", "Spotted a mirrored wagon sign", { choice: selection });
},
},
];
...
ss.mythicEnabled = true;
gameState.mythicEnabled = true;
...
chaotic: {
id: "chaotic",
label: "Chaotic Narrator",
iconKey: "storm",
tagline: "Unpredictable, darkly humorous frontier weirdness",
description:
"Finds the oddest beats at the edge of the trail — like X-files on the frontier told with a dry grin.",
hint: "Surprise-forward pacing with guarded relief valves.",
examples: [
"A calm dusk can pivot into a whispered omen, then back to laughter before sleep.",
"Prefers sharp turns over long cruelty; tension toys with you more than it crushes you.",
],
personality: "Impish pacing; surprise over cruelty.",
tensionBaseDrift: 0.09,
tensionRiskScale: 0.34,
tensionMin: 10,
tensionMax: 100,
tensionAfterMajorDrop: 40,
tensionAfterMinorDrop: 20,
minHoursBetweenMajor: 16,
minHoursBetweenMinor: 2,
breatherBias: 0.98,
lifelineBias: 1.05,
pacingSummary: "Plains: pranks · Rockies: sudden turns · Columbia: uneasy grins",
regionCurves: {
plains: {
tensionRiskScale: 0.28,
baseDrift: 0.06,
minClamp: 12,
maxClamp: 85,
label: "quiet, until it isn't",
seasons: { spring: { baseDrift: 0.04 }, summer: { baseDrift: 0.1 } },
},
central_plains: {
tensionRiskScale: 0.3,
baseDrift: 0.08,
minClamp: 14,
maxClamp: 90,
label: "mirages and rumors",
seasons: { summer: { baseDrift: 0.12 } },
},
high_plains: { tensionRiskScale: 0.35, baseDrift: 0.12, minClamp: 18, maxClamp: 95, label: "flash-change skies" },
mountains: {
tensionRiskScale: 0.4,
baseDrift: 0.18,
minClamp: 24,
maxClamp: 100,
label: "switchback unease",
seasons: { fall: { baseDrift: 0.22 } },
},
snake_plain: { tensionRiskScale: 0.38, baseDrift: 0.16, minClamp: 24, maxClamp: 100, label: "heat mirage tricks" },
blue_mountains: { tensionRiskScale: 0.42, baseDrift: 0.2, minClamp: 26, maxClamp: 100, label: "shadow jokes" },
columbia: { tensionRiskScale: 0.46, baseDrift: 0.22, minClamp: 28, maxClamp: 100, label: "gallows chuckles" },
},
},
harsh: {
id: "harsh",
...
const TRAIT_SKILL_SCALE = 3;
function clampSkill(v) {
return clamp(Math.round(v), SKILL_MIN, SKILL_MAX);
}
function getSkillRaw(person, id) {
if (!person || !person.skills) return SKILL_MIN;
return clampSkill(person.skills[id] == null ? SKILL_MIN : person.skills[id]);
}
function getSkillTier(person, id) {
const raw = getSkillRaw(person, id);
return clamp(Math.ceil(raw / 4), 1, SKILL_TIER_MAX);
}
function getSkillScore(person, id) {
const raw = getSkillRaw(person, id);
return 10 + ((raw - SKILL_MIN) / (SKILL_MAX - SKILL_MIN)) * 40;
}
...
const delta = (def.skillMods[k] || 0) * TRAIT_SKILL_SCALE;
person.skills[k] = clampSkill((person.skills[k] || SKILL_MIN) + delta);
});
if (def.moraleBias) {
person.morale = clamp((person.morale || 60) + def.moraleBias, 0, 100);
}
if (def.guardBonus)
person.skills.guard = clampSkill(
(person.skills.guard || SKILL_MIN) + def.guardBonus * TRAIT_SKILL_SCALE
);
if (def.guardPenalty)
person.skills.guard = clampSkill(
(person.skills.guard || SKILL_MIN) - def.guardPenalty * TRAIT_SKILL_SCALE
);
applied.push(tid);
});
...
const skillVals = keys.map(function (k) {
return typeof person.skills[k] === "number" ? person.skills[k] : null;
});
const hasLegacyScale = skillVals.every(function (v) {
return v == null || v <= 6;
});
keys.forEach(function (k, idx) {
let val = person.skills[k];
if (hasLegacyScale && val != null) {
val = 1 + ((val || 0) / 6) * (SKILL_MAX - 1);
}
person.skills[k] = clampSkill(val == null ? SKILL_MIN : val);
});
if (hasLegacyScale) {
person.skillScale = "v2";
}
if (!person.skillScale) person.skillScale = "v2";
}
...
let level = getSkillRaw(person, skillId);
let xp = person.skillXP[skillId] || 0;
const beforeTier = getSkillTier(person, skillId);
xp += amount || 1;
let leveled = false;
while (level < SKILL_MAX) {
const needed = 12 + level * 6;
if (xp < needed) break;
xp -= needed;
level += 1;
leveled = true;
...
skills[skillId] = clampSkill(level);
person.skills = skills;
const afterTier = clamp(Math.ceil(level / 4), 1, SKILL_TIER_MAX);
if (leveled && afterTier > beforeTier) {
addLog(
`${person.name}'s ${skillIdLabel(skillId)} moves up to tier ${afterTier}.`,
{ importance: 1 }
);
}
}
...
dom.btnExportSave = document.getElementById("ot-btn-export-save");
dom.btnImportSave = document.getElementById("ot-btn-import-save");
dom.importSaveFile = document.getElementById("ot-import-save-file");
dom.timeReadout = document.getElementById("ot-time-readout");
dom.timeButtons = Array.from(document.querySelectorAll(".ot-time-btn"));
...
if (name === "travel") {
setTravelView(gameState.travelView || "explorer");
}
}
...
person.skills[k] = clampSkill((person.skills[k] || SKILL_MIN) + bias[k]);
});
}
if (draft) {
...
person.skills[k] = clampSkill((person.skills[k] || SKILL_MIN) + draft.skillBias[k]);
});
}
}
applyTraitStats(person);
...
const FRAILTY_TRAITS = ["frail", "stiff_joints", "cold_sickly"];
function traitPolarity(def) {
if (!def) return 0;
let score = 0;
Object.keys(def.skillMods || {}).forEach(function (k) {
score += (def.skillMods[k] || 0) * TRAIT_SKILL_SCALE * 0.4;
});
if (def.guardBonus) score += def.guardBonus * TRAIT_SKILL_SCALE * 0.4;
if (def.guardPenalty) score -= def.guardPenalty * TRAIT_SKILL_SCALE * 0.4;
if (def.moraleBias) score += def.moraleBias * 0.6;
if (def.socialBonus) score += def.socialBonus * 0.5;
if (def.opinionBias) score += def.opinionBias * 0.5;
if (def.taskPenalty) score -= def.taskPenalty * 0.6;
return score;
}
function pickTraits(rng, count, existing, opts) {
...
let safety = 0;
while (picked.length < count && safety < 60) {
safety += 1;
...
const def = getTraitDef(id);
if (!id || !def) continue;
if (opts && opts.avoidYoungHealth && FRAILTY_TRAITS.indexOf(id) >= 0 && rng() < 0.85)
continue;
picked.push(id);
...
if (count >= 3 && !(opts && opts.allowExtreme)) {
const hasPositive = picked.some(function (tid) {
return traitPolarity(getTraitDef(tid)) > 0.4;
});
const hasNegative = picked.some(function (tid) {
return traitPolarity(getTraitDef(tid)) < -0.4;
});
if (!hasPositive || !hasNegative) {
for (let i = 0; i < picked.length; i++) {
const wantPositive = !hasPositive;
const swapTarget = picked[i];
if (wantPositive && traitPolarity(getTraitDef(swapTarget)) > 0) continue;
if (!wantPositive && traitPolarity(getTraitDef(swapTarget)) < 0) continue;
const desiredPolarity = wantPositive ? 1 : -1;
let swapId = null;
for (let tries = 0; tries < 12 && !swapId; tries++) {
const id = pickTraitFromBucket("common", rng, picked, true);
const pol = traitPolarity(getTraitDef(id));
if ((desiredPolarity > 0 && pol > 0.4) || (desiredPolarity < 0 && pol < -0.4)) {
swapId = id;
}
}
if (swapId) {
picked.splice(i, 1, swapId);
break;
}
}
}
...
function traitSkillDelta(traits) {
const delta = {};
(traits || []).forEach(function (tid) {
const def = getTraitDef(tid);
if (!def) return;
Object.keys(def.skillMods || {}).forEach(function (k) {
delta[k] = (delta[k] || 0) + (def.skillMods[k] || 0) * TRAIT_SKILL_SCALE;
});
if (def.guardBonus)
delta.guard = (delta.guard || 0) + def.guardBonus * TRAIT_SKILL_SCALE;
if (def.guardPenalty)
delta.guard = (delta.guard || 0) - def.guardPenalty * TRAIT_SKILL_SCALE;
});
return delta;
}
function buildTraitTooltip(traitId) {
const def = typeof traitId === "string" ? getTraitDef(traitId) : traitId;
if (!def) return "";
const parts = [];
const hint = def.hint || def.personality || def.summary;
if (hint) parts.push(hint);
const mods = [];
Object.keys(def.skillMods || {}).forEach(function (k) {
const lbl = SKILL_LABELS[k] || k;
const delta = (def.skillMods[k] || 0) * TRAIT_SKILL_SCALE;
if (delta) mods.push((delta > 0 ? "+" : "") + delta + " " + lbl);
});
if (def.guardBonus)
mods.push("+" + def.guardBonus * TRAIT_SKILL_SCALE + " Guard");
if (def.guardPenalty)
mods.push("-" + def.guardPenalty * TRAIT_SKILL_SCALE + " Guard");
if (def.moraleBias)
mods.push((def.moraleBias > 0 ? "+" : "") + def.moraleBias + " morale");
if (def.socialBonus)
mods.push((def.socialBonus > 0 ? "+" : "") + def.socialBonus + " social");
if (def.opinionBias)
mods.push((def.opinionBias > 0 ? "+" : "") + def.opinionBias + " opinion");
if (def.taskPenalty)
mods.push("-" + def.taskPenalty + " task efficiency");
const mech = mods.length ? "Effects: " + mods.join(" · ") : null;
...
const traitMods = traitSkillDelta(draft && draft.traits);
const out = {};
SKILL_PREVIEW_ORDER.forEach(function (key) {
const bias = (draft && draft.skillBias && draft.skillBias[key]) || 0;
const tmod = traitMods[key] || 0;
out[key] = clampSkill((baseSkills[key] || SKILL_MIN) + bias + tmod);
});
return out;
}
...
const existingFirsts = Object.values(draft.people || {})
.map(function (p) {
return p && p.name ? p.name.split(" ")[0] : null;
})
.filter(Boolean);
let name = rollName(rng);
for (let i = 0; i < 3; i++) {
const first = name.split(" ")[0];
if (existingFirsts.indexOf(first) < 0) break;
name = rollName(rng);
}
const genderHint = deriveGenderHint(name);
const backstory = pickBackstory(rng, { genderHint: genderHint });
const age = 16 + Math.floor(rng() * 32);
const allowExtreme = rng() < 0.12;
const traitCountRoll = rng();
const traitCount =
traitCountRoll < 0.62 ? 3 : traitCountRoll < 0.85 ? 2 : traitCountRoll < 0.94 ? 1 : 4;
const traits = pickTraits(rng, traitCount, [], {
avoidYoungHealth: age < 22,
allowExtreme: allowExtreme,
});
const baseAnchor = 4 + Math.round(rng() * 3);
const ageMod = age < 20 ? -2 : age < 24 ? -1 : age > 45 ? 2 : age > 38 ? 1 : 0;
const skillBias = {};
SKILL_PREVIEW_ORDER.forEach(function (key) {
const backBias = ((backstory.skillBias && backstory.skillBias[key]) || 0) * TRAIT_SKILL_SCALE;
const perSkillNoise = Math.round((rng() - 0.45) * 6);
const desired = clampSkill(
SKILL_MIN + baseAnchor + ageMod + perSkillNoise + backBias
);
skillBias[key] = desired - SKILL_MIN;
});
draft.people[slot] = {
name: name,
...
const tip = (buildTraitTooltip(def || t) || "").replace(/"/g, "&quot;");
return `<span class="ot-draft-tag" title="${tip}" data-tip="${tip}">${
            def ? def.label : t
          }</span>`;
})
.join("")}</div>` +
  ...
  function startNewGameFromForm() {
    ...
    gameState.mythicEnabled = true;
    ensureStoryState().mythicEnabled = true;
  ...
  function rollSkillOutcome(person, taskId, difficulty, context) {
    ...
    const skillScore = getSkillScore(person, skillTag);
    ...
    const base = skillScore - 20 + moraleBonus - fatiguePenalty - weatherPenalty;
    const luck = (Math.random() - 0.5) * 18;
  ...
  function performCooking(person, context) {
    ...
    const skillTier = getSkillTier(person, "cooking");
    const block    = getScheduleBlock(gameState.date);
    ...
    function recipeWeight(recipe) {
      ...
      if (recipe.tier === "meal_feast") w += skillTier * 0.5;
      return w;
    }
  ...
  function performHunt(person) {
    ...
    const skillTier = getSkillTier(person, "hunting");
    ...
    for (let i = 0; i < shots; i++) {
      if (Math.random() < regionBase + skillTier * 0.025) {
        meat += randFloat(4, 18);
    const inefficiency = skillTier <= 1 ? 1.25 : skillTier >= 4 ? 0.85 : 1.0;
    ...
    const injuryChance = clamp(0.08 - skillTier * 0.012, 0.02, 0.08);
  ...
  function performGatherWood(person) {
    ...
    const skillTier = getSkillTier(person, "woodcutting");
    const bundles = yieldBase * richness * (0.35 + skillTier * 0.25);
    const envNote = local.tags && local.tags.length ? " (" + local.tags[0] + ")" : "";
    ...
    const mishapChance = clamp(0.05 - skillTier * 0.009, 0.01, 0.05);
  ...
  function performRepair(person) {
    ...
    const hasParts =
      ...
      0;
    const repairTier = Math.max(
      getSkillTier(person, "repair"),
      getSkillTier(person, "woodcutting")
    );
    const outcome = rollSkillOutcome(person, "repair", hasParts ? 1 : 0, {
      weather: gameState.weatherState,
    });
    let gain = hasParts ? 4 + repairTier * 1.3 : 2 + repairTier;
  ...
  function performDoctoring(person) {
    ...
    target.afflictions.forEach(function (aff) {
      ...
      if (hasMedicine && !aff.medicineUsed && aff.severity >= 2) {
        ...
        aff.medicineUsed = true;
        usedMedicine = true;
      if (aff.severity > 1 && Math.random() < 0.15 + skillTier * 0.05) {
  ...
  const EVENT_DEFS = [
    ...
    },
    {
      ...
      run: async function (ctx) {
        const travelTier = getSkillTier(gameState.leader, "travel");
        const choice = await presentEncounter({
          id: "shortcut_guide_offer",
        ...
        if (choice === "pay") {
          ...
          const lucky = Math.random() < 0.35 + travelTier * 0.05;
          if (lucky) {
    ...
    {
      id: "setpiece_b01_medicine_show",
      kind: "major",
      condition: function (ctx) {
        const step = getEventFlag("b01_medicine_show_step") || 0;
        const miles = gameState.milesTraveled || 0;
        const mileOk = miles >= 200 && miles <= 1400;
        const regionOk = ctx.regionKey !== "columbia";
        const cooldownOk = hoursSinceFlag("b01_medicine_show_last") >= 240;
        const blockOk = ctx.block === "evening" || ctx.block === "noon";
        return step === 0 && ctx.mode === "travel" && blockOk && mileOk && regionOk && cooldownOk;
      },
      weight: function () {
        return 2;
      },
      run: async function (ctx) {
        const selection = await presentEncounter({
          id: "setpiece_b01_medicine_show",
          title: "Traveling medicine show",
          subtitle: ctx.location,
          body: [
            "Painted wagons form a crooked circle off the trail. A barker in a sequined coat promises cures for every ailment while smoke pots hiss behind him.",
          ],
          tags: ["travel", "trade", "omen"],
          options: [
            { id: "pay", label: "Pay for the show", tone: "warm", hint: "Spend coin; morale rises." },
            { id: "tonic", label: "Buy the miracle tonic", tone: "neutral", hint: "Costs coin; gain supplies; tension up." },
            { id: "skulk", label: "Skulk behind the wagons", tone: "danger", hint: "Chance at coin; risk trouble." },
          ],
          defaultId: "pay",
        });
        const nowHour = getCurrentTrailHour(gameState);
        let variant = "pay";
        let logText = "You steer past the gaudy circle, letting the show fade behind.";
        if (selection === "pay") {
          gameState.money = Math.max(0, (gameState.money || 0) - 5);
          (ctx.people || getAllPeople()).forEach(function (p) {
            adjustPersonStat(p, "morale", 2);
          ...
          ctx.storyState.tension = clamp((ctx.storyState.tension || 0) - 1, 0, 100);
          variant = "pay";
          logText = "You pay for the spectacle. Music, snake oil, and laughter ease the road for an evening.";
        } else if (selection === "tonic") {
          const cost = 4;
          gameState.money = Math.max(0, (gameState.money || 0) - cost);
          gameState.supplies.med_kits = (gameState.supplies.med_kits || 0) + 1;
          ctx.storyState.tension = clamp((ctx.storyState.tension || 0) + 2, 0, 100);
          variant = "tonic";
          logText = "You buy a crate of \"miracle tonic\". The label glows faintly and everyone side-eyes the bottles.";
        } else if (selection === "skulk") {
          variant = "skulk";
          if (Math.random() < 0.5) {
            gameState.money = (gameState.money || 0) + 5;
            logText = "You slip behind the stage wagons and find a tipped cash box before hurrying off.";
          } else {
            adjustFactionRep("men_in_gray", -3, null, ctx);
            const target = choice(ctx.people || getAllPeople());
            if (target) target.condition = clamp((target.condition || 50) - 4, 0, 100);
            logText = "A watcher in gray spots you skulking. You escape with bruises and a cold stare.";
          }
        }
        setEventFlag("b01_medicine_show_last", nowHour);
        setEventFlag("b01_medicine_show_variant", variant);
        advanceChain("b01_medicine_show", 1);
        addLog(logText, { tone: "event", tag: "DAY " + ctx.dayTag, location: ctx.location });
        recordStoryBeat("setpiece", "b01_medicine_show", "Visited a traveling medicine show", {
          choice: selection,
          variant: variant,
        });
      },
    ...
    {
      id: "b01_medicine_show_followup",
      kind: "minor",
      condition: function (ctx) {
        const step = getEventFlag("b01_medicine_show_step");
        const waited = hoursSinceFlag("b01_medicine_show_time");
        return step === 1 && waited >= 24 && waited <= 96;
      },
      weight: function () {
        return 3;
      },
      run: async function (ctx) {
        const variant = getEventFlag("b01_medicine_show_variant");
        const selection = await presentEncounter({
          id: "b01_medicine_show_followup",
          title: "Medicine show echoes",
          subtitle: ctx.location,
          body: [
            variant === "tonic"
              ? "The crate rattles as you travel. Bottles leak a sweet smell; someone complains of a metallic aftertaste."
              : variant === "skulk"
              ? "A lone performer limps along the trail behind you, carrying a ledger and looking displeased."
              : "A jaunty fiddle tune drifts from the trees; the medicine troupe seems to have followed for a spell.",
          ],
          tags: ["omen", "travel"],
          options: [
            { id: "engage", label: "Face it head on", tone: "warm", hint: "Settle nerves; minor cost." },
            { id: "shake", label: "Shake them off", tone: "danger", hint: "Raise tension; keep moving." },
          ],
          defaultId: "engage",
        });
        let logText = "You hum the tune away and keep rolling.";
        if (selection === "engage") {
          if (variant === "tonic") {
            ctx.storyState.tension = clamp((ctx.storyState.tension || 0) + 1, 0, 100);
            gameState.supplies.med_kits = Math.max(0, (gameState.supplies.med_kits || 0) - 1);
            (ctx.people || getAllPeople()).forEach(function (p) {
              adjustPersonStat(p, "morale", 1);
            });
            logText = "You pour out a bottle to test it. Spirits rise when nothing mutates, though the smell lingers.";
          } else if (variant === "skulk") {
            adjustFactionRep("men_in_gray", -2, null, ctx);
            gameState.money = Math.max(0, (gameState.money || 0) - 2);
            logText = "You pay a begrudging hush fee to the limping performer and move on.";
          } else {
            ctx.storyState.tension = clamp((ctx.storyState.tension || 0) - 1, 0, 100);
            (ctx.people || getAllPeople()).forEach(function (p) {
              adjustPersonStat(p, "morale", 1);
            });
            logText = "You invite the fiddler in for a song, letting the road feel lighter for a night.";
          }
        } else if (selection === "shake") {
          ctx.storyState.tension = clamp((ctx.storyState.tension || 0) + 2, 0, 100);
          if (variant === "skulk") {
            const target = choice(ctx.people || getAllPeople());
            if (target) target.condition = clamp((target.condition || 50) - 3, 0, 100);
            logText = "You hurry the team; the performer fades but a rough jolt leaves someone sore.";
          } else {
            logText = "You outpace the lingering tune and leave the rattling crate unopened.";
        }
        advanceChain("b01_medicine_show", 2);
        setEventFlag("b01_medicine_show_last", getCurrentTrailHour(gameState));
        addLog(logText, { tone: "event", tag: "DAY " + ctx.dayTag, location: ctx.location });
        recordStoryBeat("setpiece", "b01_medicine_show", "Medicine show follow-up", {
          choice: selection,
          variant: variant,
      },
    {
  ...
  function renderExplorerChip() {
    ...
    dom.explorerChip.innerHTML = lines
      .filter(Boolean)
      .map(function (line) {
        return "<div>" + line + "</div>";
      })
  ...
  function syncMapModalState() {
    ...
    if (gameState.mapOpen) {
      showModal(dom.mapModal);
    } else {
      hideModal(dom.mapModal);
  ...
  function wireExplorerCanvasInteractions(canvas) {
    ...
    canvas.addEventListener("pointermove", function (evt) {
      ...
      if (
        localX < 0 ||
        localY < 0 ||
        localX >= visibleTilesX ||
        localY >= visibleTilesY
      ) {
        if (explorerRuntime.hover) {
          explorerRuntime.hover = null;
          renderExplorerWorld();
...
mileAtTile || 0
      ...
      if (!explorerRuntime.hover || explorerRuntime.hover._k !== hoverKey) {
  ...
  const EXPLORER_ART = {
    prairie: { url: IMAGE_BASE+"prairie_orig.png" },
    river_bottom: { url: IMAGE_BASE+"river-bottom_orig.png" },
    steppe: { url: IMAGE_BASE+"steppe_orig.png" },
    alpine: { url: IMAGE_BASE+"alpine_orig.png" },
    desert_sage: { url: IMAGE_BASE+"desert-sage_orig.png" },
    conifer_forest: { url: IMAGE_BASE+"conifer-forest_orig.png" },
    river_gorge: { url: IMAGE_BASE+"river-gorge_orig.png" },
    valley: { url: IMAGE_BASE+"valley_orig.png" },
    great_basin_desert: { url: IMAGE_BASE+"great-basin-desert_orig.png" },
    alkali_flat: { url: IMAGE_BASE+"alkali-flat_orig.png" },
    icon_fort_stockade: { url: IMAGE_BASE+"fort-stockade_orig.png" },
    icon_town: { url: IMAGE_BASE+"icon-town_orig.png" },
  };
  const explorerArtCache = { images: {}, canvases: {} };
  const PAWN_SHEET_URL = IMAGE_BASE+"pawns_orig.png";
  ...
  function renderCompanionDetail() {
    ...
    skillsLine.textContent =
      "Travel: " +
      getSkillRaw(person, "travel") +
      " · Hunting: " +
      getSkillRaw(person, "hunting") +
      " · Cooking: " +
      getSkillRaw(person, "cooking") +
      " · Woodcutting: " +
      getSkillRaw(person, "woodcutting") +
      " · Doctoring: " +
      getSkillRaw(person, "doctoring");
...
const repVal = tier && isFinite(tier.value) ? tier.value : 0;
subParts.push(`Standing: ${tier.label} (${repVal >= 0 ? "+" : ""}${repVal})`);
subParts.push(`Terms: ${terms.label}`);
...
anchor.href = url;
anchor.download = `old-trail-save-${stamp}.json`;
document.body.appendChild(anchor);
anchor.click();
anchor.remove();
URL.revokeObjectURL(url);
} catch (e) {
console.warn("Unable to export save:", e);
}
}
function handleImportSaveFile(evt) {
...
const payload = parsed && parsed.gameState ? parsed : { saveVersion: parsed.saveVersion || SAVE_VERSION, gameState: parsed };
if (!payload || !payload.gameState || !payload.gameState.date) {
throw new Error("Invalid save payload.");
}
localStorage.setItem(SAVE_KEY, JSON.stringify(payload));
location.reload();
} catch (e) {
console.warn("Unable to import save:", e);
alert("Import failed. The save file was not recognized.");
} finally {
input.value = "";
}
};
...
if (!el || !el.classList) return;
if (el.classList.contains("ot-show")) return;
el.classList.add("ot-show");
handleModalStateChange(true);
}
function hideOverlay(el) {
if (!el || !el.classList) return;
if (!el.classList.contains("ot-show")) return;
el.classList.remove("ot-show");
handleModalStateChange(false);
}
function handleModalStateChange(isOpen) {
if (isOpen) {
modalPauseCount += 1;
if (modalPauseCount === 1) {
timeSpeedBeforeModal = timeSpeed;
setTimeSpeed(0);
}
return;
}
modalPauseCount = Math.max(0, modalPauseCount - 1);
if (modalPauseCount === 0 && timeSpeedBeforeModal != null) {
const previous = timeSpeedBeforeModal;
timeSpeedBeforeModal = null;
setTimeSpeed(previous);
}
}
function formatTimeReadout() {
return formatDateTime(gameState.date);
}
function updateTimeControls() {
if (!dom.timeButtons || !dom.timeButtons.length) return;
dom.timeButtons.forEach(function (btn) {
const speed = Number(btn.dataset.speed || 0);
btn.classList.toggle("ot-time-btn-active", speed === timeSpeed);
});
if (dom.timeReadout) {
dom.timeReadout.textContent = formatTimeReadout();
}
}
function setTimeSpeed(speed) {
const clamped = Math.max(0, Math.min(3, Number(speed) || 0));
timeSpeed = clamped;
if (clamped > 0) lastNonZeroSpeed = clamped;
updateTimeControls();
scheduleAutoTick();
}
...
autoTickTimer = setTimeout(runAutoTick, AUTO_TICK_BASE_MS / timeSpeed);
}
function runAutoTick() {
if (timeSpeed <= 0) return;
if (modalPauseCount > 0 || gameState.phase !== "travel") {
scheduleAutoTick();
return;
}
Promise.resolve(
withAdvanceLock(function () {
return advanceOneHour({ reason: "auto_tick" });
})
).finally(function () {
scheduleAutoTick();
});
...
if (view !== "journal" && view !== "explorer") view = "explorer";
...
if (dom.timeButtons && dom.timeButtons.length) {
dom.timeButtons.forEach(function (btn) {
btn.addEventListener("click", function () {
setTimeSpeed(Number(btn.dataset.speed || 0));
});
});
}
if (dom.btnExportSave) {
dom.btnExportSave.addEventListener("click", function () {
exportSaveToFile();
});
}
if (dom.btnImportSave && dom.importSaveFile) {
dom.btnImportSave.addEventListener("click", function () {
dom.importSaveFile.click();
});
dom.importSaveFile.addEventListener("change", function (evt) {
handleImportSaveFile(evt);
});
}
dom.btnOpenInventory.addEventListener("click", function () {
renderInventoryModal();
showModal(dom.inventoryModal);
});
...
evt.preventDefault();
if (timeSpeed === 0) {
setTimeSpeed(lastNonZeroSpeed || 1);
} else {
setTimeSpeed(0);
}
} else if (evt.key === "1") {
...
renderCampRolesSummary();
if (dom.campOverlay) showOverlay(dom.campOverlay);
showOverlay(dom.campOverlay);
}
function closeCampOverlay() {
if (dom.campOverlay) hideOverlay(dom.campOverlay);
}
